...
<body> 
 <form name="form" id="form"  class="form" method="post">
		...
		qrysb.append(" MOM.LATITUDE,MOM.CONT1_DESIG,MOM.JURIS_DIST_CD,MOM.ORG_CD,DECODE(MOM.ACT_YN,'Y','YES','NO') AS ACT_YN, MOM.AGENCY_TYPE FROM MAS_OFF_MAST MOM,M_DISTRICT MD,M_STATE MS");
