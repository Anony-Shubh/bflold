...
ResultSet rsmast = db.execSQL("SELECT upper(cir_sub), to_char(cir_date,'DD-MON-RRRR') as cir_date, kvic_msme, file_nm,cir_id FROM PMEGPONLINE.circulars WHERE ACT_YN='Y' and kvic_msme like '"+vOffType+"'order by  to_date(cir_date) desc" );
%>
<html>
<head>
...
<table id="example" class="display" cellspacing="0" width="100%">
  ...
  %>
   <tr><td nowrap><div align="center">
    ...
    <th nowrap><a href="../dashboard/<%out.print(rsmast.getObject(4)); %>" target="_blank">View</a></th>
    <th nowrap><a href="DeleteCircular.jsp?CIR_ID=<%=(rsmast.getObject(5))%>" class="greenButtonRound" onClick="javascript:Popup(this.href, 'Delete Document', 800, 350);return (false);">Delete</a></th>
  </tr>
  <%}
	rsmast.close();
