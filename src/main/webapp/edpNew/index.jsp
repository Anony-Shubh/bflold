...
<html>
<head>
<title>Central Office Edp Login Form</title>
...
<% 
   String msgStr="";
	...
	if ((username.equals("admin") && pw.equals("A@3%!67(U"))) {
	
	 session.setAttribute("userid", username);				
	//response.sendRedirect("AppUpdateBank.jsp");
...
<table align="center">
  ...
  <tr>
    <td colspan="2"><center><img src="../images/pmegponlineN.jpg"></center></td>
  </tr>
  ...
  <tr > 
    <th colspan="2" > <div align="center" class="GreenLebel">
      <h2>CENTRAL OFFICE ADMIN LOGIN FORM FOR EDP DETAIL UPDATION </h2>
    </div></th>
    </tr>
  <tr>
