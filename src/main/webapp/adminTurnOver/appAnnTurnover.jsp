...
String EMAIL_SENT = "";
String GR_TIMESTAMP = "";
String APP_ID =(String) request.getParameter("appid")==null?"":(String) request.getParameter("appid").trim();
String APP_NAME="";
...
qrysb.append("   SELECT AD.ACTIVITY_CD,AD.MOB_NO1,AD.APP_NAME, ad.UNIT_POST_ADDR ");
qrysb.append("  || ' '");
qrysb.append("  || ad.UNIT_TALUK_BLOCK");
qrysb.append("  || ' Dist:'");
 qrysb.append(" || MD.DISTRICT_NAME");
 qrysb.append(" || ' Pin:'");
 qrysb.append(" || ad.UNIT_PIN                                       AS unit_addr,AM.ACTIVITY_NAME,");
...
<input name="APP_NAME" type="hidden" id="APP_NAME" value="<%=APP_NAME%>" >
  ...
  <th width="35"><input name="MOB_NO1" type="text" id="MOB_NO1" value="<%=MOB_NO1%>" maxlength="50" ></th>
</tr>
<tr>
  <th > Unit Name:* </th>
...
<tr>
  <th><input name="ATO_16" type="text" id="ATO_16" value="<%=ATO_16%>" maxlength="50"></th>
  <th><input name="ATO_17" type="text" id="ATO_17" value="<%=ATO_17%>" maxlength="50"></th>
  <th><input name="ATO_18" type="text" id="ATO_18" value="<%=ATO_18%>" maxlength="50" ></th>
  <th><input name="ATO_19" type="text" id="ATO_19" value="<%=ATO_19%>" maxlength="50" ></th>
  <th><input name="ATO_20" type="text" id="ATO_20" value="<%=ATO_20%>" maxlength="50" ></th>
</tr>  
...
if (NO_OF_APP.equals("0"))
{
 ...
 sb.append("  ATO_16,ATO_17,ATO_18,ATO_19,ATO_20,APP_ID) VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
}
else
{
	  ...
	  append("    MOB_NO=?,  ATO_16=?,  ATO_17=?, ATO_18=? ,ATO_19=?,ATO_20=? WHERE  APP_ID=?      ");
}
