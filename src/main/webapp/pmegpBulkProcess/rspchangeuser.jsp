...
var  OLD_PWD=document.form.OLD_PWD.value;

 //var pwdpattern = /^[a-z0-9_-]{8,15}*$/;

if(OLD_PWD == "") {
    inlineMsg("OLD_PWD","Please Enter old Password",2);
    return false;
  }
...
if(NEW_PWD == "") {
  ...
  if (NEW_PWD !=RE_PWD) {
      inlineMsg("NEW_PWD","New Password mismatch With Re-entered New Password",2);
    return false;
  }
...
qrysb.append("  select IFSL_CODE,   USER_NM AS BRANCH_NAME,   USER_DESC AS BR_NAME,NOD_CONTNO1 AS CONT_NO,   NOD_EMAIL1 AS EMAIL,trim(PASSWD) AS PSSWD "      );
qrysb.append("    from bu_usermast   where  IFSL_CODE=?"      );
...
OLD_PWD=request.getParameter("OLD_PWD")== null?"":(String) request.getParameter("OLD_PWD").trim();
...
if (OLD_PWD.equals(PSSWD) ){

StringBuffer sb= new StringBuffer();
sb.append("UPDATE  BU_USERMAST SET PASSWD=? WHERE IFSL_CODE=?");
...
err_msg="Old Password Mismatch............";
 ...
 <table align="center" class="pmegpTable">
  ...
  (* mark fields are mendotory )
    ...
    <tr >
      <td >(1)</td>
      <th nowrap >Enter Old Password* </th>
      <td><input name="OLD_PWD" id="OLD_PWD" type="password"  size="15" maxlength="10"></td>
    </tr>
    <tr >
      <td >(2)</td>
      <th nowrap > 
      ...
      <td>
        <input name="NEW_PWD" id="NEW_PWD" type="password"  size="15" maxlength="10">
      </td>
    </tr>
    <tr >
      <td >(3)</td>
      ...
      <td>
        <input name="RE_PWD" id="RE_PWD" type="password"  size="15" maxlength="10">
      </td>
    </tr>
    <tr >
