...
-->
 ...
 <form  method="post"  name="form1" id="form1" >
  <%		
   ...
   qrysb.append("  SELECT MOM.OFF_NAME1,BD.EDP_TRG_NAME,TO_CHAR(BD.EDP_FR_DT,'DD-MON-YYYY') AS EDP_FR_DT,BD.TDR_ACNO,TO_CHAR(BD.TDR_ADJ_DT,'DD-MON-YYYY') AS TDR_ADJ_DT," );
...
String validateqry="SELECT * FROM TABLE(GET_PMEGP_BANKERROR_TDR_SECOND(?,?,?,?,?))";
...
StringBuffer sb = new StringBuffer();
		 sb.append("   UPDATE  BANK_DATAENTRY_SECOND SET TDR_ACNO=?, TDR_ADJ_DT=?, MM_ADJ_DT=?,   ").
             append("  MM_ADJ_AMT=?  WHERE APP_ID =?  AND PACT_ID=34  AND APPRV_YN='A'  ");
