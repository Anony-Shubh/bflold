...
av.append("SELECT a.tr_id,a.OFF_CD,a.REMTRID, b.app_id,a.LOAN_DOCFNAME,a.act_id, to_char(a.bank_rec_dt,'DD-MON-YYYY') AS  bank_rec_dt, bank_remarks,AM.activity_name,100-OWNCONT_PER(B.APP_ID) AS BANK_LOAN_PER,a.RINT,a.LOAN_PERIOD, ").
...
append ( " to_char(a.tdr_adj_dt,'DD-MON-YYYY') as tdr_adj_dt, a.tdr_adj_amt,to_char(sysdate,'DD-MON-YYYY') as TODAYDT,B.IFSC_CODE, " ).
 append ( " a.bank_comment,  to_char(a.time_stamp,'DD-MON-YYYY:HH:MM:SS') as time_stamp ").
  append (" FROM bank_dataentry a, app_detail b,BANK_BR_MAST BBM,BENF_CATEGORY_MAST C,education_mast d , ACTIVITY_MAST AM WHERE B.ACTIVITY_CD=AM.ACTIVITY_CD AND bbm.br_ifsl_code=b.ifsc_code AND  b.APP_ID=? AND BBM.CIRCLE_IFSC=?").
  ...
  <table align="center" class="pmegpTable">
    ...
    <tr>
	 ...
	 <%  if (!DOC_NAME_ADD.equals("")) { %>
      ...
      <td colspan="2"><div align="center">
        <input name="btnAdd" type="button" class="buttonGreen" id="btnAdd" value="UPLOAD" style="color:#000000"; onClick="uploadAdd('<%= APP_ID %>')"> 
        </div></td>
    <tr>
    <tr>
      <th>&nbsp;</th>
	...
	<%   } %>
      ...
      <td colspan="2"><div align="center">
        <input name="btnEDP" type="button" class="buttonGreen" id="btnEDP" value="UPLOAD / UPDATE EDP CERTIFICATE" style="color:#000000"; onClick="uploadCert('<%= APP_ID %>')"> 
        </div></td>
    <tr>
      <th colspan="5">&nbsp;</th>
    <tr>
	  ...
	  <input name="OFF_CD" id="OFF_CD" type="hidden" size="50" maxlength="50" value="<%= OFF_CD %>">
    ...
    <tr>
      ...
      <td colspan="3"><input name="EDP_CERT_DT" type="text"  id= "EDP_CERT_DT" onClick="javascript:NewCssCal('EDP_CERT_DT','ddMMMyyyy')" value="<%= EDP_CERT_DT %>" size="12" maxlength="11" autocomplete="off" placeholder="DD-MON-YYYY"></td>
    ...
    <tr>
      ...
      <td colspan="2"><div align="center">
          <input name="btnEDP" type="button" class="buttonGreen" id="btnEDP"  style="color:#000000"; value="UPLOAD / UPDATE REVISED LOAN STATEMENT" onClick="uploadLoan('<%= APP_ID %>')">
      </div></td>
    <tr>
      <th colspan="5">&nbsp;</th>
    <tr>
...
( Non customer A/c)	</td>
 ...
 <span class="redLebel">Aadhaar Details are invalid! Please ensure Aadhaar No, Name, Date Of Birth , Gender and mobile No Details are as per Aadhaar Card....... ! Kindly Reject/Cancel the MM Claim and Contact Concern Agency to Update Correct  Details in Applicant Data form </span>
        ...
        <input name="btnClaim" type="submit"  style="color:#000000"; class="buttonBlue" id="btnClaim" value="Final MM Claim Submission">
      </div>
		<%}%></th>
  </table>
