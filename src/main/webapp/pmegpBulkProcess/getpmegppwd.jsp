...
var TRANSAC=document.form.TRANSAC.value;
if(NEW_PWD == "") {
  ...
  if(RE_PWD == "") {
   ...
   if(TRANSAC == "") {
    inlineMsg("TRANSAC","Please Confirm Your Transient Account No. As per Your Email....",2);
    return false;
  }
 ...
 %>
  ...
  (* mark fields are mendotory )
    ...
    <tr >
      ...
      <th align="right" nowrap>Confirm Transient A/c No. of Your Branch:</th>
      <td align="right" nowrap><input name="TRANSAC" type="password" id="TRANSAC" size="20" maxlength="20"></td>
    </tr>
    <tr >
...
sb.append("UPDATE  bank_br_mast SET psswd=?, timestamp=sysdate ,RESETYN='N' WHERE BR_IFSL_CODE=?");
 values.add (NEW_PWD);
 pstm.add ("L");
  values.add (BR_IFSL_CODE);
pstm.add ("L");
