...
String OFF_ADDR2="";
    ...
    if (!CITY.equals("")){
       vWherecls=vWherecls+" AND UPPER(OFF_ADDR2) ||' '|| UPPER(MOM.CITY)||' '||UPPER(DISTRICT_NAME) ||' '||MOM.PINCODE  LIKE  TRIM(UPPER('%"+CITY+"%')) ";
...
qrysb.append(" M_DISTRICT MD,M_STATE MS WHERE  MOC.OFF_CATEGORY=100  AND ACT_YN='Y' " );
qrysb.append(" AND MD.DISTRICT_CD=MOM.DISTRICT_CD  AND MOC.OFF_TYPE_CD=MOM.OFF_TYPE_CD AND MD.STATE_CD=MS.STATE_CD" );
