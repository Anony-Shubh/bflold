...
adhvalid=v.VerifyAad(APP_ID, "AG");
		...
		sb.append("    UPDATE BANK_DATAENTRY BBD SET BBD.IFSC_CODE=  "      );
        sb.append("   (SELECT IFSC_CODE FROM APP_DETAIL AAD WHERE AAD.APP_ID=BBD.APP_ID)"      );
		sb.append("    WHERE BBD.APP_ID IN "      );
        sb.append("   (SELECT AD.APP_ID FROM APP_DETAIL AD, BANK_DATAENTRY BD      ");
        ...
        StringBuffer qrysb = new StringBuffer();
			...
			qrysb.append("     AD.AADHAR_NO,BBM.CIRCLE_NEFT AS NEFT_IFSC,"      );
   ...
   qrysb.append("   WHEN (FGETNEFTIFSCODE(BD.APP_ID) NOT IN (SELECT CIRCLE_NEFT FROM BANK_BR_MAST WHERE br_ifsl_Code=BD.IFSC_CODE)) THEN "      );
    ...
    qrysb.append(" END mm_claim_valid"      );
			...
			qrysb.append("     BANK_DATAENTRY BD, BANK_BR_MAST BBM"      );
