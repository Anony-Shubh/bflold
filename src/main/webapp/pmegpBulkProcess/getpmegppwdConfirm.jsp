...
qrysb.append("     lower(bbm.EMAIL) as EMAIL"      );
qrysb.append("   FROM bank_br_mast bbm"      );
qrysb.append("   WHERE TRIM(UPPER(bbm.BR_IFSL_CODE))=TRIM(UPPER(?)) AND TRIM(UPPER(EMAIL)) =TRIM(UPPER(?))"      );
...
%>
  ...
  <tr >
    ...
    <tr >
      <th colspan="3" ><div align="center"><h1>Get Financing Branch User Login Details</h1></div></th>
    </tr>
    <tr >
      <td colspan="3" >
            <div align="center">
  ...
  (* mark fields are mendotory )
    ...
    <tr >
      <td colspan="3" ><div align="center" class="GreenLebel"> Note: Confirmation Mail will be Sent to Your Registered branch eMail ID</div></td>
    </tr>
    <tr >
      <td colspan="3" >
	   <% if (!err_msg.equals("")) {%>
...
<%}%>
    ...
    <tr >
      <td >(2)</td>
      <th >        
      Enter Registered email ID of Your Branch: * </th>
      <td>
        <input name="EMAIL" type="text" id="EMAIL"  size="40" maxlength="40" value="<%= EMAIL %>" autocomplete="off" title=" Enter email ID of Your Branch which is registered in our PMEGP eportal">
      </td>
    </tr>
    <tr >
      <td colspan="3" align="right" nowrap><div align="center" class="redLebel">( Note: eMail ID Should be Your official  email of Branch which is registered in our PMEGP eportal) </div></td>
    </tr>
    <tr >
      <td colspan="3" align="right" nowrap><div align="center"><%= Msg %></div></td>
    </tr>
    <tr >
      <th colspan="2" align="right" nowrap><div align="center">
        
      <a href="index.jsp" target="_parent" class="greenButtonRound">Go Back</a>      </div></th>
      <th align="right" nowrap><div align="center">
        <input name="Button" type="button" class="button" onClick="form_submit();" value="Submit" >
      </div></th>
    </tr>
    <tr >
      <td colspan="3" align="right" nowrap>For technical assistance send email to  pmegpeportal.kvic@gov.in  with IFS Code, Branch Name, State, Contact Person Name, Designation and Contact No.</td>
    </tr>
  </table>
</form>
