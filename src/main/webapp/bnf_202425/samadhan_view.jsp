...
%>
  <TR>
	...
	<TD><DIV align="center"><% if (RECOM_LET_UPLOAD.equals("") && (!(TOTALRECOMAMT.equals("0")) )) {%><A href="jasperReports/bnfreport.jsp?INVUPID=<%= INVUPID %>&MONTHDT=<%= MONTH_DT %>&SOFF_CD=<%= SOFF_CD%>&REP_NM=samadhanedprecom"class="myButton">Recom. Letter</A><%} else {
