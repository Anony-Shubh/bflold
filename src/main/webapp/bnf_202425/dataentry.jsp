...
%>
  <TR>
	...
	<TD><DIV align="center"><A href="deviewform.jsp?PBNF_HDID=<%=BNF_HDID  %>&BNF_SUB_HEAD_SH_DESC=<%= BNF_SUB_HEAD_SH_DESC %>" class="myButton">Add/Update</A></DIV></TD>
	<%}%>
  </TR>
  <%
