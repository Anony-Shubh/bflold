...
input[type="text"]:read-only { background-color:#990000; width:auto; }
       </style>
...
Number(document.getElementById('EDPARRPAYRECOM').value)
...
Number(document.getElementById('FIVEDAYTRGRECOMAMT_OLD').value)+Number(document.getElementById('TENDAYTRGRECOMAMT_OLD').value)+Number(document.getElementById('EDPARRPAYRECOM').value)
...
if 	(off_cd.equals("5707")) {
	off_cd="10";
	}
	
	if 	(off_cd.equals("6466")) {
	off_cd="25";
	}
...
qrysb.append("   AND SQ.INVUPID=? AND (SQ.OFF_CD=? or MIS_OFF_CD in (select mis_off_cd from mas_off_mast where off_cd = (?))) AND TRUNC(SQ.MONTH_DT)=? "      );
qrysb.append("   "      );
...
<table width="747" border="1" align="center" id="cont">
				 
<tr>
  <td colspan="4" class="style1" align="center"><div align="center" style="background-color:#2e823c;" class="class">Online EDP Upload Invoice Form </div></td>
  </tr>
<tr align="left">
  <td width="154" class="style1">Office Name:
  <input name="ins" type="hidden" id="ins" value="<%=ins %>"></td>
  <td width="155" class="style1"><%=off_name1%></td>
  <td width="173" class="style1">State:</td>
  <td width="237" class="style1"><%=state%></td>
</tr>
<tr align="left">
...
<table width="747" border="1" align="center" id="cont">
  ...
  <tr>
    <td colspan="6" align="center" "background-color:#2e823c;" style="background-color:#2e823c;">&nbsp;</td>
    </tr> 
  <tr> 
    <td width="6%" align="center"><strong>(1)</strong></td>
    <td width="28%"><strong>Invoice Date:</strong></td>
    <td width="11%"><%//=inv_date%>  </td>
    <td width="17%"><strong>Invoice No:</strong></td>
    <td colspan="2"><%=inv_no%></td>
    </tr>
  ...
  <tr>
    ...
    <td  style="background-color:#2e823c;" class="class">NEW RATE </td> 
    <td  style="background-color:#2e823c;"class="class" >No of Trainees </td> 
    <td  style="background-color:#2e823c;" class="class"> Amount(In Rs.)</td>
    <td  style="background-color:#2e823c;" width="19%" class="class">No of Trainees</td>
    <td  style="background-color:#2e823c;" width="19%" class="class"><span class="class" style="background-color:#2e823c;">Amount(In Rs.)</span></td>
  </tr> 
  <tr>
    <td align="center">&nbsp;</td>
    <td><div align="right">5 Days Training @Rs. 1650  </div></td>
    <td><div align="center"><Strong><%=FIVEDAYTRGINVNO%></strong></td>
    <td><Strong><%=FIVEDAYTRGINVAMT%></Strong></td>
    <td><input type="number"  name="FIVEDAYTRGRECOMNO" id="FIVEDAYTRGRECOMNO"   value="<%=FIVEDAYTRGRECOMNO%>" onChange="calculateedp();" maxlength="12" ></td>
    <td><input name="FIVEDAYTRGRECOMAMT" type="text"   id="FIVEDAYTRGRECOMAMT"  value="<%=FIVEDAYTRGRECOMAMT%>" size="12"  maxlength="12" readonly="true"></td>
  </tr> 
  <tr>
    <td align="center">&nbsp;</td>
    <td><div align="right">10  Days Training @ Rs. 3300  </div></td>
    <td><div align="center"><Strong><%=TENDAYTRGINVNO%></Strong></td>

	<td><Strong><%=TENDAYTRGINVAMT%></Strong></td>
	...
	<td><input name="TENDAYTRGRECOMAMT" type="text"  id="TENDAYTRGRECOMAMT"  onChange="calculateedp();" value="<%=TENDAYTRGRECOMAMT%>" maxlength="12" readonly="true"></td>
  </tr>
 <tr>
    <td align="center"><strong>(3)</strong></td>
    <td  style="background-color:#2e823c;" class="class" >OLD RATE </td> 
    <td  style="background-color:#2e823c;" class="class" >No of Trainees </td> 
    <td  style="background-color:#2e823c;" class="class" ><span class="class" style="background-color:#2e823c;">Amount(In Rs.)</span></td>
    <td  style="background-color:#2e823c;" class="class">No of Trainees</td>
    <td  style="background-color:#2e823c;" class="class"><span class="class" style="background-color:#2e823c;">Amount(In Rs.)</span></td>
  </tr>
  <tr>
    ...
    <td><div align="center"><strong><%=FIVEDAYTRGINVNO_OLD%></Strong></td>
    <td><Strong><%=FIVEDAYTRGINVAMT_OLD%></Strong></td>
    ...
    <td><input type="text" id="FIVEDAYTRGRECOMAMT_OLD" name="FIVEDAYTRGRECOMAMT_OLD" value="<%=FIVEDAYTRGRECOMAMT_OLD%>" onChange="calculateedp();"  class="form-text" maxlength="5" readonly="true"></td>
  </tr> 
  <tr>
    <td align="center">&nbsp;</td>
    <td><div align="right">10  Days Training @ Rs. 3000  </div></td>
    <td><div align="center"><strong><%=TENDAYTRGINVNO_OLD%></Strong></td>

	<td><Strong><%=TENDAYTRGINVAMT_OLD%></Strong></td>
	...
	<td><input type="text" id="TENDAYTRGRECOMAMT_OLD" name="TENDAYTRGRECOMAMT_OLD" value="<%=TENDAYTRGRECOMAMT_OLD%>" onChange="calculateedp();"  maxlength="5" readonly="true" ></td>
  </tr>
  
  <tr>
    <td align="center"><strong>(4)</strong></td>
    <td><div align="right">EDP Arrear Remark (If Any) </div></td> 
    <td colspan="4"><strong><%=EDPARR_REM%></strong></td>
    </tr> 
  <tr> 
    <td align="center">&nbsp;</td>  
    <td><div align="right">Any Arrear Amount </div></td>   
    <td></td>  
    <td><strong><%=EDPARRPAY%></strong></td>
   <td><div align="left">Any Arrear Recommand Amount </div></td>    
   <td><input type="number" id="EDPARRPAYRECOM" name="EDPARRPAYRECOM" value="<%=EDPARRPAYRECOM%>" onChange="calculateedp();"  maxlength="5"></td>
  </tr>  
  <tr>  
    <td align="center"><Strong>(5)</Strong></td> 
    <td><div align="left"><strong><strong>Total EDP </strong>
     </div></td>
  <td>
 <strong><%=edp_no%></strong><input type="hidden" id="edp_no" name="edp_no"   value="<%=edp_no%>"></td>
    <td><input type="hidden" id="total_inv_amt" name="total_inv_amt"   value="<%=total_inv_amt%>"><strong><%=total_inv_amt%></strong></td>
    <td><input type="text" id="TOTALEDPRECOMNO" name="TOTALEDPRECOMNO"   value="<%=TOTALEDPRECOMNO%>"  maxlength="5" readonly="true" ></td>
    <td><input type="text" id="TOTALEDPRECOMAMT" name="TOTALEDPRECOMAMT" value="<%=TOTALEDPRECOMAMT%>"   maxlength="6" readonly="true" ></td>
  </tr>
  ...
  <tr> 
    ...
    <td>&nbsp;</td>
    <td><strong><%=gst_amt%></strong></td>
    <td>&nbsp;</td>
    <td><input type="text" id="GST_AMT_RECOM" name="GST_AMT_RECOM" value="<%=GST_AMT_RECOM%>"    maxlength="5" readonly="true" ></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td><input type="text" id="TOTALRECOMAMT" name="TOTALRECOMAMT" value="<%=TOTALRECOMAMT%>"   maxlength="5" readonly="true"></td> 
  </tr>
  <br>
  <tr>
  ...
  <tr>
    <td colspan="6" class="style1" align="center"><div align="center">
	   ...
	   <input name="button" type="button" class="class" onClick="submitform();"  value="SAVE DATA"  style="background-color:#2e823c;"/>
    </div></td>
  </tr>
</table>
<%
