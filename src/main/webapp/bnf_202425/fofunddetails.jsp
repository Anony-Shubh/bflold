...
<DIV align="center"><A class="myButton" href="JavaScript:newPopup('releaasertfo.jsp');">ADD NEW</A>
</DIV><BR>
<%}%>
...
%>
  <TR>
	...
	<TD><DIV align="center"><A href="JavaScript:newPopup('releaasertfo.jsp?BNF_ID=<%=BNF_ID%>');" class="myButton">Update</A></DIV></TD>
  </TR>
  <%
