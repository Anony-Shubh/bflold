...
<tr>
  ...
  <td width="14%"><input name="BNF_AFROMDT" type="text" id="BNF_AFROMDT" onClick="popUpCalendar(this, this.form.BNF_AFROMDT,'dd-mmm-yyyy');return false;" value="<%= BNF_AFROMDT %>" maxlength="11" readonly="true"  autocomplete="off" ></td>
  <td width="6%">To</td>
  <td width="27%"><input name="BNF_ATODT" type="text" id="BNF_ATODT" onblur="days();" onClick="popUpCalendar(this, this.form.BNF_ATODT,'dd-mmm-yyyy');return false;" value="<%= BNF_ATODT %>" maxlength="11"  autocomplete="off" ></td>
</tr>
<tr>
  <td >No of Days Organized</td>
  <td colspan="3"><input name="BNF_ATOURDYS" type="text" id="BNF_ATOURDYS" value="<%= BNF_ATOURDYS %>" maxlength="4" readonly="true" autocomplete="off"  ></td>
</tr>
<tr>
  <td > event incharge Name </td>
  <td><input name="BNF_ASTFFNME" type="text" id="BNF_ASTFFNME" value="<%= BNF_ASTFFNME %>" maxlength="60" autocomplete="off" /></td>
  <td nowrap>Contact No </td>
  <td><input name="BNF_ASTFFCNTCT" type="text" id="BNF_ASTFFCNTCT" value="<%= BNF_ASTFFCNTCT %>" maxlength="10" autocomplete="off" ></td>
</tr>
<tr>
  <td >No. of participants For : </td>
  <td colspan="3"><input name="BNF_NOOFPARTCPNTS" type="text" autocomplete="off" id="BNF_NOOFPARTCPNTS" value="<%= BNF_NOOFPARTCPNTS %>" ></td>
</tr>
...
<tr>
  ...
  <td colspan="3"><input name="BNF_ACLBNAME" type="text" id="BNF_ACLBNAME" value="<%= BNF_ACLBNAME %>" size="50" maxlength="50" autocomplete="off" ></td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="3"><input name="BNF_ATA" type="text" id="BNF_ATA" value="<%= BNF_ATA %>" autocomplete="off" ></td>
</tr>
<tr>
  <td>Subject Decision taken on/Remark : </td>
  <td colspan="3"><input name="REMARK_ADD" type="text" id="REMARK_ADD" value="<%= REMARK_ADD %>" size="60" maxlength="90" autocomplete="off" ></td>
</tr>
