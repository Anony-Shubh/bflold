...
<img src="images/04.jpg" width="100%">
  ...
  <li> <a href="../dashboard/pmegpMMtarget.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Live Performance (2018-19)</a></li>
 <!-- <li> <a href="dashboard_UM.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Live Performance (2018-19)</a></li>-->
    <li> <a href="../dashboard/pmegp_failcases_bank.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Bank Rejection Officewise</a></li>                          
         <li> <a href="../dashboard/bankwise_pmegp_failcases_bank.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Bank Rejection Bankwise</a></li>                          
           <li> <a href="../dashboard/PerformanceRepo1718.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Annual Progress Report</a></li>    
...
qrysb.append("       CASE"      );
qrysb.append("         WHEN (TRUNC(ad.FORD_DT_DLTFC) BETWEEN '01-APR-2016' AND '31-MAR-2017')"      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS dtfc_place,   "      );
qrysb.append("       "      );
qrysb.append("       SUM("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN TRUNC(ad.BANK_F_DATE) BETWEEN '01-APR-2016' AND '31-MAR-2017'"      );
...
qrysb.append("         AND TRUNC(bd.LOAN_SANC_DT) BETWEEN '01-APR-2016' AND '31-MAR-2017'"      );
qrysb.append("         AND ad.ACT_ID = 5"      );
qrysb.append("         THEN 1"      );
...
qrysb.append("       SUM(NVL("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN (TRUNC(ad.FORD_DT_DLTFC) BETWEEN '01-APR-2017' AND '31-MAR-2018')"      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS dtfc_place,   "      );
qrysb.append("       "      );
qrysb.append("       SUM("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN TRUNC(ad.BANK_F_DATE) BETWEEN '01-APR-2017' AND '31-MAR-2018'"      );
qrysb.append("         AND ad.ACT_ID = 5"      );
qrysb.append("         THEN 1"      );
qrysb.append("         ELSE 0"      );
qrysb.append("       END) AS bank_ford,"      );
...
qrysb.append("       CASE"      );
qrysb.append("         WHEN bd.ACT_ID >= 11"      );
qrysb.append("         AND TRUNC(bd.LOAN_SANC_DT) BETWEEN '01-APR-2017' AND '31-MAR-2018'"      );
qrysb.append("         AND ad.ACT_ID = 5"      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS bank_sanc,"      );
qrysb.append("      "      );
...
qrysb.append("     SUM(NVL("      );
qrysb.append("     CASE"      );
qrysb.append("       WHEN bd.ACT_ID = 11 AND  ad.ACT_ID = 5 "      );
qrysb.append("       THEN 1"      );
qrysb.append("     END, 0)) AS bank_sanc,"      );
qrysb.append("     SUM(NVL("      );
qrysb.append("     CASE"      );
...
qrysb.append("     SELECT   '2018-19' AS FNAME, "      );
qrysb.append("       SUM("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN TRUNC(ad.ONLINE_SUBDT) BETWEEN '01-APR-2018' AND TRUNC(SYSDATE)"      );
qrysb.append("         THEN 1"      );
qrysb.append("         ELSE 0"      );
qrysb.append("       END) AS APP_REC,"      );
qrysb.append("      "      );
qrysb.append("       SUM(NVL("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN (TRUNC(ad.FORD_DT_DLTFC) BETWEEN '01-APR-2018' AND TRUNC(SYSDATE))"      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS dtfc_place,   "      );
qrysb.append("       "      );
qrysb.append("       SUM("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN TRUNC(ad.BANK_F_DATE) BETWEEN '01-APR-2018' AND TRUNC(SYSDATE)"      );
qrysb.append("         AND ad.ACT_ID = 5"      );
qrysb.append("         THEN 1"      );
qrysb.append("         ELSE 0"      );
qrysb.append("       END) AS bank_ford,"      );
...
qrysb.append("       CASE"      );
qrysb.append("         WHEN bd.ACT_ID >= 11"      );
qrysb.append("         AND TRUNC(bd.LOAN_SANC_DT) BETWEEN '01-APR-2018' AND TRUNC(SYSDATE)"      );
qrysb.append("         AND ad.ACT_ID = 5"      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS bank_sanc,"      );
qrysb.append("      "      );
...
qrysb.append("         AND bd.LOAN_DOCFNAME IS NOT NULL"      );
qrysb.append("         AND bd.ACT_ID        >= 11"      );
qrysb.append("         AND TRUNC(bd.MM_CLAIM_DT) BETWEEN '01-APR-2018' AND TRUNC(SYSDATE)"      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS mmclaimed,"      );
qrysb.append("      "      );
qrysb.append("       SUM(NVL("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN bd.MM_REL_DT IS NOT NULL"      );
qrysb.append("         AND TRUNC(bd.MM_REL_DT) BETWEEN '01-APR-2018' AND TRUNC(SYSDATE)"      );
qrysb.append("         AND bd.ACT_ID >= 11 AND bd.PACT_ID        = 34 AND bd.APPRV_YN       = 'A' "      );
qrysb.append("         THEN 1"      );
qrysb.append("       END, 0)) AS MMRELEASE  "      );
qrysb.append("     FROM app_detail ad,"      );
...
<table width="90%" border="0" align="center">
  ...
  <!--<tr>
    ...
    <td><a href="../dashboard/statewisedwdb.jsp?YR=TOTAL" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></a></td>
  </tr>-->
</table>
    </h3>
  </div></td>
...
<script language="javascript">
 ...
 <!-- <tr>
    ...
    <td><a href="../dashboard/statewisedwdb_dltfc.jsp?YR=TOTAL" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></a></td>
  </tr>-->
</table>
</h3>
  ...
  <!--<tr>
    ...
    <td><a href="../dashboard/statewisedwdb_fwdbank.jsp?YR=TOTAL" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></a></td>
  </tr>-->
</table></h3>
  </div></td>
...
<tr>
 ...
 <!-- <tr>
    ...
    <td><a href="../dashboard/statewisedwdb_sanction.jsp?YR=TOTAL" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></a></td>
  </tr>-->
</table>
</h3>
  </div></td>
 ...
 <!-- <tr>
    ...
    <td><a href="../dashboard/statewisedwdb_claim.jsp?YR=TOTAL" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></a></td>
  </tr>-->
</table>
</h3>
  </div></td>
 ...
 <!-- <tr>
    ...
    <td><a href="../dashboard/statewisedwdb_release.jsp?YR=TOTAL" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></a></td>
  </tr>-->
</table>
</h3>
  </div> </td>
