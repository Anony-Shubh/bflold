...
<LI ><A href="docs/Helpdesk numbers.xlsx">Statewise Helpdesk No <SPAN style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon fa fa-facebook-official"></SPAN></A></LI>
			<LI ><A href="../nstfdcmis">NSTFDC Login  <SPAN style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon fa fa-facebook-official"></SPAN></A></LI>
		
			
			<LI ><A href="mod_edp_guideline_16102020.pdf">Modified EDP Circular <SPAN style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon fa fa-facebook-official"></SPAN></A></LI>
			<!--
			...
			-->
				<LI ><A href="https://kviconlineapp.in/mdashboard/">MSME Dashboard<SPAN style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon fa fa-facebook-official"></SPAN></A></LI>
				...
				<LI ><A href="../GrivancesMS/index.jsp">Grivences Official Login<SPAN style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-user"></SPAN></A></LI>
...
<UL id="js-news" class="js-hidden">
		 ...
		 <LI class="news-item"> EDP exempted upto 31 March 2022, Upload the Margin Money Claim without EDP Now. 
		
		<A href="EDPExemption202122.pdf" style="color: white;"> Click here -> to Download Circular </A>
		 </LI>
		  <LI class="news-item">  Long pending applications at IA and Bank as on 30 April 2020 
		  have been returned back to the applicant. Applicant can submit fresh application,if desired	 </LI>
		 
		 <LI class="news-item"> Physical verification and Geo tagging of PMEGP units 	 
		
		<A href="Phy.verification.pdf" style="color: white;"> Click here -> to Download</A>
		 </LI>
		...
		<A href="ScoreCardCircular.pdf" style="color: white;"> Click here -> to Download Score Card </A>
		  ...
		  <LI class="news-item"> 		
		Implementing Agency and Training center can download EDP training content from there respective login.
		 </LI>
       ...
       <DIV align="center">
		...
		<TABLE width="100%" style="border:2px solid black;padding:5px;background-color:#FBCBBF ">
		<TR>
		  <TD width="86%"><DIV align="center"><SPAN style="font-family:Geneva, Arial, Helvetica, sans-serif ;color:#000000;font-weight:bold;font-size:25px">For Upgradation / Expansion of existing PMEGP / REGP / MUDRA units </SPAN></DIV></TD>
		  <TD width="14%" rowspan="4"> <DIV align="center"><A href="https://www.kviconline.gov.in/khadimask"><IMG width="90%" src="images/buykhadiproducts.png"></A></DIV></TD>
		  </TR>
		<TR>
		  <TD><DIV align="center"><SPAN style="color: red;font-size: 15px;font-weight: 800;">Apply for 2nd Loan upto Rs.1.00 Crore</SPAN></DIV></TD>
		  </TR>
		<TR>
		  <TD><DIV align="center"><SPAN style="color: red;font-size: 15px;font-weight: 800;">(Avail Government Subsidy from 15% to 20%)</SPAN></DIV></TD>
		  </TR>
		<TR>
		<TD><DIV align="center"><A href="#" class="myButtonYellow style2"  id="myBtn">Apply Online</A><SPAN style="color: black;font-size: 15px;font-weight: 800;">(For Second Loan)</SPAN></DIV></TD>
		</TR>
		</TABLE>	
...
<DIV class="row" >
  <DIV class="col-sm-0">
    <DIV class="row" >
      ...
      <DIV class="col-md-3">
          <A href="../jsp/NonIndvMsg.jsp" class="btn blue" style="width: 100%;font-size: 10.5px"><B>Online Application form for Non-Individual</B></A>
      </DIV>
    ...
    <DIV class="row">
      ...
      <DIV class="col-md-3">
          <DIV class="box box2 shadow6"><BR>
            ...
            <DIV align="center"><SPAN class="link_label" style="font-size: 25px;"> EDP Training Center</SPAN><BR>
              <A href="../edpoff">Login</A></DIV>
        </DIV>
      </DIV>
