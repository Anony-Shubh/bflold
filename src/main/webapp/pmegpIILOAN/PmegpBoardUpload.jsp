...
<form method="post"  name="form" id="form" class="form" enctype="multipart/form-data" >
  ...
  <jsp:setProperty name="upBean" property="filesizelimit" value="1050000" />
   ...
   <jsp:setProperty name="upBean" property="whitelist" value="*.pdf,*.jpg,*jpeg,*.png" />
	  ...
	  <p>
        ...
        db.connect();
          ...
          String docStr="SELECT UPM_CD,DOC_DESC FROM APP_UPLOAD_MAST_SECOND WHERE  UPM_CD=16";
	...
	//ResultSet rsUp = db.execSQL(qryUp.toString());		
	  ...
	  <table align="center">
        <tr>
          <th colspan="2" scope="col"><div align="center" class="style1">PMEGP UNIT SIGNBOARD PHOTOGRAPH UPLOAD</div></th>
        </tr>
        <tr>
          <td colspan="2" scope="col"><span class="style1"><strong>1) Signboard should be 4 feet * 2.5 heet.</strong></span></td>
        </tr>
        <tr>
          <td colspan="2" scope="col"><span class="style1"><strong>2) Signboard should be located at Project sight.</strong></span></td>
        </tr>
        <tr>
          <td colspan="2" scope="col"><span class="style1"><strong>3)<a href="../pmegphome/PMEPG signboard template.pdf" target="_blank"> Download Unit Signboard template and Guidelines.</a></strong></span></td>
        </tr>
        <tr>
          <td colspan="2" scope="col"><span class="style1"><strong>4) Without Unit SignBoard Photograph,Govt. Subsidy cannot be claimed by Financing Branch</strong> </span></td>
        </tr>
		 <tr>
