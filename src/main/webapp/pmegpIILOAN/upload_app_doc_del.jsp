...
<form method="post" name="form" id="form"  >
	...
	while (rsUp.next()) {
	  ...
	  <table align="center">
        ...
        <tr>
          <td colspan="2"><div align="center"><img src="../pmegpappupload/<%= DOC_NAME %>" width="100%" height="100%">
            <div align="center">		  
          </div></td>
        </tr>
        <tr>
...
String insData="INSERT INTO APP_UPLOAD_TRANS_SECOND_DEL SELECT * FROM APP_UPLOAD_TRANS_SECOND WHERE UP_ID=?";
