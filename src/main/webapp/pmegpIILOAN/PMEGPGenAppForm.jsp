...
<head>
	...
	String vFname=request.getParameter("RNAME")==null?"SecondLoanApplication":(String) request.getParameter("RNAME");
	...
	//String outFileName ="E:\\Tomcat5\\webapps\\pmegpeportal\\jasperrop\\jaspdf\\"+vAPPID+".pdf"; 
 ...
 conn=ds.getConnection(); 
		 ...
		 hm.put("PAPPID",vAPPID);
           ...
           exporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, outFileName); 
			...
			response.sendRedirect("../jasperrop/jaspdf/"+vAPPID+".pdf");
			conn.close();
				}catch (Exception e){
