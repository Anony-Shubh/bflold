...
<form name="form"  id="form" method="post">
       ...
       String SmsText="";
        ...
        <table align="center">
          ...
          <tr>
            <td colspan="2" scope="col"><input name="ins" type="hidden" id="ins"><input name="ACT_ID" type="hidden" id="ACT_ID"  value="<%=ACT_ID%>"/></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			</td><input name="MOB_NO1" type="hidden" id="MOB_NO1" value="<%=MOB_NO1%>"><input name="APP_PWD" type="hidden" id="APP_PWD" value="<%=APP_PWD%>">
          </tr>
          <tr>
