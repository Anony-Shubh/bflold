...
<form name="form" id="form"  class="form" method="post">
  ...
  <table class="CSSTableGenerator" align="center">
    ...
    <tr>
      <th>(4)</th>
      <th nowrap><strong><span id="PMEGP" style="display:none">PMEGP</span><span id="text" style="display:none">MUDRA</span>Application ID:*</strong></th>
    ...
    <tr >
      ...
      <td colspan="4"><div align="left">
          <input name="UAD" type="text"   class="aadharimg" id="UAD"  size="17" maxlength="12" />
      </div></td>
    </tr>
    <tr >
      <th>(6)</th>
