...
String SCHEME_NM= request.getParameter("schemenm")==null?"":(String) request.getParameter("schemenm");
//out.print(UAD);
String state="";
String qrystr="";
String qrystr1="";
...
<table align="center">
 ...
 rs = db.execSQL("SELECT  DISTINCT(TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A ,M_DISTRICT B WHERE  A.district_cd=B.district_cd(+) AND A.ACT_YN='Y' ORDER BY BANK_NAME");
      ...
      <tr>
        <td>&nbsp;</td><input name="FLAG" type="hidden" id="FLAG" value="3"><input name="SCHEME" type="hidden" id="SCHEME" value="<%=SCHEME_NM%>">
        <td>Branch Name*: </td>
