...
ResultSet rsMANU= db.execSQL("SELECT case when bd.ist_loan_dt < trunc(SYSDATE) - 1095 then 'Y' else 'N' end as elg_yn from app_detail ad,bank_dataentry bd where ad.app_id=bd.app_id(+) and ad.app_id='"+APP_ID+"'  ");

		   while (rsMANU.next()) {  //3
           ELG_YN=rsMANU.getString(1);
           } //3  
		   rsMANU.close();
...
<table align="center">
    ...
    <tr>
      ...
      <tr>
        ...
        <td colspan="2"><input name="UAD" type="text"  id="UAD"  size="20" maxlength="20" value="<%=UAD%>"  /></td>
      ...
      <tr>
		...
		<select name="BANK_NAME"  id="BANK_NAME" >
            ...
            <%
 rs = db.execSQL("SELECT  DISTINCT(TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A ,M_DISTRICT B WHERE  A.district_cd=B.district_cd(+)  ORDER BY BANK_NAME");
	   while(rs.next()){ 
	   %>
      ...
      <tr>
        ...
        <th colspan="4" nowrap><input type="text"  id="IST_LOAN_DT" name="IST_LOAN_DT" value="" onClick="javascript:NewCssCal('IST_LOAN_DT','ddMMMyyyy')" placeholder="DD-MON-YYYY" size="11" maxlength="11" ></th>
      </tr>
      <tr>
      ...
      <td colspan="2"><div align="center">
        <input type="text"  id="REPAY_DT" name="REPAY_DT" value="" placeholder="DD-MON-YYYY" onClick="javascript:NewCssCal('REPAY_DT','ddMMMyyyy')" size="11" maxlength="11">
      </div></td>
  ...
  <% } else if (ELG_YN.equals("N")) {%>
  
   <table>
	<tr>	
	<h1 align="center">AS PER PMEGP SCHEME GUIDELINES YOUR APPLICATION HAS NOT COMPLETED 3 YRS FROM THE DATE OF MM DISBURSEMENT HENCE YOU ARE NOT ELIGIBLE FOR SECOND LOAN </h1>
	</tr>
  ...
  <%} else if (applen < 10 ){%>
	...
	<tr>	
	<h1 align="center">Please Enter Full Application ID(For ex-(KBTN1234-88888)</h1>
	</tr>
