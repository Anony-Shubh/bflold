...
<form name="form" id="form" class="form" method="post">
  ...
  String BANK_NAME =request.getParameter("BANK_NAME")==null?"Please Select Bank":js.getOnlyText((String)request.getParameter("BANK_NAME"),100); 
  String SDISTRICT=request.getParameter("SDISTRICT")==null?"0": js.getOnlyText((String)request.getParameter("SDISTRICT"),50); 
    String BRIFSC=request.getParameter("BRIFSC")==null?"": js.getOnlyText((String)request.getParameter("BRIFSC"),11); 
  String BRADDR=request.getParameter("BRADDR")==null?"": js.getOnlyText((String)request.getParameter("BRADDR"),25); 

    String vstate =request.getParameter("state")==null?"": js.getOnlyText( (String)request.getParameter("state"),25); 
