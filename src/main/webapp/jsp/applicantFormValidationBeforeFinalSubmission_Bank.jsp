...
qrysb.append("     MD.STATE_CD,A.ACTIVITY_CD,"      );
qrysb.append("     A.IFSC_CODE,A.BENF_TYPE_CD,"      );
qrysb.append("     BRM.ACT_YN,MS.ZONE_CD,"      );
...
qrysb.append("     A.EDU_ID,case when MD.DISTRICT_CD in (600,118) then 'N' else 'Y' end as dist_subyn,"      );
...
aerror.add(ACTIVITY_NAME+" Activity doess not belong to Manufacturing Industry...PLz Change the industry Type");
 ...
 /* if ( NER_YN.equals("Y")) {
  ...
  if (AADHAR_NO.equals("")) {
   ...
   aerror.add("For the Selected District Forward to bank is Not Allowed.....");
  }
