...
<form method="post" name="form" id="form"  >
	...
	while (rsUp.next()) {
	  ...
	  <table align="center">
        ...
        <tr>
          ...
          <input name="ins" type="hidden" id="ins" value="">  <input name="APP_ID" type="hidden" id="APP_ID" value="<%=APP_ID%>"></th>
   ...
   List values=new ArrayList();
		...
		qryUpdate.append("DELETE FROM  APP_UPLOAD_TRANS  WHERE UP_ID=? AND APP_ID=?");
		values.clear();
        pstm.clear();
values.add(UP_ID); pstm.add ("L");
values.add(APP_ID); pstm.add ("L");
String insData="INSERT INTO APP_UPLOAD_TRANS_DEL SELECT * FROM APP_UPLOAD_TRANS WHERE UP_ID=? AND APP_ID=? ";
