...
<body>
 <form name="form" id="form"  class="form" method="post">
		...
		qrysb.append(" FROM APP_DETAIL_second AD,ACTIVITY_MAST AM, MAS_OFF_MAST MOM ,APP_STATUS_MAST ASM ");
...
<tr bgcolor="#FF9E5E" >
    <td colspan="4"><center><h2>Note: Unit District and Office can be Change only before Approve or Reject and forward to Bank. </h2></center></td>
    </tr>
 ...
 <th>Applicant_ID</th>
  ...
  <tr>
   ...
   <%
		...
		sb.append("  UPDATE APP_DETAIL_SECOND SET  ").
		append("   OFF_CD=?, UNIT_DIST_CD=? WHERE APP_ID=? AND ACT_ID<4 ");
