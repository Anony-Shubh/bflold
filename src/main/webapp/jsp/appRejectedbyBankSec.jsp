...
<body> 
 <form name="form" id="form"  class="form" method="post" action="appRejectedbyBankSec.jsp">
...
<p>    
  ...
  <tr>
    <th scope="row"> Forwarding Date to 1st Bank </th>
    <td><%= BANK_F_DATE %></td>
    <th>2ND Bank IFS Code: </th>
    <td><H2 class="mtextarea"><%= IFSC_CODE2 %></H2></td>
  </tr>
  <tr>
    <th scope="row">1st Bank IFS Code: </th>
  ...
  <tr>
    ...
    <tr>
     ...
     <%
	  ...
	  APP_NM = request.getParameter("APP_NAME")==null?"0":request.getParameter("APP_NAME");
...
//out.print(APP_ID1);
			 ...
			 qryUpdate.append("UPDATE APP_DETAIL_SECOND SET  ACT_YN='N'  WHERE APP_ID='"+APP_ID1+"'  ");
...
db.close();
	response.sendRedirect("save.jsp");
			...
			//String SmsText=" "+APP_NM+ ",Your PMEGP application has been returned for new submission.Contact to the concerned agency for further information and clarification. ";
