...
ResultSet rsDist = db.execSQL("SELECT DISTRICT_CD,DISTRICT_NAME FROM M_DISTRICT WHERE DISTRICT_CD='"+UNIT_DIST_CD+"'");
	%>
...
<form name="form"  id="form" method="post"  >
  ...
  <tr>
    ...
    <td colspan="3"><input name="AADHAR_NO" type="text" class="aadharimg" id="AADHAR_NO" value="<%= AADHAR_NO %>" size="17" maxlength="12" readonly="true" /></td>
  </tr>
  <tr>
    <th>(2)</th>
	...
	<select name="APP_PRIX" id="APP_PRIX">
      ...
      <option value="Ms." <% if (APP_PRIX.equals("Ms.")){out.print("selected");}%>>Ms.</option>
        ...
        <input name="APP_NAME" type="text"  id="APP_NAME" readonly="true" value="<%=APP_NAME  %>"/></td>
  </tr>
  
  <tr>
    <th>(3)</th>
    <th colspan="2" nowrap><strong> Sponsoring Agency*:</strong></th>
    <td colspan="3"><select name="AGENCY" class="button" id="AGENCY"   onchange="showOffice(this.value);" >
  ...
  <tr>
    ...
    <td colspan="3"><select name="STATE" class="button"  id="STATE" onBlur="showOffice(this.value);" onChange="showDistrict(this.value);">
      <option value="-1">--Select State--</option>
      <%
	    qrystr="SELECT  ms.state_cd, initCap(ms.state_nm) as state_nm FROM m_state ms WHERE MS.STATE_CD IN (SELECT STATE_CD FROM M_DISTRICT WHERE DISTRICT_CD="+UNIT_DIST_CD+")";
  ...
  <tr>
    ...
    <td id ='DISTRICT' colspan="3"><select name="DISTRICT" class="button" onChange="showOffice(this.value);" >
	<% 
	String vDistCd="";
	String vDistnm="";
	while (rsDist.next()) { 
  ...
  <tr>
    ...
    <th colspan="3"> <input name="BENF_TYPE_CD" id="BENF_TYPE_CD" type="hidden" value="1" />
      INDIVIDUAL</th>
  </tr>
  <tr>
    <th>(8)</th>
    <th colspan="2" nowrap><strong>Gender:*</strong></th>
    <td colspan="3"><select name="GENDER" class="button" id="GENDER">
  ...
  <tr>
    ...
    <td colspan="3"><input name="DOB" type="text" class="mob"  id="DOB" onBlur="checkDateAge();" onKeyPress="return onlyDate(event);"  size="13" maxlength="10" value="<%= DOB %>" />
      Age:
      <input name="AGE" type="text" id="AGE" size="5" maxlength="3" style="background-color: #FFCCCC" readonly="true" value="<%= AGE %>" /></td>
  </tr>
  <tr>
    <th rowspan="2">(10)</th>
    <th colspan="2" rowspan="2" nowrap><strong>Social  Category : *</strong></th>
  ...
  <tr>
    ...
    <td colspan="3"><select name="EDU_ID" class="button" id="EDU_ID" >
      <option value="">--Select---</option>
      <%
while (rsEdu.next()) {
...
%>
  ...
  <tr>
    ...
    <td colspan="3"><input name="APP_POST_ADDR" type="text" id="APP_POST_ADDR"  size="50" maxlength="99" onKeyPress="return RestrictSpecialChar(event);" value="<%=APP_POST_ADDR  %>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">Taluk/Block*:</td>
    <td colspan="3"><input name="APP_TALUK_BLOCK" type="text" id="APP_TALUK_BLOCK" size="50" maxlength="60" onKeyPress="return RestrictSpecialChar(event);"  value="<%=APP_TALUK_BLOCK  %>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">Pin*:</td>
    <td colspan="3"><input name="APP_PIN" type="text" id="APP_PIN"  onkeypress="return numbersonly(event);" size="10" maxlength="6" value="<%=APP_PIN  %>"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="3"><input name="E_MAIL" type="text" id="E_MAIL" size="20"  maxlength="58" value="<%=E_MAIL %>"/></td>
  </tr>
  <tr>
    <th>&nbsp;</th>
    <th colspan="2" nowrap>PAN NO: </th>
    <td colspan="3"><input name="PAN_NO" type="text" id="PAN_NO"   size="20" maxlength="10" value="<%=PAN_NO %>"/></td>
  </tr>
  <tr>
    <th>(13)</th>
  ...
  <tr>
    ...
    <td colspan="3"><input name="UNIT_POST_ADDR" type="text" id="UNIT_POST_ADDR"  size="45" maxlength="99" onKeyPress="return RestrictSpecialChar(event);" value="<%=UNIT_POST_ADDR  %>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">Taluk/Block*</td>
    <td colspan="3"><input name="UNIT_TALUK_BLOCK" type="text" id="UNIT_TALUK_BLOCK"  size="40" maxlength="55" onKeyPress="return RestrictSpecialChar(event);" value="<%= UNIT_TALUK_BLOCK %>"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">Pin*</td>
    <td colspan="3"><input name="UNIT_PIN" type="text" id="UNIT_PIN"  onkeypress="return numbersonly(event);" size="10" maxlength="6" value="<%= UNIT_PIN %>" /></td>
  </tr>
  <tr>
    <th>(15)</th>
  ...
  <tr>
    ...
    <td colspan="3"><input name="PROD_DESC" type="text" id="PROD_DESC"  size="50" maxlength="50" onKeyPress="return RestrictSpecialChar(event);" value="<%=PROD_DESC  %>"/></td>
  </tr>
  <tr>
    <th>(17)</th>
    <th colspan="2" nowrap><strong>EDP Training Undergone:*
      <input name="EDP_INST_ADDR2" type="hidden" id="EDP_INST_ADDR" onKeyPress="return RestrictSpecialChar(event);" value="" />
    ...
    <td colspan="3"><select name="EDP_YN" id="EDP_YN">
      <option value="">-Select-</option>
  ...
  <tr>
    ...
    <td colspan="3"><input name="EDP_INST_ADDR" type="text" id="EDP_INST_NM" onKeyPress="return RestrictSpecialChar(event);" size="50" maxlength="50" value="<%=EDP_INST_ADDR  %>" /></td>
  </tr>
  <tr>
    <th nowrap>(19)</th>
  ...
  <tr>
    ...
    <td colspan="3"><select name="BANK_NAME" id="BANK_NAME" class="button"  >
 ...
 rs = db.execSQL("SELECT  DISTINCT(TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A");
  ...
  <tr>
    ...
    <td colspan="3"><input name="BRANCH_NAME" type="text" id="BRANCH_NAME"  size="60" maxlength="100" onKeyPress="return RestrictSpecialChar(event);" value="<%=BRANCH_NAME  %>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">Address*:</td>
    <td colspan="3"><input name="BANK_POST_ADDR" type="text" id="BANK_POST_ADDR" onKeyPress="return RestrictSpecialChar(event);" size="70" value="<%=BANK_POST_ADDR  %>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">District:</td>
    <td colspan="3"><input name="BANK_DISTRICT" type="text" id="BANK_DISTRICT" size="30" maxlength="25" onKeyPress="return RestrictSpecialChar(event);" value="<%=BANK_DISTRICT  %>" /></td>
  </tr>
  <tr>
    <th>(21)</th>
 ...
 rs = db.execSQL("SELECT  DISTINCT(TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A ,M_DISTRICT B WHERE  A.district_cd=B.district_cd");
  ...
  <tr>
    ...
    <td colspan="3"><input name="IFSC_CODE2" type="text" id="IFSC_CODE2" value="<%=IFSC_CODE2  %>" maxlength="11" readonly="true" />
...
db.executeUpdate() ;
db.close();
response.sendRedirect("dltfcAppwiseUpdate.jsp?txtSearch="+APP_ID+"");
