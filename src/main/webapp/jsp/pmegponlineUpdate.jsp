...
qrysb.append("     DECODE(ad.aadhar_no,NULL,NULL, '*********'     || substr(ad.aadhar_no,10,length(ad.aadhar_no)-6)) AADHAR_NO," );
...
qryUpdate.append(" ONLINE_SUBDT=SYSDATE,TECH_QUALI=?,BLDG_TYPE=?,CLIENT_IP=? WHERE APP_ID=?  ");
...
db.executeUpdate() ;
db.close();
response.sendRedirect("pmegponlineUpdate.jsp");
