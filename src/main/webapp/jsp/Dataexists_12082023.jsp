...
response.sendRedirect("upload_app_doc.jsp");
	  ...
	  <table align="center">
       ...
       <!-- <tr>
        ...
        <tr>-->
          <td colspan="5" class="redLebel"><div align="center"><h3><strong>(Note:Please note your application id received on registered mobile no for future reference .Your Application Will not be Considered Valid Until it is Finally Submitted to The Concerned Office)</strong></div></td>
        </tr>
