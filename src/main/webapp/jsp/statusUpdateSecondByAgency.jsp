...
av.append(" SELECT ad.APP_ID,TO_CHAR(AD.ONLINE_SUBDT,'DD-MON-RRRR HH:MM:SS') AS ONLINE_SUBDT, ").
 append(" ad.APP_NAME,ad.MOB_NO1,TO_CHAR(AD.ONLINE_SUBDT, 'DD-MON-RRRR') AS APP_REC_DATE, TO_CHAR(SYSDATE,'DD-MON-RRRR') AS TODAYDT, ").
...
if (ACT_ID == "5"){
window.location.href="SecapplicantForBank.jsp?APP_ID="+APP_ID;
}
}
</script>
</head>
...
<form  method="post" name="form" id="form">
  ...
  <table align="center">
    ...
    <tr>
      ...
      Applicant Id :
        <input name="ACT_ID1" type="radio" disabled value="0" <% if (ACT_ID.equals("0")){out.print("Checked");}%>></th>
      <th><%=APP_ID %> </th><input type="hidden" name="APP_ID" id="APP_ID" value="<%=APP_ID%>"/>
      <th><div align="right">Name Of Applicant :</div></th>
      <th><%=  APP_NAME %></th>
    </tr>
    <tr >
      <th nowrap>Online Submission Date and Time: </th>
      <th colspan="3" nowrap><div align="left"><%= ONLINE_SUBDT %></div></th>
    </tr>
    <tr >
      <th nowrap>eMail:</th>
    ...
    <tr >
      ...
      Under Process
        ...
        <input name="ACT_ID"  id="ACT_ID" type="radio"  onChange="test();" value="5" <% if (ACT_ID.equals("5")){out.print("Checked");}%>>
      Forwarded to Bank</span> </span></th>
    </tr>
    <tr >
      <td colspan="4" class="GreenLebel" ><div align="center" class="redLebel"></div></td>
    </tr>
    <tr >
...
//String vtoDate=ACT_ID.equals("1")?TODAYDT:"";

	List values=new ArrayList();
		List pstm=new ArrayList();
		StringBuffer qryUpdate = new StringBuffer();
//out.print (vtoDate);
qryUpdate.append(" UPDATE APP_DETAIL_SECOND SET REMARKS=?,APP_REC_DATE=SYSDATE,");
qryUpdate.append("  ACT_ID=? WHERE APP_ID=? AND ACT_ID IN (0,1,3)");
...
db.executeUpdate() ;
if (ACT_ID.equals("3")) {
	 String sms_string="Dear "+APP_NAME+" your application "+APP_ID +" has been rejected by the concerned Agency.";
