...
<form>
  <p>
	  ...
	  MOB_NO1=rsApp.getString("MOB_NO1")==null?"":rsApp.getString("MOB_NO1");
		...
		qryUp.append("   WHERE  AUT.UPM_CD = AUM.UPM_CD  ");
		qryUp.append("    AND AUT.APP_ID='"+APP_ID+"' ");
...
qryRemarks.append(" FROM MM_REMARKS_TRANS_SECOND MRT, ");
 qryRemarks.append("  BANK_APP_STATUS APS, ");
 qryRemarks.append("  BANK_DATAENTRY_SECOND BD ");
  ...
  %>
      ...
      <table width="100%"  border="1">
        <tr>
          ...
          <th nowrap><div align="center"><a href="../bankModule/docviewSec.jsp?docname=<%= LOAN_DOCFNAME %>" class="greenButtonRound">Loan Disbursment Statement  </a> 
...
<!--<a href="../bankModule/uploadclaim/<%= LOAN_DOCFNAME %>" class="greenButtonRound">Loan Disbursment Statement </a>-->
	 ...
	 if (ORG_CD.equals("KV")) {
	 %>
      <p align="center"><a href="upload_app_doc_mmSec.jsp?APP_ID=<%= APP_ID %>" class="buttonOrange">UPLOAD DOCUMENT (FOR SO/DO) </a></p>
	  <%}%>
      <p align="center">&nbsp;</p>
