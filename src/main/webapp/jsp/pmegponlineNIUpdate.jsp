...
String APP_NAME = "";
String FH_NAME = "";
String BENF_TYPE_CD = request.getParameter("BENF_CD")==null?"0":(String) request.getParameter("BENF_CD");
...
REGD_NO=rsMain.getString("REGD_NO")==null?"":rsMain.getString("REGD_NO");
TAN_NO=rsMain.getString("TAN_NO")==null?"":rsMain.getString("TAN_NO");
 ...
 AUTH_DESIG=rsMain.getString("AUTH_DESIG")==null?"":rsMain.getString("AUTH_DESIG");
BLDG_TYPE=rsMain.getString("BLDG_TYPE")==null?"":rsMain.getString("BLDG_TYPE");
}
...
<body onLoad="edpyn();showOffice(this.value);">
<%!
  ...
  <table class="CSSTableGenerator">
    ...
    <tr bgcolor="#D1A476">
      ...
      <tr>
        ...
        <td colspan="3"><input name="APP_NAME" type="text"  id="APP_NAME"   value="<%= APP_NAME %>" size="70" maxlength="100" /></td>
      </tr>
      <tr>
        <th>(3)</th>
		...
		<input name="REGD_NO" type="text"  id="REGD_NO"   value="<%= REGD_NO %>" size="30" maxlength="20" onKeyPress="return RestrictSpecialChar(event);" />
		 <% } else {%>
      ...
      <tr>
		...
		<input name="DOB" type="text" class="mob"  id="DOB" onBlur="checkDateAge();" onKeyPress="return onlyDate(event);"  value="<%= DOB %>" size="13" maxlength="10" />
      ...
      <tr>
        ...
        <td colspan="3">
		 <% if (!(BENF_TYPE_CD.equals("4"))) {%>
		<input name="TAN_NO" type="text"  id="TAN_NO" value="<%= TAN_NO %>" size="15" maxlength="10" onKeyPress="return RestrictSpecialChar(event);" />
		<% } else {%>
      ...
      <option value="M/s." <% if (APP_PRIX.equals("M/s.")){out.print("selected");}%>>M/s.</option>
		  ...
		  <input name="FH_NAME" type="text"  id="FH_NAME"   value="<%= FH_NAME %>" size="30" maxlength="100" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <th>(7 A)</th>
        <th colspan="2" nowrap>Designation*:</th>
        <td colspan="3"><input name="AUTH_DESIG" type="text"  id="AUTH_DESIG"   value="<%= AUTH_DESIG %>" size="30" maxlength="20" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      
      <tr>
        <th>(7 B)</th>
        <th colspan="2" nowrap><strong>AADHAAR No. of Authorised Person: </strong></th>
        <td colspan="3"><input name="AADHAR_NO" type="text" class="aadharimg"  id="AADHAR_NO" maxlength="12" onKeyPress="return numbersonly(event);" value="<%= AADHAR_NO %>" /></td>
      </tr>
      <tr>
        <th>(7 D)</th>
        <th colspan="2" nowrap>PAN No of <strong>Authorised Person : </strong></th>
        <td colspan="3"><input name="PAN_NO" type="text" id="PAN_NO"   size="20" maxlength="10" value="<%= PAN_NO %>" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <th>(8)</th>
		...
		<select name="AGENCY" class="button" id="AGENCY"   onchange="showOffice(this.value);" >
      ...
      <tr>
		...
		<td id ='DISTRICT' colspan="3">
		
		<select name="DISTRICT" class="button" onChange="showOffice(this.value);" >
	<% 
	String vDistCd="";
	String vDistnm="";
	while (rsDist.next()) { 
	...
	%>
      ...
      <tr>
        ...
        <td colspan="3"><input name="APP_POST_ADDR" type="text" id="APP_POST_ADDR" value="<%= APP_POST_ADDR %>" size="50" maxlength="99" onKeyPress="return RestrictSpecialChar(event);" /></td>
        </tr>
      ...
      <tr>
        ...
        <td colspan="3"><input name="APP_TALUK_BLOCK" type="text" id="APP_TALUK_BLOCK" value="<%= APP_TALUK_BLOCK %>"size="50" maxlength="60" onKeyPress="return RestrictSpecialChar(event);" /></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2"><input name="APP_DIST_CD" type="hidden" id="APP_DIST_CD" value= "<%= APP_DIST_CD %>"/>
District*:</td>
        <td colspan="3"><input name="APP_DIST_NM" type="text" id="APP_DIST_NM"  style="background-color: #FFCCCC" readonly="true" value="<%= APP_DIST_NM %>" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Pin*:</td>
        <td colspan="3"><input name="APP_PIN" type="text" id="APP_PIN"  onkeypress="return numbersonly(event);" value= "<%= APP_PIN  %>" size="10" maxlength="6" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <th colspan="2" nowrap>Authorised Person Mobile No:*:</th>
        <td colspan="3">(1)<input name="MOB_NO1" type="text" class="mob"  id="MOB_NO1" onKeyPress="return numbersonly(event);" value= "<%= MOB_NO1  %>" size="14" maxlength="10" /> 
          Office Telephone No: 
            <input name="MOB_NO2" type="text" class="mob"  id="MOB_NO2" onKeyPress="return numbersonly(event);" value= "<%= MOB_NO2  %>" size="14" maxlength="10" /> </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <th colspan="2" nowrap>Office eMail:</th>
        <td colspan="3"> <input name="E_MAIL" type="text" id="E_MAIL" value= "<%=E_MAIL %>" size="40"  maxlength="58" /></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th colspan="2" nowrap>Bank Account of  <%= BENF_TYPE_DESC %></th>
        <td colspan="3"><input name="BANK_ACCNO" type="text" id="BANK_ACCNO" value= "<%=BANK_ACCNO %>" size="20"  maxlength="20" /></td>
      </tr>
      <tr>
        <th>(15)</th>
        <th colspan="2" nowrap>Unit Location </th>
        <td colspan="3"><select name="UNIT_LOC" class="button" id="UNIT_LOC" >
      ...
      <tr>
        ...
        <td colspan="3"><input name="UNIT_POST_ADDR" type="text" id="UNIT_POST_ADDR"  value= "<%=UNIT_POST_ADDR %>" size="45" maxlength="99" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Taluk/Block*</td>
        <td colspan="3"><input name="UNIT_TALUK_BLOCK" type="text" id="UNIT_TALUK_BLOCK"  value="<%= UNIT_TALUK_BLOCK %>"  size="40" maxlength="55" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2"> District*
          <input name="UNIT_DIST_CD" type="hidden" id="UNIT_DIST_CD" value="<%= UNIT_DIST_CD %>" /></td>
        <td colspan="3"><input name="UNIT_DIST_NM" type="text" id="UNIT_DIST_NM" style="background-color: #FFCCCC"  readonly="true" value="<%= UNIT_DIST_NM %>" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Pin*</td>
        <td colspan="3"><input name="UNIT_PIN" type="text" id="UNIT_PIN"  onkeypress="return numbersonly(event);" value="<%= UNIT_PIN %>"  size="10" maxlength="6" /></td>
      </tr>
      <tr>
        <th>(17)</th>
        <th colspan="2" nowrap><strong>Type of Activity  : * </strong></th>
        <td colspan="3"><select name="IND_TYPE" class="button" id="IND_TYPE" >
      <option value="" selected>-Select-</option>
      ...
      <tr>
        ...
        <td colspan="3"><input name="PROD_DESC" type="text" id="PROD_DESC" value="<%= PROD_DESC %>" size="50" maxlength="50" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <th>(19)</th>
		...
		<select name="EDP_YN" id="EDP_YN"  onChange="edpyn();">
      <option value="">-Select-</option>
      ...
      <td colspan="3"><input name="EDP_INST_ADDR" type="text" id="EDP_INST_ADDR" onKeyPress="return RestrictSpecialChar(event);" value="<%=EDP_INST_ADDR  %>" size="50" maxlength="50" /></td>
      </tr>
      <tr>
        <th nowrap>(21)</th>
      ...
      <tr>
        ...
        <td colspan="2">&nbsp;</td>
        <td><div align="center">
          <input name="MACHINARY_COST" type="text" id="MACHINARY_COST" onChange="proj_cal();" value="<%= MACHINARY_COST %>" size="8" maxlength="7" onKeyPress="return numbersonly(event);"/>
        </div></td>
        <td><div align="center">
          <input name="WORKING_CAPITAL" type="text" id="WORKING_CAPITAL"  onchange="proj_cal();" onKeyPress="return numbersonly(event);" value="<%= WORKING_CAPITAL %>" size="8" maxlength="7" />
          &nbsp;</div></td>
        <td><div align="center">
      ...
      <tr>
        ...
        <td colspan="3">
          <select name="BANK_NAME" class="button"  >
 ...
 rs = db.execSQL("SELECT  DISTINCT(TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A");
      ...
      <tr>
        ...
        <td colspan="3"><input name="IFSC_CODE" type="text" id="IFSC_CODE"  style="background-color: #FFCCCC" size="11" maxlength="20"  readonly="true" value="<%= IFSC_CODE %>"/>
          <input name="btnBank" id="btnBank" type="button" class="button" onClick=" rbilist_lov()"  value="Select  Bank IFS Code and Address" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Branch Name*: </td>
        <td colspan="3"><input name="BRANCH_NAME" type="text" id="BRANCH_NAME"  value="<%= BRANCH_NAME %>" size="60" maxlength="100" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Address*:</td>
        <td colspan="3"><input name="BANK_POST_ADDR" type="text" id="BANK_POST_ADDR" onKeyPress="return RestrictSpecialChar(event);" value="<%= BANK_POST_ADDR %>" size="70" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      <td colspan="2">District:</td>
      <td colspan="3"><input name="BANK_DISTRICT" type="text" id="BANK_DISTRICT" value="<%= BANK_DISTRICT %>" size="30" maxlength="25" onKeyPress="return RestrictSpecialChar(event);" /></td>
    </tr>
      
      <tr>
        <th>(23)</th>
      <th colspan="2" nowrap>2nd Financing Branch IFS Code <input type="hidden" name="BANK_TYPE" id="BANK_TYPE" value="1" /></th>
      <td colspan="3"><input name="IFSC_CODE2" type="text" id="IFSC_CODE2" maxlength="11"  value="<%= IFSC_CODE2 %>"/></td>
      </tr>
...
AUTH_DESIG=(String) request.getParameter("AUTH_DESIG")==null?"":(String) request.getParameter("AUTH_DESIG").trim();
REGD_NO=(String) request.getParameter("REGD_NO")==null?"":(String) request.getParameter("REGD_NO").trim();	
TAN_NO=(String) request.getParameter("TAN_NO")==null?"":(String) request.getParameter("TAN_NO").trim();	
BANK_ACCNO=(String) request.getParameter("BANK_ACCNO")==null?"":(String) request.getParameter("BANK_ACCNO").trim();	
   out.print(REGD_NO); 
	   out.print(TAN_NO); 
	      out.print(BANK_ACCNO); 
...
qryUpdate.append(" UPDATE APP_DETAIL_ONLINE SET ");
...
qryUpdate.append("EDP_YN=?, AUTH_DESIG=?,REGD_NO=?,TAN_NO=?,");
...
values.add(AUTH_DESIG); pstm.add ("L");

values.add(REGD_NO); pstm.add ("L");
values.add(TAN_NO); pstm.add ("L");
