...
if(OP_PASS =""  ) { 
    inlineMsg('OP_PASS','Enter Old Password',2);
    return false;
    }
 if(NP_WORD == "") {
...
-->
   ...
   <%
       String OFF_CD =session.getAttribute("sOffCd")==null?"":(String) session.getAttribute("sOffCd");
  ...
  <th colspan="3"><div align="center"> 
      ...
      <span class="style90 style96">PASSWORD CHANGE FOR DLTFC FORM</span>
...
<th>ENTER OLD PASSWORD*</th>
   <td>
      <input name="OP_PASS" type="password" id="OP_PASS"  value="<%= OP_PASS %>" size="20" maxlength="10">
      </td>
    </tr>
	<tr>
<th>ENTER NEW PASSWORD*</th>
    <td ><input name="NP_WORD" type="password" id="NP_WORD"  value="<%= NP_WORD %>" size="20" maxlength="10"></td>	
</tr>
<tr>
<th>CONFIRM NEW PASSWORD*</th>
    <td ><input name="CP_WORD" type="password" id="CP_WORD"  value="<%= CP_WORD %>" size="20" maxlength="10"></td>	
</tr>
<tr>
<th colspan="3"> 
          <div align="center">
   ...
   <%
		...
		qry.append(" SELECT nvl(COUNT(*),0) FROM MAS_OFF_MAST WHERE OFF_CD=? AND P_WORD=? AND CONV_DLTFCYN='Y' " );
...
if (cnt.equals("1")) {
		 ...
		 qrysb.append(" UPDATE MAS_OFF_MAST SET P_WORD=? WHERE OFF_CD=? AND CONV_DLTFCYN='Y' " );
