               ...
               <tr>
				...
				String MTG_ID="";
				 ...
				 String NO_OF_APP_PLACED="";
				  ...
				  while (rs.next()) {
				  MTG_ID=rs.getString(1);
				  MT_DATE=rs.getString(2);
				  NO_OF_APP_PLACED=rs.getString(3);
				  
				   %>
                     <option value=" <%=  MTG_ID %> ">ID:<%=  MTG_ID %> Date:<%= MT_DATE %> (<%= NO_OF_APP_PLACED %>)</option>
                     <% 
				   } 
				   rs.close();
				   %>
...
String vqry="UPDATE APP_DETAIL SET MTG_ID="+MTG_ID+",DLTFC_PROC_DT=SYSDATE WHERE APP_ID IN ("+vwhercls+") AND MTG_ID IS NULL AND ACT_ID=2  ";
/*
