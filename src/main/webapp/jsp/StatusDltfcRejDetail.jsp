...
%>
  ...
  <table align="center">
    <tr>
      <th colspan="4"><div align="center">Details for Rejection </div></th>
    </tr>
    <tr>
    ...
    <tr >
      <th>DLTFC Remarks for Rejection: </th>
...
qryUpdate.append("  UPDATE APP_DETAIL SET ACT_ID=5,  BANK_F_DATE =SYSDATE ,CLIENT_IP=? WHERE APP_ID=? ");
values.clear();
pstm.clear();
