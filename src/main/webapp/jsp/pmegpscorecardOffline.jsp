...
qrysb.append("    PSC.LOCATION_ADV,  PSC.SKILL_CERTIFICATION,  PSC.MARKETING_TU,  PSC.LINE_OF_ACT,  PSC.REG_GOV_AUTH, PSC.HO_VERIFY_YN,   "      );
...
qrysb.append(" PSC.INSU_REMARK,  PSC.INSU_DOC,  PSC.INCOME_REMARK,  PSC.OTHSOUR_REMARK,  PSC.INCOME_DOC,  PSC.OTHSOUR_DOC, "      );
 qrysb.append(" PSC.EXP_REMARK,  PSC.ADDR_REMARK,  PSC.EXP_DOC,  PSC.ADDR_DOC,  PSC.HOUSE_REMARK,  PSC.DEPEN_REMARK,  PSC.HOUSE_DOC,  PSC.DEPEN_DOC,PSC.AGENCY_DOC,PSC.AGENCY_REMARK,PSC.ADDL_REMARK,PSC.ADDL_DOC, PSC.DSCR_DOC,  PSC.DSCR_REMARK,  "      );
qrysb.append("  PSC.CR_DOC,  PSC.CR_REMARK,  PSC.LOC_DOC,  PSC.MARK_DOC,  PSC.MARK_REMARK,  PSC.LOC_REMARK,  PSC.REPY_REMARK,PSC.COLSEC_DOC,PSC.COLSEC_REMARK,  PSC.REPY_DOC  FROM PMEGP_SCORE_CARD PSC    "      );
...
<CENTER>
 <a href="AppSearchLOVOFF.jsp" class="greenButtonRound">Back</a>
<H1>PMEGP SCORE CARD</H1>
<H1>(<SPAN class="style5"><STRONG>Note: You can Upload Documents after entering marks</STRONG></SPAN>) </H1>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (DEPEN_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=1" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!DEPEN_DOC.equals("")){ %>
    <INPUT type="button" name="button2" id="button2" class="myButton" style="background-color:#009933;" value="View" onClick="viewdocument('<%= DEPEN_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!DEPEN_DOC.equals(""))){%>
    <A href="Upload_score_app_del.jsp?UPM_CD=1" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (HOUSE_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=2" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!HOUSE_DOC.equals("")){ %>
    <INPUT type="button" name="button3" id="button3" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= HOUSE_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!HOUSE_DOC.equals(""))) {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=2" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
  <TD><P align="center"><%=HOUSE_REMARK %></P></TD>
...
<TR>
  ...
  <TD><P>
    <% if ((add_update.equals("U")) && (ADDR_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=3" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!ADDR_DOC.equals("")){ %>
    <INPUT type="button" name="button4" id="button4" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= ADDR_DOC %>');">
    <%}%>
  </P></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!ADDR_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=3" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
  <TD><P align="center"><%=ADDR_REMARK %></P></TD>
  <TD colspan="3">      <DIV align="center">
    <P>5</P>
    <P>3</P>
    <P>2</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (EXP_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=4" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!EXP_DOC.equals("")){ %>
    <INPUT type="button" name="button5" id="button5" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= EXP_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!EXP_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=4" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
  <TD><%=EXP_REMARK %></TD>
  <TD colspan="3">   <DIV align="center">
    <P>8</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (OTHSOUR_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=5" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!OTHSOUR_DOC.equals("")){ %>
    <INPUT type="button" name="button6" id="button6" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= OTHSOUR_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!OTHSOUR_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=5" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (INCOME_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=6" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!INCOME_DOC.equals("")){ %>
    <INPUT type="button" name="button7" id="button7" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= INCOME_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!INCOME_DOC.equals(""))) {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=6" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
  <TD><%=INCOME_REMARK %></TD>
  <TD colspan="3"> <DIV align="center">
    <P>2</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (INSU_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=7" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!INSU_DOC.equals("")){ %>
    <INPUT type="button" name="button8" id="button8" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= INSU_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!INSU_DOC.equals(""))) {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=7" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
  <TD><%=INSU_REMARK %></TD>
  <TD colspan="3"><DIV align="center">
    <P>3</P>
...
<TR>
 ...
 <P> New </P> </TD>
  <TD><% if ((add_update.equals("U")) && (BANK_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=8" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!BANK_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= BANK_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!BANK_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=8" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=BANK_REMARK %></TD>
  <TD colspan="3">     <DIV align="center">
    <P>&nbsp;</P>
...
<TR>
  ...
  <TD><P>
   ...
   <TD><% if ((add_update.equals("U")) && (CR_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=13" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!CR_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= CR_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!CR_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=13" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=CR_REMARK %></TD>
  <TD colspan="3"> <DIV align="center">
    <P>5</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (LOC_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=14" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!LOC_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= LOC_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!LOC_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=14" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=LOC_REMARK %></TD>
  <TD colspan="3">         <DIV align="center">
    <P>5</P>
...
<TR>
  ...
  <TD><P>
    <% if ((add_update.equals("U")) && (SKILL_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=9" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!SKILL_DOC.equals("")){ %>
    <INPUT type="button" name="button10" id="button10" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= SKILL_DOC %>');">
    <%}%>
  </P></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!SKILL_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=9" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
  <TD><%=SKILL_REMARK %></TD>
  <TD colspan="3"> <DIV align="center">
    <P>5</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (MARK_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=15" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!MARK_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= MARK_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!MARK_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=15" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=MARK_REMARK %></TD>
  <TD colspan="3">         <DIV align="center">
    <P>5</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (REGEGOV_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=10" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!REGEGOV_DOC.equals("")){ %>
    <INPUT type="button" name="button11" id="button11" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= REGEGOV_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!REGEGOV_DOC.equals(""))) {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=10" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% }  %></TD>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (REPY_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=16" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!REPY_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= REPY_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!REPY_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=16" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=REPY_REMARK %></TD>
  <TD colspan="3"> <DIV align="center">
    <P>5</P>
...
<TR>
  ...
  <TD><% if ((add_update.equals("U")) && (DSCR_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=17" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!DSCR_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= DSCR_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!DSCR_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=17" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=DSCR_REMARK %></TD>
  <TD colspan="3"><DIV align="center">
    <P>5</P>
...
<%}%>  </TD>
  <TD><% if ((add_update.equals("U")) && (COLSEC_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=18" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!COLSEC_DOC.equals("")){ %>
    <INPUT type="button" name="button9" id="button9" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= COLSEC_DOC %>');">
    <%}%></TD>
  <TD><% if ((!ACT_ID.equals("0")) && (!COLSEC_DOC.equals("")))  {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=18" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD><%=COLSEC_REMARK %></TD>
  <TD colspan="3"><DIV align="center">
    <P>10</P>
  ...
  <TR>
    ...
    <TD></TD>
	<TD>
    <% if ((add_update.equals("U")) && (ADDL_DOC.equals(""))){%>
    <A href="Upload_score_app.jsp?UPM_CD=12" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 350);return (false);">Upload </A>
    <%}else if (!ADDL_DOC.equals("")){ %>
    <INPUT type="button" name="button11" id="button11" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocument('<%= ADDL_DOC %>');">
    <%}%></TD>
  <TD><% if((!ACT_ID.equals("0")) && (!ADDL_DOC.equals(""))) {%>
    <A href="Upload_score_app_del.jsp?UPM_CD=12" class="myButton" onClick="javascript:Popup(this.href, 'Upload Document', 800, 500);return (false);">delete</A>
    <% } %></TD>
  <TD colspan="4"><P align="center"><%=ADDL_REMARK %></P></TD>
  </TR>
  <%if(!AGENCY_DOC.equals("")){%>
  <TR> 
  ...
  <TD colspan="3"><P>
    <INPUT type="button" name="button" id="button" class="myButton" value="View" style="background-color:#009933;"  onClick="viewdocumentA('<%= AGENCY_DOC %>','<%= APP_ID%>');">
   </P>  </TD>
  
  <TD colspan="4"><P align="center"><%=AGENCY_REMARK %></P>
    <P>&nbsp;</P></TD>
</TR>
  <%}%>
  <TR>
  <TD colspan="10"><DIV align="center"> <INPUT type="hidden" name="APP_AGREE_YN" value="Y" id="APP_AGREE_YN" >
   <INPUT type="checkbox" name="checkbox" value="check" class="largerCheckbox" id="checkbox" >
   <SPAN class="style6">    I hereby declare that the details furnished above are true and correct to the best of my knowledge and belief. In case any of the above information is found to be false or untrue or misleading or misrepresenting, I am aware that my application will be liable to be rejected.</SPAN></DIV></TD>
</TR>


<TR>
  <TD colspan="10">
  <% if  ((UPDATE_YN.equals("Y"))&&(HO_VERIFY_YN.equals("")) ){ %>
  
 <DIV align="center"> <INPUT name="Button" type="button" class="myButton" onClick="submitform();" style="background-color:#0066CC;" value="SAVE"/></DIV>
  <%} else{%>
  
<DIV align="center"><SPAN class="style5">  Data Verified by Agency hence Updatation Not Allowed </SPAN></DIV>
...
var callbackFunctionArray = new Array(refreshpage);
 modalWin.ShowURL("docViewScore.jsp?docname="+vDOC_NAME,500,800,'View Document',null,null);
 }//end of bank
