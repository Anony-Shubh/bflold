...
qrysb.append("     AD.AADHAR_NO,AD.BLDG_TYPE," );
...
<FORM name="form"  id="form" method="post"  >
  ...
  <TR>
    ...
    <TD colspan="2"><SELECT name="APP_PRIX" id="APP_PRIX">
      ...
      <INPUT name="APP_NAME" type="text" id="APP_NAME" value="<%=APP_NAME  %>" /></TD>
  </TR>
...
qryUpdate.append("BENF_SPECAT_CD=?,TECH_QUALI=?,BLDG_TYPE=?,CLIENT_IP=? ");
