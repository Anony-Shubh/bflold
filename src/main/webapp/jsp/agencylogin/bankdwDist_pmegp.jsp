...
append(" where ad.app_id=bd.app_id(+) and ad.unit_dist_cd=dm.district_cd and dm.state_cd=ms.state_cd and mom.off_cd="+vooff_cd+" ").
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by bank_name,ms.STATE_NM,MS.STATE_CD,  ROLLUP(DECODE(dm.DISTRICT_NAME,NULL,'Total',dm.DISTRICT_NAME))) A WHERE A.BANK_FORD>0  AND  A.BANK_NAME='"+vBank+"'    ");
...
<tr>
<th>State/Office</th>
<td><%= getTit(vStatecd) %>(<%= vdist_nm %> )</td>
<th>District</th>
<td><%= vdist_nm %></td>
<th>From Date </th>
<td><%=FromDt  %></td>
...
<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=5"%>">
  ...
  <td nowrap="nowrap">
    <div align="right">
	<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=6"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=11"%>">
...
<td nowrap="nowrap">
    <div align="right">
	<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=12"%>">
   ...
   <td nowrap="nowrap">
<div align="right"><a href="dwstatewise.jsp?<%=p4+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a>
</td>
<td nowrap="nowrap"><a href="dwstatewise.jsp?<%=p4+"&amp;QRYCODE=24"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_NOT_UPDATE")));%></a></td> 
<td nowrap="nowrap"><div align="right">
<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=7"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=40"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=38"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewise.jsp?<%=p4+"&QRYCODE=16"%>">
