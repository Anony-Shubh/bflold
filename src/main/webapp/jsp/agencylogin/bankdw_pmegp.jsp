...
//String vDist_nm =request.getParameter("sdistrict_cd")==null||request.getParameter("sdistrict_cd")=="ALL"?"%%":(String) request.getParameter("sdistrict_cd");
...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd and mom.off_cd="+vooff_cd+" group by ROLLUP(DECODE(AD.bank_name,NULL,'Total',AD.BANK_NAME))  )A ");
...
<table align="center">
<tr>
  <th colspan="8"><%= voffname %></th>
  </tr>
<tr>
<th>State/Office</th>
<td><%= getTit(vStatecd) %></td>
<th>District</th>
<td><%= vdist_nm %> </td>
<th>From Date </th>
<td><%=FromDt  %></td>
...
<a href="jasper/GenerateXLS.jsp?<%=p3+"&QRYCODE=5"%>&REPNM=Agency_dwstatewise">
      ...
      <%
//	  jasper/GenerateXLS.jsp?<%=p3+"&QRYCODE=0"&REPNM=Agency_dwstatewise
...
<td nowrap="nowrap"><a href="jasper/GenerateXLS.jsp?<%=p3+"&amp;QRYCODE=24"%>&REPNM=Agency_dwstatewise">
<% out.print(dfd.format(rsinst.getDouble("TDR_NOT_UPDATE")));%></a></td> 
  
<td nowrap="nowrap">
<div align="right"><a href="jasper/GenerateXLS.jsp?<%=p3+"&amp;QRYCODE=40"%>&REPNM=Agency_dwstatewise">
...
<td nowrap="nowrap"><div align="right">
<a href="jasper/GenerateXLS.jsp?<%=p3+"&QRYCODE=45"%>&REPNM=Agency_dwstatewise">
...
<td nowrap="nowrap"><div align="right">
<a href="jasper/GenerateXLS.jsp?<%=p3+"&QRYCODE=16"%>&REPNM=Agency_dwstatewise">
