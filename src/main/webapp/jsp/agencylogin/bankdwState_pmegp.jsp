...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd  and mom.off_cd="+vooff_cd+"  group by bank_name, ROLLUP(DECODE(MS.STATE_NM,NULL,'Total',MS.STATE_NM)))  A  WHERE A.BANK_FORD>0 AND A.BANK_NAME='"+vBank+"'");
