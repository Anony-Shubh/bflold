...
String vDist =request.getParameter("DISTCD")==null||request.getParameter("DISTCD")=="ALL"?"%%":(String) request.getParameter("DISTCD");
 ...
 txtSearch=txtSearch+" AND MOM.OFF_CD="+vooff_cd+" ";
...
<a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=5"%>&REPNM=Agency_dwstatewise_pen">
  ...
  <td nowrap="nowrap">
    <div align="right">
	<a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=6"%>&REPNM=Agency_dwstatewise_pen">
...
<td nowrap="nowrap"><div align="right">
<a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=8"%>&REPNM=Agency_dwstatewise_pen">
...
<td nowrap="nowrap">
    <div align="right">
	<a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=9"%>&REPNM=Agency_dwstatewise_pen">
...
<td nowrap="nowrap">
<div align="right"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=11"%>&REPNM=Agency_dwstatewise_pen">
...
<td nowrap="nowrap"><div align="right">
<a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=12"%>&REPNM=Agency_dwstatewise_pen">
