...
String ReportDesc=" PMEGP e-Tracking "+ReportName+" Performance Report for the Period from "+FromDt +" to "+ToDt+" " ; 
 ...
 sb.append("SELECT A.*,NVL(PRV_BANK_FORD_PEN,0)+NVL(CUR_BANK_FORD_PEN,0) AS TOT_BANK_FORD_PEN, ").
 ...
 append(" FROM ( ").
 append(" SELECT DM.district_name as off_name1  ").
...
append(" , SUM(CASE WHEN AD.ACT_ID=5 AND BD.ACT_ID=11 AND BD.LOAN_DOCFNAME IS NOT NULL AND BD.MM_CLAIM_AMT >0 AND BD.MM_CLAIM_DT IS NOT NULL AND BD.PACT_ID =30  AND TRUNC(BD.MM_CLAIM_DT)  BETWEEN '"+FromDt+"' AND '"+ToDt+"' THEN 1 ELSE 0 END) AS REFF_DISB  ").
  ...
  append(" and    mom.DISTRICT_CD=dm.district_cd and dm.state_cd=ms.state_cd and ad.mtg_id=amm.mtg_id(+) ").
append("  "+txtSearch+" ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by  ROLLUP(DM.district_name) )A ");
...
%>
 ...
 <table align="center">
<tr>
<th colspan="8">User Name:-<%= voffname %></th>
</tr>
<tr>
  <td colspan="8"><div align="center">PMEGP e-Traking online Performance Report </div></td>
</tr>
<tr>
<th>Agency</th>
<td><%=vAgencytit  %></td>
...
<tr>
  ...
  <th  rowspan="2" ><p>Previous Years Application Pending At Bank For Credit Decision </p>    </th>
...
<tbody>
 <tr>
 <th  colspan="28"><div align="center"></div>   <%=firstcolold%></span></th>
 </tr>
	 <%}%>
...
<td>
        <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=0"%>&REPNM=Agency_dwstatewise_pen">
            <%
			//jasper/GenerateXLS_Pen
			 out.print(dfn.format(rsinst.getDouble("APP_REC")));%>
        </a></div></td><td><div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=20"%>&REPNM=Agency_dwstatewise_pen">
      <% out.print(dfd.format(rsinst.getDouble("agency_reject")));%>
        </a></div></td>
      <td>
        <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=2"%>&REPNM=Agency_dwstatewise_pen">
            <% out.print(dfd.format(rsinst.getDouble("dtfc_place")));%>
        </a>        </div></td><td>
	      <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=4"%>&REPNM=Agency_dwstatewise_pen">
    
      <% out.print(dfd.format(rsinst.getDouble("dtfc_sanction")));%>
          </a></div></td>

<td><div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=3"%>&REPNM=Agency_dwstatewise_pen">
      <% out.print(dfd.format(rsinst.getDouble("dtfc_reject")));%>
</a></div></td>
<td>
  <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=5"%>&REPNM=Agency_dwstatewise_pen">
...
<td>
	<div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=6"%>&REPNM=Agency_dwstatewise_pen">
 ...
 <td><div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=7"%>&REPNM=Agency_dwstatewise_pen">
    
 </a>
       <% out.print(dfd.format(rsinst.getDouble("TOT_BANK_FORD_PEN")));%>
 </div></td>
  <td>
    <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=8"%>&REPNM=Agency_dwstatewise_pen">
  ...
  <td>
	<div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=9"%>&REPNM=Agency_dwstatewise_pen">
  ...
  <td>
          <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=10"%>&REPNM=Agency_dwstatewise_pen"></a>
            <% out.print(dfd.format(rsinst.getDouble("TOT_BANK_NOT_CLAIM_PEN")));%>
          </div></td>
    <td>
      <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&QRYCODE=11"%>&REPNM=Agency_dwstatewise_pen">
    ...
    <td>
      <div align="center"><a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=12"%>&REPNM=Agency_dwstatewise_pen">
...
<td><div align="center">
      ...
      <a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=14"%>&REPNM=Agency_dwstatewise_pen">
...
<td><div align="center">
      ...
      <a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=18"%>&REPNM=Agency_dwstatewise_pen">
...
<td><div align="center">
      ...
      <a href="jasper/GenerateXLS_Pen.jsp?<%=p3+"&amp;QRYCODE=19"%>&REPNM=Agency_dwstatewise_pen">
