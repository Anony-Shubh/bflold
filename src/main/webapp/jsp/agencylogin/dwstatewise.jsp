...
String vStateCd=request.getParameter("STATECD")==null?"":(String) request.getParameter("STATECD");  
 ...
 String vAgency=request.getParameter("sagency_type")==null?"":(String) request.getParameter("sagency_type"); 
...
append(" and bd.tr_id=edpom.off_cd(+)   ").
 append(" "+txtSearch+" ").
append("  AND MOM.OFF_CD ="+vooff_cd+" ").
...
%>
  ...
  <tr>
    <th colspan="66" align="left" nowrap="nowrap"><div align="left">PMEGP Detail Report for the period from <%= FromDt %> to <%= ToDt %>of Agency :<%= vOffname %></div></th>
    </tr>
  <tr>
