...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd  and mom.off_cd="+vooff_cd+"  group by ROLLUP(DECODE(dm.district_name,NULL,'Total',dm.district_name))  )A ");
