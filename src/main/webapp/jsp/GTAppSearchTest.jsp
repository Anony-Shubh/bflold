...
qrysb.append("   AND GT.PMEGPGEOTAGID IN ('3976313','4088300','3778332','4905568','3774039','3774482','3774273','3774062','3777667','3774076'))  ORDER BY DATE_OF_VERIFICATION DESC"      );
...
CO_REMARKS=rs.getString("CO_REMARKS")==null?"":rs.getString("CO_REMARKS");
    ...
    %>
     <INPUT name="APP_ID" type="hidden" id="BANKCODE" value="<%=APP_ID %>">
	  ...
	  <!--Approved-->
	   <DIV align="center"><A onClick="GTPULLBK('<%= APP_ID %>','<%= PMEGPGEOTAGID %>','<%=  APP_NAME %>');" class="greenButtonRound">PULLBCK</A>
  </DIV>
	  <%} else {%>
...
modalWin.ShowURL("appgeoStatUpdate11.jsp?APP_ID="+APP_ID+"&PMEGPGEOTAGID="+PMEGPGEOTAGID,700,850,'Status',null,null);
...
function GTPULLBK(APP_ID,PMEGPGEOTAGID,APPNAME){
var callbackFunctionArray = new Array(refreshpage);
// modalWin.ShowURL("UploadMMAdj.jsp?APP_ID="+APP_ID+"&PMEGPGEOTAGID="+PMEGPGEOTAGID+"&APPNAME="+APPNAME,500,500,'Status',null,null);
modalWin.ShowURL("pullAppsi.jsp?APP_ID="+APP_ID+"&PMEGPGEOTAGID="+PMEGPGEOTAGID+"&APPNAME="+APPNAME,500,500,'Status',null,null);
 }


function GTview(DOC_NAME){
var callbackFunctionArray = new Array(refreshpage);
 modalWin.ShowURL("../geoportal/docView.jsp?DOC_NAME="+DOC_NAME,720,1350,'Status',null,null);
 }
