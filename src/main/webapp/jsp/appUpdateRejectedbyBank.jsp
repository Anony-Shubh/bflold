...
<body>
<form  method="post"  name="form" id="form" action="appUpdateRejectedbyBank.jsp" >
<%
...
%>
 ...
 <span class="redLebel">Aadhaar Details are invalid! Please ensure Aadhaar No, Name, Date Of Birth , Gender and mobile No Details are as per Aadhaar Card....... ! Update Correct  Details in Applicant Data form </span>
		<%} else{%>
          <div align="left">
...
CallableStatement cs = conn.prepareCall("{call  PROCEDURE_REFORWARDTOBANK  (?,?,?,?,?,?,?)}");
...
//DIAS248103-13010420
 cs.setString(1,APP_ID); 
	...
	cs.setString(7,CLIENT_IP );
      cs.executeQuery();
cs.close();
conn.close();

response.sendRedirect("PMEGPGenAppForm.jsp?RNAME=BankForwardingLetter&APP_ID="+APP_ID+"");
