...
String msgStr="";
 ...
 sb.append (" APP_PWD FROM APP_DETAIL_ONLINE A WHERE APP_ID=? AND MOB_NO1=? AND AADHAR_NO=? AND ACT_YN='Y' ");
...
<table align="center">
  ...
  <tr>
    ...
    <td ><input name="APPID" type="text" id="APPID" tabindex="1" maxlength="20" autocomplete="off" ></td>
    </tr>
  <tr>
