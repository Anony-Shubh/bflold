...
qrysb.append("   SELECT AD.OFF_CD,FUN_LOCKUPDATE(AD.APP_ID) AS LOCK_YN," );
...
qrysb.append("     AD.TECH_QUALI,AD.BLDG_TYPE," );
...
qrysb.append("     AD.PAN_NO,AD.EMP_ENV," );
...
LOCK_YN=rsMain.getString("LOCK_YN")==null?"":rsMain.getString("LOCK_YN");
...
<body onLoad="edpyn();showOffice(this.value);checkDateAge();">
<%!
  ...
  <table class="CSSTableGenerator" align="center">
    ...
    <tr bgcolor="#D1A476">
      ...
      <tr>
        ...
        <th colspan="4"><h2><%= BENF_TYPE_DESC %>
      ...
      <tr>
        ...
        <td colspan="4"><input name="APP_NAME" type="text"  id="APP_NAME" readonly="true"  value="<%= APP_NAME %>" size="70" maxlength="100" /></td>
      </tr>
      <tr>
        <th>(3)</th>
		...
		<input name="REGD_NO" type="text"  id="REGD_NO" readonly="true"  value="<%= REGD_NO %>" size="30" maxlength="20" onKeyPress="return RestrictSpecialChar(event);" />
		 <% } else {%>
      ...
      <option value="M/s." <% if (APP_PRIX.equals("M/s.")){out.print("selected");}%>>M/s.</option>
		  ...
		  <input name="FH_NAME" type="text"  readonly="true" id="FH_NAME"   value="<%= FH_NAME %>" size="30" maxlength="100" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <th>(7 A)</th>
        <th colspan="2" nowrap>Designation*:</th>
        <td colspan="4"><input name="AUTH_DESIG" type="text"  id="AUTH_DESIG"   value="<%= AUTH_DESIG %>" size="30" maxlength="20" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      
      <tr>
        <th>(7 B)</th>
        <th colspan="2" nowrap><strong>AADHAAR No. of Authorised Person: </strong></th>
        <td colspan="4"><input name="AADHAR_NO" readonly="true" type="text" class="aadharimg"  id="AADHAR_NO" maxlength="12" onKeyPress="return numbersonly(event);" value="<%= AADHAR_NO %>" /></td>
      </tr>
      <tr>
        <th>(7 D)</th>
        <th colspan="2" nowrap>PAN No of <strong>Authorised Person : </strong></th>
        <td colspan="4"><input name="PAN_NO" type="text" id="PAN_NO" readonly="true"  size="20" maxlength="10" value="<%= PAN_NO %>" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <th>(8)</th>
		...
		<select name="AGENCY" disabled="disabled" class="button" id="AGENCY"   onchange="showOffice(this.value);" >
      ...
      <tr>
        ...
        <td colspan="4">
          ...
          <select name="STATE" class="button" disabled="disabled" id="STATE" onBlur="showOffice(this.value);" onChange="showDistrict(this.value);">
      ...
      <tr>
		...
		<td id ='DISTRICT' colspan="4">
		
		<select name="DISTRICT" disabled="disabled" class="button" onChange="showOffice(this.value);" >
	<% 
	String vDistCd="";
	String vDistnm="";
	while (rsDist.next()) { 
	...
	%>
      ...
      <tr>
        ...
        <td colspan="4"><select name="GENDER" id="GENDER">
      ...
      <tr>
        ...
        <td colspan="4"><input name="APP_POST_ADDR" type="text" id="APP_POST_ADDR" value="<%= APP_POST_ADDR %>" size="50" maxlength="99" onKeyPress="return RestrictSpecialChar(event);" /></td>
        </tr>
      ...
      <tr>
        ...
        <td colspan="4"><input name="APP_TALUK_BLOCK" type="text" id="APP_TALUK_BLOCK" value="<%= APP_TALUK_BLOCK %>"size="50" maxlength="60" onKeyPress="return RestrictSpecialChar(event);" /></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
...
District*:</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Pin*:</td>
        <td colspan="4"><input name="APP_PIN" type="text" id="APP_PIN"  onkeypress="return numbersonly(event);" value= "<%= APP_PIN  %>" size="10" maxlength="6" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <th colspan="2" nowrap>Authorised Person Mobile No:*:</th>
        <td colspan="4">(1)<input name="MOB_NO1" type="text" class="mob"  id="MOB_NO1" onKeyPress="return numbersonly(event);" value= "<%= MOB_NO1  %>" size="14" maxlength="10" /> 
          Office Telephone No: 
      ...
      <tr>
        ...
        <td colspan="4"> <input name="E_MAIL" type="text" id="E_MAIL" value= "<%=E_MAIL %>" size="40"  maxlength="58" /></td>
      </tr>
      <tr>
        <th>&nbsp;</th>
        <th colspan="2" nowrap>Bank Account of  <%= BENF_TYPE_DESC %></th>
        <td colspan="4"><input name="BANK_ACCNO" type="text" id="BANK_ACCNO" value= "<%=BANK_ACCNO %>" size="20"  maxlength="20" /></td>
      </tr>
      <tr>
        <th>(15)</th>
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">Pin*</td>
        <td colspan="4"><input name="UNIT_PIN" type="text" id="UNIT_PIN"  onkeypress="return numbersonly(event);" value="<%= UNIT_PIN %>"  size="10" maxlength="6" /></td>
      </tr>
      <tr>
        <th>(17)</th>
      ...
      <tr>
        ...
        <td colspan="4"><input name="PROD_DESC" type="text" id="PROD_DESC" value="<%= PROD_DESC %>" size="50" maxlength="50" onKeyPress="return RestrictSpecialChar(event);" /></td>
      </tr>
      <tr>
        <th>(19)</th>
      ...
      <td colspan="4"><input name="EDP_INST_ADDR" type="text" id="EDP_INST_ADDR" onKeyPress="return RestrictSpecialChar(event);" value="<%=EDP_INST_ADDR  %>" size="50" maxlength="50" /></td>
      </tr>
      <tr>
        <th nowrap>(21)</th>
 ...
 rs = db.execSQL("SELECT  DISTINCT(TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A");
      ...
      <td colspan="4"><input name="IFSC_CODE2" type="text" id="IFSC_CODE2" maxlength="11"  value="<%= IFSC_CODE2 %>"/></td>
      </tr>
      <tr>
    <th>(24)</th>
...
qryUpdate.append("TIME_STAMP=SYSDATE WHERE APP_ID=? ");
