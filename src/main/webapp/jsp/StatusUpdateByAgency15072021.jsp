...
<INPUT name="TOTAL_SCORE" type="hidden" id="TOTAL_SCORE" value="<%= TOTAL_SCORE %>">
  ...
  <TABLE align="center">
    ...
    <TR >
      <TH><DIV align="right">Select Rejection Reason : </DIV></TH><% out.print(REJ_ID);%>
      <TD colspan="3" class="GreenLebel" >
	  <select name="REJ_ID" id="REJ_ID" value=<%=REJ_ID%> >
	   <option value="-1">--Select Rejection Reason--</option>
      <%
	  String qrystr="";
	  String REJID="";
		String REJDESC="";
...
REJDESC=rs.getString(2);
    ...
    <TR >
      ...
      <TD colspan="3" ><input name="REMARKS" type="text" id="REMARKS" value="<%= REMARKS %>" size="50" maxlength="100"></TD>
    </TR>
    <TR>
...
qryUpdate.append("  ACT_ID=?, REJ_ID=?, FORD_DT_DLTFC=? ,MTG_ID=? WHERE APP_ID=? AND  ACT_ID NOT IN (7,5) ");
