...
qrysb1.append("   FROM INTERACTION_TRANS IT  WHERE APP_ID = '"+APP_ID+"' ORDER BY INT_TIME DESC" );
...
COM_MODE=(String) request.getParameter("COM_MODE")==null?"":(String) request.getParameter("COM_MODE").trim();
 ...
 qryUpdate.append("INSERT INTO INTERACTION_TRANS ");
...
ResultSet rsMax= db.execSQL("SELECT NVL(MAX(INT_TRANS_ID),0)+1 FROM INTERACTION_TRANS ");
while (rsMax.next()) {
