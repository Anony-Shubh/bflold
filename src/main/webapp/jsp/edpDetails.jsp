...
<span class="style11"><h3>For Project Cost Within 2 lakh,EDP is not Mandatory ......,  Online EDP disabled untill further notice</h3></span>
</MARQUEE>
...
<form  action="edpDetails.jsp" method="post" name="form" id="form" >
...
List pstm=new ArrayList();
 ...
 qry="SELECT APP_DIST_CD FROM APP_DETAIL_ONLINE  WHERE APP_ID='"+vAppid+"' ";
...
<tr>
 ...
 <td> 
   <input name="EDP" type="radio" disabled id="ONP"  value="ON" <% if (EDP.equals("ON")) {out.print("CHECKED");} %>   />
   *Online  EDP
...
<tr id="EDP_TY5">
  ...
  <input name="EDP_TRG_NAME" id="EDP_TRG_NAME" type="text" size="50" maxlength="50" value="<%= EDP_TRG_NM %>" readonly="true">
        ...
        <input name="btnEDP" type="button" class="button" id="btnEDP" value="Select  EDP Centers" onClick="ShowEdpList(<%=DISTRICT_CD%>);">
...
<tr>
  <th colspan="2"><div align="center" class="GreenLebel">*Online EDP disabled Untill further notice </div></th>
</tr>
...
qryUpdate.append("EDPTIMESTAMP,EDP_TYPE,ED_ID)");
qryUpdate.append("VALUES (?,?,?,?,SYSDATE,?,?) ");
}
else{
qryUpdate.append("  UPDATE EDP_CONDUCT_TRANS SET APP_ID=?,EDPOFF_CD=?, EDP_TRG_NAME=?, ACT_YN=?, EDPTIMESTAMP=SYSDATE, EDP_TYPE=? WHERE ED_ID=?  ");
