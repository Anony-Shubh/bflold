...
swal.fire({
  ...
  <li>I will be blacklisted from any subsidy scheme 
        ...
        found to be fake and government subsidy released to me if any will
         be recovered.</li>
  <li>I am ready to submit my application with the above terms and conditions.</li>
 </ul> 
</div>     `,
...
<%@ include file="newincludepage_01062022.jsp" %>
...
<TR>
  <TD>    <TABLE class="CSSTableGenerator">
	...
	<TR>
      <TH nowrap >(a)</TH>
      <TH nowrap>EID (Enrolment ID) 24 digits</TH>
      <TD colspan="4">
         <INPUT name="EID" type="text" class="aadharimg"  id="EID" onKeyPress="return numbersonly(event);" size="24" maxlength="24" />
     (In Case Enrolled for Aadhaar but Not yet Received/
     &#2310;&#2343;&#2366;&#2352; &#2325;&#2375; &#2354;&#2367;&#2319; &#2344;&#2366;&#2350;&#2366;&#2306;&#2325;&#2367;&#2340; &#2354;&#2375;&#2325;&#2367;&#2344; &#2309;&#2349;&#2368; &#2340;&#2325; &#2346;&#2381;&#2352;&#2366;&#2346;&#2381;&#2340; &#2344;&#2361;&#2368;&#2306; &#2361;&#2379;&#2344;&#2375; &#2325;&#2368; &#2360;&#2381;&#2341;&#2367;&#2340;&#2367; &#2350;&#2375;&#2306;
...
&nbsp;</TD>
 ...
 rs = db.execSQL("SELECT DISTINCT (TRIM(UPPER(A.BANK_NAME))) AS BANK_NAME FROM rbibanklist A WHERE A.ACT_YN = 'Y' ORDER BY (TRIM(UPPER(A.BANK_NAME)))");
    ...
    <TR>
      <TD>&nbsp;</TD>
      <TD>District:/&#2332;&#2367;&#2354;&#2366;</TD>
      <TD colspan="4"><INPUT name="BANK_DISTRICT" type="text" id="BANK_DISTRICT" size="30" maxlength="30" onKeyPress="return RestrictSpecialChar(event);" /></TD>
    </TR>
    <TR>
      <TH>(21)</TH>
      <TH nowrap>Alternate Financing Bank Name /&#2342;&#2370;&#2360;&#2352;&#2366;  &#2398;&#2366;&#2311;&#2344;&#2375;&#2306;&#2358;&#2367;&#2351;&#2354; &#2348;&#2376;&#2306;&#2325; </TH>
      <TD colspan="4"><SELECT name="BANK_NAME2"  id="BANK_NAME2" class="custom-select" >
...
String APP_SMSNAME=APP_NAME;

int cnam=APP_NAME.length();
/*
if (cnam>24) {
try {
APP_SMSNAME=APP_NAME.substring(0,24);

}catch (Execption e) {out.print (e.toString());}
}
*/
...
qryUpdate.append("ONLINE_SUBDT,CLIENT_IP ) ");
...
values.add(CLIENTIP); pstm.add ("L");
...
String SmsText="Dear  "+APP_SMSNAME+ " ,Your PMEGP  Portal Application is registered. User  ID is "+tempUN+" and password is "+APP_PWD+". Please Login for Upload Documents and Final Submission. After Final Submission You can Print Application form. -KVIC ";
...
if (AGENCY == "-1") {	
 ...
 var urlpar='PMEGPlovpage_dtb.jsp?AGENCY='+AGENCY;
 var callbackFunctionArray = new Array(EnrollNow, EnrollLater);
 modalWin.ShowURL(urlpar,600,1000,'Find Activity',null,callbackFunctionArray);
 }//end of bank
