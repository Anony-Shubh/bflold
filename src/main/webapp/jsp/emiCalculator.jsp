...
<HEAD>
    ...
    <LINK rel="stylesheet" href="../pmegphome/css/sweetalert2.min.css">
...
<%@ include file="newincludepage.jsp" %>
  ...
  <!-------------------------------------------------Footer Section End  ---------------------------------------------->
    <SCRIPT src="../pmegphome/js/jquery.min.js"></SCRIPT>
    <SCRIPT src="../pmegphome/js/bootstrap.min.js"></SCRIPT>
    <SCRIPT language="javascript" src="../pmegphome/js/sweetalert2.js"></SCRIPT>
    <SCRIPT src='../pmegphome/js/calci.js'> </SCRIPT>
    <SCRIPT language="javascript">
        function callcalc() {
            ...
            if (Number(vamt) < 1) {
                ...
                return false;
            } else if (Number(vamt) > 5000000) {
                Swal.fire("Maximum Loan Amount is 50 lakhs");
                return false;
