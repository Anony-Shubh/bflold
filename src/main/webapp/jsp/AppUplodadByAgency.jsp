   ...
   <jsp:setProperty name="upBean" property="whitelist" value="*.pdf,*.jpg,*jpeg,*.png" />
	  ...
	  <p>
        ...
        db.connect();
          ...
          String docStr="SELECT UPM_CD,DOC_DESC FROM APP_UPLOAD_MAST WHERE  UPM_CD="+UPM_CD+" OR UPM_CD IN (8,19)";
	...
	//ResultSet rsUp = db.execSQL(qryUp.toString());		
	  ...
	  <table align="center">
        ...
        <tr>
          <th colspan="2">* After Forward to Bank Agency Can Upload Revised Documents or EDP Certificate/ Any Other Addl. Document </th>
        </tr>
        <tr>
          <th>Select File: </th>
                ...
                if ( (files != null) && (!files.isEmpty()))
                {
					...
					if (ext.equals("jpg")||ext.equals("jpeg")||ext.equals("pdf")) {
					 upBean.store(mrequest, "uploadfile");
						...
						//boolean success =f.renameTo(new File("/opt/tomcat5/webapps/pmegpeportal/pmegpappupload/"+frenNm+""));
