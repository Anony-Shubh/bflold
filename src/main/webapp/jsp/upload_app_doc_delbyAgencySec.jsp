...
<form method="post" name="form" id="form"  >
	...
	while (rsUp.next()) {
	  ...
	  <table align="center">
        ...
        <tr>
          <td colspan="2"><div align="center"><img src="docView.jsp?docname=<%= DOC_NAME %>" width="20%">
            <div align="center">		  
          </div></td>
        </tr>
        <tr>
   ...
   List values=new ArrayList();
		...
		qryUpdate.append("DELETE FROM  APP_UPLOAD_TRANS_SECOND  WHERE UP_ID=?");
		values.clear();
        pstm.clear();
values.add(UP_ID); pstm.add ("L");
String insData="INSERT INTO APP_UPLOAD_TRANS_SECOND_DEL SELECT * FROM APP_UPLOAD_TRANS WHERE UP_ID=?";
