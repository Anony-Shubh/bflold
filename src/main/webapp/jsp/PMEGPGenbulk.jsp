...
<head>
	...
	String vFname=request.getParameter("RNAME")==null?"MMCLAIMBATCHPRINT":(String) request.getParameter("RNAME");
	...
	//String outFileName ="E:\\Tomcat5\\webapps\\pmegpeportal\\jasperrop\\jaspdf\\Bulkmm"+rnd+".pdf"; 
	String outFileName =folderpath+"jaspdf/"+"Bulkmm"+rnd+".pdf"; 
	//************************************************
 ...
 conn=ds.getConnection(); 
		 ...
		 hm.put("WHERECLS",vAPPID);
           ...
           exporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, outFileName); 
			...
			//out.print (vAPPID);
			response.sendRedirect("../jasperrop/jaspdf/Bulkmm"+rnd+".pdf");
			conn.close();
				}catch (Exception e){
