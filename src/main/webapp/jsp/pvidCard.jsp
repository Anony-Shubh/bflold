...
qrysb.append("   SELECT GD.EN_ID,GD.DOC_NAME,GD.DOC_REMARK,GD.ACT_YN,TO_CHAR(UPLOAD_TIMESTAMP,'DD-MON-RRRR') AS UPLOAD_TIMESTAMP,MS.STATE_NM,MS.STATE_CD from GEOENUM_DETAIL GD,M_STATE MS WHERE MS.STATE_CD=GD.STATE_CD AND GD.ACT_YN='Y' AND MS.STATE_CD='"+vstate_cd+"' "      );
