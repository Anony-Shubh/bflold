...
<jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
   ...
   <table class="CSSTableGenerator" align="center">
    ...
    <tr>
      <th>&nbsp;</th>
      <td colspan="3" nowrap><div align="center" class="mtextarea">APPLICANT ID IS: <%= APP_ID  %></div></td>
     </tr>
    <tr>
      <th>(1)</th>
      <th nowrap><strong>Name of the Visiting Officer*: </strong></th>
      <td colspan="2"><input name="PV_VER_OFF" type="text"  id="PV_VER_OFF" value="<%=PV_VER_OFF%>" size="50" maxlength="50" />
	  </td>
    ...
    <tr>
      ...
      <td colspan="2">     <input type="hidden" name="todo" value="upload"/>      <input name="PV_VAR_DES" type="text"  id="PV_VAR_DES"   value="<%=PV_VAR_DES%>" size="50" maxlength="50"  />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="2"><select name="PV_AGENCY" class="button" id="PV_AGENCY" >
    ...
    <tr>
      ...
      <td colspan="2"><br>
 <input name="PV_DT" type="text" id="PV_DT" value="<%= PV_DT %>"  onClick="javascript:NewCssCal('PV_DT','ddMMMyyyy')" readonly="true">
    ...
    <tr>
      ...
      <td colspan="2"><select name="PV_STATUS" class="button" id="PV_STATUS" onChange="toggle();" >
        <option value="">--Present Status--</option>
        <option value="WO">Working</option>
        <option value="DF">Defaunt</option>
	...
	<th>(6)
          ...
          (mamimum 1 mb in jpg or pdf) </th>
          <td colspan="2">
		 
		  
		  <input name="uploadfile" type="file" class="button" id="uploadfile" onChange="ValidateSingleInput(this);">            </td>
        </tr>
	    <tr >    <th>(7)</th>
      <th nowrap><strong>Date of Commence of Activity*: </strong></th>
      <td colspan="2">
	  <input name="START_DT" type="text" id="START_DT" value="<%= START_DT %>"  onClick="javascript:NewCssCal('START_DT','ddMMMyyyy')" readonly="true">	 
      </th>
    </tr>
	    <tr>
      <th>(8)</th>
      <th nowrap><strong>Product Details*: </strong></th>
      <td colspan="2"><input name="PRODUCT_DETAIL" type="text"  id="PRODUCT_DETAIL"   value="<%=PRODUCT_DETAIL%>" size="50" maxlength="100" disabled="true"  />
	    </tr>	
    <tr>      <th rowspan="2">(9)  
      <th rowspan="2">No.of Employment*: 
	  <th><div align="center">Part time           </div>
      <th><div align="center">Full Time </div>    
    </tr>
    <tr>
      <td><div align="center">
        <input name="PHY_EMP_PT" type="text" id="PHY_EMP_PT"  value="<%=PHY_EMP_PT%>" size="10" maxlength="4" disabled="true" />    
      </div>
      <td><div align="center">
        <input name="PHY_EMP_FT" type="text"  id="PHY_EMP_FT"   value="<%=PHY_EMP_FT%>" size="10" maxlength="4" disabled="true"/>      
      </div>
    </tr>
    <tr>      <th>(10)  
        <th>Annnual Turnover*:         
        <td colspan="2"><input name="PHY_ANL_TO" type="text"  id="PHY_ANL_TO"   value="<%=PHY_ANL_TO%>" size="30" maxlength="15" disabled="true" />
      </tr>
    <tr  >
      <th>(11)  
      <th>Remark (if any) :         
      <td colspan="2"><textarea name="PV_OBSERV"  value="<%=PV_OBSERV%>  "cols="50" rows="10" wrap="PHYSICAL" id="PV_OBSERV" ></textarea>      </tr>
    <tr>
      <td colspan="4"><div align="center">
        <input name="ins" type="hidden" id="ins">
        <input name="Button" type="button" class="button"  onClick="sub_form();"  value="Save Data"/>
      </div></td>
    </tr>
...
qryUpdate.append(" VALUES (SYSDATE,?,?,? ,?,?,? ,?,?,?,? ,?,?,?,'Y',?) ");
