...
%>
 ...
 <DIV align="center"><A href="edp_training_content_23022021.rar"  class="buttonMarun" style="background-color:#0f7fb6;">Download Approved EDP Content</A><IMG src="new-gif.gif" width="70px" height="50px"></DIV>
...
<br><br>  
 <DIV align="center" ><p style="background-color:#0f7fb6; color:#FFFFFF; padding:4px;">For Technical issues contact email: pmegpeportal.kvic@gov.in and PMEGP Scheme related queries contact email: pmegp.kvic@gov.in</p></DIV> 
