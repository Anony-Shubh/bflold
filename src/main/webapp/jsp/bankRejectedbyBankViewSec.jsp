...
<td><input name="btnReturned" type="button" class="buttonGreen"  id="btnReturned" onClick="rejectBankPage('<%= APP_ID %>')" value="Returned"></td>
</tr>
...
var urlpar='appUpdateRejectedbyBankSec.jsp?APP_ID='+APP_ID;
...
var urlpar='appRejectedbyBankSec.jsp?APP_ID='+APP_ID;
//var urlpar='applicantFormValidation.jsp?APP_ID='+APP_ID;
 modalWin.ShowURL(urlpar,600,1000,'Reject App Process....',null,null);
 }//
