...
var PV_VER_OFF=document.form.PV_VER_OFF.value; 
 ...
 //var PV_FILE=document.form.uploadfile.value; 
 var PV_FILE = document.getElementById("uploadfile");
 if(PV_VER_OFF == "") {
...
function toggle() {
	//alert("hello");
	  ...
	  var PV_STATUS=form.elements["PV_STATUS"].value; 
		//  alert(PV_STATUS);
 if(document.getElementById("PV_STATUS").value == "WO" ) {
	    document.forms[0].START_DT.disabled=false;
        document.forms[0].PHY_EMP_PT.disabled=false;
		document.forms[0].PHY_EMP_FT.disabled=false;
        document.forms[0].PRODUCT_DETAIL.disabled=false;
		document.forms[0].PHY_INV.disabled=false;
		document.forms[0].PHY_ANL_TO.disabled=false;
  ...
  // document.getElementById('PRODUCT_DETAIL').disabled = false;
   //document.getElementById('PHY_ANL_TO').disabled = false;
	 ...
	 document.forms[0].START_DT.disabled=true;
        document.forms[0].PHY_EMP_PT.disabled=true;
		document.forms[0].START_DT.disabled=true;
        document.forms[0].PHY_EMP_PT.disabled=true;
		document.forms[0].PHY_EMP_FT.disabled=true;
        document.forms[0].PRODUCT_DETAIL.disabled=true;
		document.forms[0].PHY_INV.disabled=true;
		document.forms[0].PHY_ANL_TO.disabled=true;
 ...
 function toggle() {
	  ...
	  alert(PV_STATUS);
 if (PV_STATUS == "WO"){	
 	 hidethis6.style.display = "block"; 
	 hidethis5.style.display = "block";
	 ...
	 hidethis6.style.display = "none"; 
	 hidethis5.style.display = "none";
...
List values=new ArrayList();
 ...
 DBCon db= new DBCon();
db.connect();
String NO_OF_VISIT="0";
String  APP_ID =  session.getAttribute("SAPP_ID")==null?"":(String) session.getAttribute("SAPP_ID");
StringBuffer qrysb= new StringBuffer();
qrysb.append(" SELECT max(NVL(NO_OF_VISIT,0)) NO_OF_VISIT FROM  MONITORING_PV_DETAIL WHERE APP_ID='"+APP_ID+"' "      );

ResultSet rsMain = db.execSQL(qrysb.toString());
 while (rsMain.next()) {
 NO_OF_VISIT =rsMain.getString("NO_OF_VISIT")==null?"0":rsMain.getString("NO_OF_VISIT");
 }
 rsMain.close();
//out.print("hello"+NO_OF_VISIT);

int NOFVISIT = Integer.parseInt(NO_OF_VISIT)+1;
//out.print(NOFVISIT);
...
//out.print(a);
//String a="pmegpunitmonitoring/physicalmupload/";
%>
...
<table class="CSSTableGenerator" align="center">
  ...
  <tr>
    ...
    <td colspan="4"><input name="PV_VER_OFF" type="text"  id="PV_VER_OFF" value="<%=PV_VER_OFF%>" size="50" maxlength="50" />    </td>
  ...
  <tr>
    ...
    <td colspan="4"><input name="PV_VAR_DES" type="text"  id="PV_VAR_DES"   value="<%=PV_VAR_DES%>" size="50" maxlength="50"  />    </td>
  </tr>
  <tr>
    <th>(3)</th>
    ...
    <td colspan="4"><select name="PV_AGENCY" class="button" id="PV_AGENCY" >
	  ...
	  <option value="CO">COIR</option>
    </select></td>
  </tr>
  <tr>
    <th>(4)</th>
    <th nowrap><strong>Date of Visit*: </strong></th>
    <td colspan="4"><input name="PV_DT" type="text"  id="PV_DT" onClick="javascript:NewCssCal('PV_DT','ddMMMyyyy')"  value="<%=PV_DT%>" size="15" maxlength="11" readonly="true" />
    </th>    </tr>
  <tr>
    <th>(5)</th>
  ...
  <tr>
    ...
    <td colspan="4"><input name="uploadfile" type="file" class="button" id="uploadfile"  >              </td>
  </tr>
  <tr>
    <th>(7)</th>
    <th nowrap><strong>Date of Commence of Activity*: </strong></th>
    <td colspan="4"><input name="START_DT" type="text"  id="START_DT"  onClick="javascript:NewCssCal('START_DT','ddMMMyyyy')"  readonly="true" value="<%=START_DT%>" size="13" maxlength="11" />   <input name="NOFVISIT" type="hidden"  id="NOFVISIT"   value="<%=NOFVISIT%>" size="50" maxlength="100"  />     </td>
    </tr>
  <tr>
    <th>(8)</th>
    <th nowrap><strong>Product Details*: </strong></th>
    <td colspan="4"><input name="PRODUCT_DETAIL" type="text"  id="PRODUCT_DETAIL"   value="<%=PRODUCT_DETAIL%>" size="50" maxlength="100"  /></td>
    </tr>
  <tr >
    <th rowspan="2">(9)  
    <th rowspan="2">No.of Employment*: 
    <th colspan="2"><div align="center">Part time </div>
    <th colspan="2"><div align="center">Full Time </div>    </tr>
  <tr >
  ...
  <tr  >
  <th>(10).</th>
  <th><strong>Current Year Production as on Visit Date: </strong></th>
    <td><input name="PHY_ANL_TO"  type="text"  id="PHY_ANL_TO" value="<%=PHY_ANL_TO%>" size="10" maxlength="10"></td>
    <th> 
    <th>Current Year Sales as on visit Date: 
      ( in Rs.) 
    <td colspan="2"><input name="PHY_INV"  type="text"  id="PHY_INV" value="<%=PHY_INV%>" size="10" maxlength="10"></td>
  ...
  <tr  >
    ...
    <td><div align="center"><strong>Recommandation </strong></div>    </tr>
  <tr  >
    <th> 
    ...
    <td><input name="MACHIN_AVAIL_RECOM"  type="text"  id="MACHIN_AVAIL_RECOM" value="<%=MACHIN_AVAIL_RECOM%>" size="50" maxlength="300">    </tr>
  <tr  >
    <th> 
    <th>Production Process Adopted:
    <td><label>
        ...
        <td><input name="PROD_PROC_RECOM"  type="text"  id="PROD_PROC_RECOM" value="<%=PROD_PROC_RECOM%>" size="50" maxlength="300">        </tr>
  <tr  >
    <th> 
    ...
    <td><select name="QUALITY_CONTROL">
        ...
        <td><input name="QUALITY_CONTROL_RECOM"  type="text"  id="QUALITY_CONTROL_RECOM" value="<%=QUALITY_CONTROL_RECOM%>" size="50" maxlength="300">        </tr>
  <tr  >
    <th> 
    ...
    <td><select name="PRODUCT_PKG" id="PRODUCT_PKG">
      ...
      <td><input name="PRODUCT_PKG_RECOM"  type="text"  id="PRODUCT_PKG_RECOM" value="<%=PRODUCT_PKG_RECOM%>" size="50" maxlength="300">        </tr>
  <tr  >
    <th> 
    ...
    <td><select name="MKTCHANL_ADPT_YN">
        ...
        <td><input name="MKTCHANL_ADPT_RECOM"  type="text"  id="MKTCHANL_ADPT_RECOM" value="<%=MKTCHANL_ADPT_RECOM%>" size="50" maxlength="300">        </tr>
  <tr  >
    <th> 
    ...
    <td><select name="LICEN_OBTN_YN" id="LICEN_OBTN_YN">
        ...
        <td><input name="LICEN_OBTN_RECOM"  type="text"  id="LICEN_OBTN_RECOM" value="<%=LICEN_OBTN_RECOM%>" size="50" maxlength="300">        </tr>
  <tr  >
    <th> 
    ...
    <td><select name="QUALITY_CERT_YN" id="QUALITY_CERT_YN">
        ...
        <td><input name="QUALITY_CERT_RECOM"  type="text"  id="QUALITY_CERT_RECOM" value="<%=QUALITY_CERT_RECOM%>" size="50" maxlength="300">        </tr>
  <tr  >
    <th>(11)  
    <th>Problems and Issues  (if any) :         
    <td colspan="4"><textarea name="PV_OBSERV"  value="<%=PV_OBSERV%>  "cols="50" rows="10"  id="PV_OBSERV" ></textarea>        </tr>
  
    <tr  >
    <th>(12)  
    <th>Suggestion and Recommendation of Visiting Officer :         
    <td colspan="4"><textarea name="SUGG_RECOM"  value="<%=SUGG_RECOM%>  "cols="50" rows="10"  id="SUGG_RECOM" ></textarea>        </tr>
 
 <tr>
    <td colspan="6"><div align="center">
      <input name="ins" type="hidden" id="ins">
      <input name="Submit" type="button" class="button"  onClick="sub_form();"  value="Save Data"/>
    </div></td>
  </tr>
</table>
<%
...
MACHIN_AVAIL_YN=(String) mrequest.getParameter("MACHIN_AVAIL_YN")==null?"":(String) mrequest.getParameter("MACHIN_AVAIL_YN").trim();
MACHIN_AVAIL_DTL=(String) mrequest.getParameter("MACHIN_AVAIL_DTL")==null?"":(String) mrequest.getParameter("MACHIN_AVAIL_DTL").trim();
MACHIN_AVAIL_OBS=(String) mrequest.getParameter("MACHIN_AVAIL_OBS")==null?"":(String) mrequest.getParameter("MACHIN_AVAIL_OBS").trim();
MACHIN_AVAIL_RECOM=(String) mrequest.getParameter("MACHIN_AVAIL_RECOM")==null?"":(String) mrequest.getParameter("MACHIN_AVAIL_RECOM").trim();
PROD_PROC=(String) mrequest.getParameter("PROD_PROC")==null?"":(String) mrequest.getParameter("PROD_PROC").trim();
PROD_PROC_DTL=(String) mrequest.getParameter("PROD_PROC_DTL")==null?"":(String) mrequest.getParameter("PROD_PROC_DTL").trim();
PROD_PROC_OBS=(String) mrequest.getParameter("PROD_PROC_OBS")==null?"":(String) mrequest.getParameter("PROD_PROC_OBS").trim();
PROD_PROC_RECOM=(String) mrequest.getParameter("PROD_PROC_RECOM")==null?"":(String) mrequest.getParameter("PROD_PROC_RECOM").trim();
QUALITY_CONTROL=(String) mrequest.getParameter("QUALITY_CONTROL")==null?"":(String) mrequest.getParameter("QUALITY_CONTROL").trim();
QUALITY_CONTROL_DTL=(String) mrequest.getParameter("QUALITY_CONTROL_DTL")==null?"":(String) mrequest.getParameter("QUALITY_CONTROL_DTL").trim();
QUALITY_CONTROL_OBS=(String) mrequest.getParameter("QUALITY_CONTROL_OBS")==null?"":(String) mrequest.getParameter("QUALITY_CONTROL_OBS").trim();
QUALITY_CONTROL_RECOM=(String) mrequest.getParameter("QUALITY_CONTROL_RECOM")==null?"":(String) mrequest.getParameter("QUALITY_CONTROL_RECOM").trim();
PRODUCT_PKG=(String) mrequest.getParameter("PRODUCT_PKG")==null?"":(String) mrequest.getParameter("PRODUCT_PKG").trim();
PRODUCT_PKG_DTL=(String) mrequest.getParameter("PRODUCT_PKG_DTL")==null?"":(String) mrequest.getParameter("PRODUCT_PKG_DTL").trim();
PRODUCT_PKG_OBS=(String) mrequest.getParameter("PRODUCT_PKG_OBS")==null?"":(String) mrequest.getParameter("PRODUCT_PKG_OBS").trim();
PRODUCT_PKG_RECOM=(String) mrequest.getParameter("PRODUCT_PKG_RECOM")==null?"":(String) mrequest.getParameter("PRODUCT_PKG_RECOM").trim();
MKTCHANL_ADPT_YN=(String) mrequest.getParameter("MKTCHANL_ADPT_YN")==null?"":(String) mrequest.getParameter("MKTCHANL_ADPT_YN").trim();
MKTCHANL_ADPT_DTL=(String) mrequest.getParameter("MKTCHANL_ADPT_DTL")==null?"":(String) mrequest.getParameter("MKTCHANL_ADPT_DTL").trim();
MKTCHANL_ADPT_OBS=(String) mrequest.getParameter("MKTCHANL_ADPT_OBS")==null?"":(String) mrequest.getParameter("MKTCHANL_ADPT_OBS").trim();
MKTCHANL_ADPT_RECOM=(String) mrequest.getParameter("MKTCHANL_ADPT_RECOM")==null?"":(String) mrequest.getParameter("MKTCHANL_ADPT_RECOM").trim();
LICEN_OBTN_YN=(String) mrequest.getParameter("LICEN_OBTN_YN")==null?"":(String) mrequest.getParameter("LICEN_OBTN_YN").trim();
LICEN_OBTN_DTL=(String) mrequest.getParameter("LICEN_OBTN_DTL")==null?"":(String) mrequest.getParameter("LICEN_OBTN_DTL").trim();
LICEN_OBTN_OBS=(String) mrequest.getParameter("LICEN_OBTN_OBS")==null?"":(String) mrequest.getParameter("LICEN_OBTN_OBS").trim();
LICEN_OBTN_RECOM=(String) mrequest.getParameter("LICEN_OBTN_RECOM")==null?"":(String) mrequest.getParameter("LICEN_OBTN_RECOM").trim();
QUALITY_CERT_YN=(String) mrequest.getParameter("QUALITY_CERT_YN")==null?"":(String) mrequest.getParameter("QUALITY_CERT_YN").trim();
QUALITY_CERT_DTL=(String) mrequest.getParameter("QUALITY_CERT_DTL")==null?"":(String) mrequest.getParameter("QUALITY_CERT_DTL").trim();
QUALITY_CERT_OBS=(String) mrequest.getParameter("QUALITY_CERT_OBS")==null?"":(String) mrequest.getParameter("QUALITY_CERT_OBS").trim();
QUALITY_CERT_RECOM=(String) mrequest.getParameter("QUALITY_CERT_RECOM")==null?"":(String) mrequest.getParameter("QUALITY_CERT_RECOM").trim();
SUGG_RECOM=(String) mrequest.getParameter("SUGG_RECOM")==null?"":(String) mrequest.getParameter("SUGG_RECOM").trim();	
NO_OF_VISIT=(String) mrequest.getParameter("NOFVISIT")==null?"":(String) mrequest.getParameter("NOFVISIT").trim();			
...
qryUpdate.append("PV_VER_OFF,");//13
...
qryUpdate.append("MACHIN_AVAIL_RECOM,");//20
...
qryUpdate.append("LICEN_OBTN_RECOM,");//40


qryUpdate.append("QUALITY_CERT_YN,");
qryUpdate.append("QUALITY_CERT_DTL,");
qryUpdate.append("QUALITY_CERT_OBS,");
qryUpdate.append("QUALITY_CERT_RECOM,SUGG_RECOM,NO_OF_VISIT,");
 qryUpdate.append("PHTR_ID)");//45
...
values.add(PV_OBSERV); pstm.add ("L");//13
...
values.add(SUGG_RECOM); pstm.add ("L");
values.add(NO_OF_VISIT); pstm.add ("L");
