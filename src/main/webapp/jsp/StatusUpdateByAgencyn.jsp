...
av.append(" SELECT ad.APP_ID, TO_CHAR(AD.ONLINE_SUBDT,'DD-MON-RRRR HH:MM:SS') AS ONLINE_SUBDT, ").
 append(" ad.APP_NAME,ad.MOB_NO1, ad.MTG_ID,TO_CHAR(AD.ONLINE_SUBDT, 'DD-MON-RRRR') AS APP_REC_DATE, SYSDATE AS TODAYDT,FORD_DT_DLTFC ,").
...
<form  method="post" name="form" id="form">
  ...
  <table align="center">
    ...
    <tr >
      <td>Online Submission Date and Time: <%= ONLINE_SUBDT %></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr >
      ...
      Under Process
        ...
        <input name="ACT_ID"  id="ACT_ID" type="radio" value="6" <% if (ACT_ID.equals("6")){out.print("Checked");}%>>
    ...
    <tr >
      ...
      <td colspan="3" ><input name="REMARKS" type="text" id="REMARKS" tabindex="39" onClick="Status_change();" value="<%= REMARKS %>" size="70" maxlength="100">
      </td>
    </tr>
    <tr>
      <th colspan="4"> <div align="center">
          <input name="Button2" type="button" class="button" tabindex="42" value="Cancel" onClick="javascript:window.close();">
          <input name="Button" type="button" class="button" tabindex="41" onClick="submit_form();" value="Save  Record">
      </div></th>
    </tr>
  </table>
  <%
...
String vtoDate=ACT_ID.equals("6")?TODAYDT:"";
...
qryUpdate.append("  ACT_ID=?,FORD_DT_DLTFC=? WHERE APP_ID=? AND ACT_ID IN (0,1,3,6) AND MTG_ID IS NULL");
