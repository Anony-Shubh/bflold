...
<TR>
  ...
  <TD width="14%"><INPUT name="BNF_AFROMDT" type="text" id="BNF_AFROMDT" onClick="popUpCalendar(this, this.form.BNF_AFROMDT,'dd-mmm-yyyy');return false;" value="<%= BNF_AFROMDT %>" maxlength="11" readonly="true"  autocomplete="off" PLACEHOLDER="From date"></TD>
  <TD width="6%">To</TD>
  <TD width="27%"><INPUT name="BNF_ATODT" type="text" id="BNF_ATODT" onBlur="days();" onClick="popUpCalendar(this, this.form.BNF_ATODT,'dd-mmm-yyyy');return false;" value="<%= BNF_ATODT %>" maxlength="11" readonly="true"  autocomplete="off" PLACEHOLDER="To date"></TD>
</TR>
<TR>
