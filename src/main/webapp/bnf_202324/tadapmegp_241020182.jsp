...
<TR>
  ...
  <TD><INPUT name="BNF_EVENT" type="text" id="BNF_EVENT" value="<%= BNF_EVENT%>" maxlength="50" AUTOCOMPLETE="off" ></TD>
</TR>
<TR>
  <TD >Name of the staff : </TD>
  <TD><INPUT name="BNF_ASTFFNME" type="text" id="BNF_ASTFFNME" value="<%= BNF_ASTFFNME %>" maxlength="55" AUTOCOMPLETE="off" />    </TD>
...
<TR>
  ...
  <TD><INPUT name="BNF_ASTFFDSGNTN" type="text" id="BNF_ASTFFDSGNTN" value="<%= BNF_ASTFFDSGNTN %>" maxlength="50" AUTOCOMPLETE="off" /></TD>
</TR>
<TR>
  <TD> Contact no. : </TD> <INPUT name="ins" type="hidden" id="ins">
  <TD><INPUT name="BNF_ASTFFCNTCT" type="text" id="BNF_ASTFFCNTCT" value="<%= BNF_ASTFFCNTCT %>" maxlength="12" AUTOCOMPLETE="off" onKeyPress="return isNumberNoDec(event)"></TD>
</TR>
<TR>
  <TD>Place of visit : </TD>
  <TD><INPUT name="BNF_APLACE" type="text" id="BNF_APLACE" value="<%= BNF_APLACE %>" maxlength="20" ></TD>
</TR>

<TR>
  <TD>Programme detail : </TD>
  <TD><INPUT name="BNF_APROGDTLS" type="text" id="BNF_APROGDTLS" value="<%= BNF_APROGDTLS %>" maxlength="100" AUTOCOMPLETE="off" ></TD>
</TR>
<TR>
  <TD>Tour sanctioned for No. of days : </TD>
  <TD><INPUT name="BNF_ATOURDYS" type="text" id="BNF_ATOURDYS" value="<%= BNF_ATOURDYS %>" maxlength="4" AUTOCOMPLETE="off" onKeyPress="return isNumberNoDec(event)" ></TD>
  </TR>
<TR>
...
<TR>
  ...
  <TD><INPUT name="BNF_ORG_DAY" type="text" id="BNF_ORG_DAY"  value="<%= BNF_ORG_DAY%>" maxlength="4" AUTOCOMPLETE="off" onKeyPress="return isNumberNoDec(event)" ></TD>
  </TR>
<TR>
  <TD>Organizer Co. Incharge Name: </TD>
  <TD><INPUT name="BNF_ACLBNAME" type="text" id="BNF_ACLBNAME" value="<%= BNF_ACLBNAME %>" maxlength="50" AUTOCOMPLETE="off" >    </TD>
  </TR>
<TR>
  <TD>Organizer Contact No</TD>
  <TD><INPUT name="BNF_ORG_CONTNO" type="text" id="BNF_ORG_CONTNO" value="<%= BNF_ORG_CONTNO%>" maxlength="12" AUTOCOMPLETE="off" onKeyPress="return isNumberNoDec(event)"></TD>
</TR>
<TR>
  <TD>Expenditure incurred on TA (Amount in Rs only): </TD>
  <TD><INPUT name="BNF_ATA" AUTOCOMPLETE="off" type="text" id="BNF_ATA" value="<%= BNF_ATA %>" onChange="tot();" onKeyPress="javascript:return isNumber(event)"></TD>
</TR>
<TR>
  <TD>Expenditure incurred on DA (Amount in Rs only): </TD>
  <TD><INPUT name="BNF_ADA" type="text" id="BNF_ADA" value="<%= BNF_ADA %>" AUTOCOMPLETE="off" onChange="tot();" onKeyPress="javascript:return isNumber(event)" >
  </TD>
</TR>
<TR>
  <TD>Total Expenditure incurred on TA/DA:</TD>
  <TD><INPUT name="FIN_AMT" type="text" id="FIN_AMT" value="<%=FIN_AMT%>"  readonly="true"></TD>
</TR>
<TR>
  <TD>Remark : </TD>
  <TD><INPUT name="REMARK_ADD" type="text" id="REMARK_ADD" value="<%= REMARK_ADD %>" maxlength="95" AUTOCOMPLETE="off" ></TD>
</TR>
...
qryUpdate.append("REMARK_ADD,OFF_CD,BUD_ID,BNF_TRID");//19
