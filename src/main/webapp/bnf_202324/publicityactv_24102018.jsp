...
<tr>
  ...
  <td><input name="BNF_EVENT" type="text" autocomplete="off" id="BNF_EVENT" value="<%= BNF_EVENT%>" ></td>
</tr>
<tr>
  <td >Type Of Publicity : </td>
  <td><input name="BNF_TYPPUBLICITY" type="text" autocomplete="off" id="BNF_TYPPUBLICITY" value="<%= BNF_TYPPUBLICITY %>" >   </td>
</tr>
<tr>
  <td> Organized From :</td>
  <td><input name="BNF_AFROMDT" type="text"  autocomplete="off" id="BNF_AFROMDT" value="<%= BNF_AFROMDT %>"  onClick="popUpCalendar(this, this.form.BNF_AFROMDT,'dd-mmm-yyyy');return false;" >
  </td>
</tr>
<tr>
  <td> Organized To :</td>
  <td><input name="BNF_ATODT" type="text" autocomplete="off" id="BNF_ATODT" value="<%= BNF_ATODT %>" onblur="days();"  onClick="popUpCalendar(this, this.form.BNF_ATODT,'dd-mmm-yyyy');return false;" ></td>
</tr>
<tr>
  <td> No. of days  was organized: </td>
  <td><input name="BNF_ATOURDYS" type="text" id="BNF_ATOURDYS" value="<%= BNF_ATOURDYS %>" readonly="true" autocomplete="off"  ></td>
</tr>
<tr>
  <td>Name of the Place: </td>
  <td><input name="BNF_APLACE" type="text" id="BNF_APLACE" autocomplete="off" value="<%= BNF_APLACE %>" ></td>
</tr>
<tr>
  <td >Name of the organizer : </td>
  <td><input name="BNF_ASTFFNME" type="text" id="BNF_ASTFFNME" autocomplete="off" value="<%= BNF_ASTFFNME %>" />
  </td>
</tr>
...
<tr>
  ...
  <td><input name="BNF_ASTFFCNTCT" type="text" id="BNF_ASTFFCNTCT" autocomplete="off"  value="<%= BNF_ASTFFCNTCT %>" ></td>
</tr>


<tr>
  <td>Subject of advertising in brief and event if any: </td>
  <td><input name="BNF_APROGDTLS" type="text" id="BNF_APROGDTLS" aautocomplete="off"  value="<%= BNF_APROGDTLS %>" ></td>
</tr>
<tr>
  <td>Total Expenditure incurred for (Amount in Rs. only) : </td>
  <td><input name="BNF_ATA" type="text" id="BNF_ATA" autocomplete="off" value="<%= BNF_ATA %>" ></td>
</tr>
<tr>
...
<tr>
  <td>Remark (if any): </td>
  <td><input name="REMARK_ADD" type="text" autocomplete="off" id="REMARK_ADD" value="<%= REMARK_ADD %>" ></td>
</tr>
