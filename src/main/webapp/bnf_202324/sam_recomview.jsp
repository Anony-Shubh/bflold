...
%> 
 ...
 <td align="center"><strong>Select Month</strong> <select name="MONTH_DT" id="MONTH_DT" class="class">
     ...
     <%
ResultSet rso =db.execSQL(" select TO_CHAR(month_dt,'DD-MON-RRRR') AS INV_VAL,TO_CHAR(month_dt,'MON-RRRR') AS DISPLAYMON from  bnf_onlineedp_inf where month_dt between '01-APR-2023' AND '31-MAR-2024' AND UPDOC_EDP IS NOT NULL GROUP BY  month_dt,month_dt ");
