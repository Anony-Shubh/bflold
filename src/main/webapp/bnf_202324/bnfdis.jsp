...
<TR>
  ...
  <TD colspan="3"><INPUT name="BNF_ATA" type="text" id="BNF_ATA" value="<%= BNF_ATA %>" onKeyPress="javascript:return isNumber(event)" AUTOCOMPLETE="off" PLACEHOLDER="Expenditure" onKeyUp="word.innerHTML=convertNumberToWords(this.value)" ></TD>
</TR>
<TR>
  <TD></TD>
