...
%>
    ...
    <A href="jasperReports/bnfreport123.jsp?REPNM=report2&YEAR_ID=<%= sselect %>" class="myButton"> Print Report</A>
  ...
  <TR>
	...
	<TH colspan="2"><DIV align="center">Release From Central Office</DIV></TH>
	<TH width="7%" rowspan="2"><DIV align="center">Recieve From Other Office</DIV></TH>
	<TH colspan="2"><DIV align="center">Refunded/Transfered</DIV></TH>
...
<% if (flag.equals("Y")){ %>
  ...
  <TR>
	...
	<% if ((OB_AMT.equals("0")) &&(sselect.equals("2023-24"))){%>	
