...
<%
  ...
  <p>&nbsp;</p>
   ...
   <table align="center">
   <% if (vSucess.equals("S")) { 
  session.setAttribute("sAADHAR_NO",uid);
session.setAttribute("sAPP_NAME",name);
session.setAttribute("sGENDER",gend); 
response.sendRedirect("savemsg.jsp");
  } else if (vSucess.equals("F") ) {%>
  <tr>
    <th scope="row"><img src="images\failure.png" width="98" height="99"></th>
