...
for (var i=0; i < document.lov1.optActCode.length; i++)
 ...
 opener.document.form.Activity_desc.value=str_actdesc;
 opener.document.form.ACTIVITY_CD.value=str_actid;
self.close();
}
</script>
...
<body>
<form action="PMEGPlovpage.jsp" method="post" name="lov1">
  <div align="center">
    <p>
      <% 
