...
String APP_PWD= (String) session.getAttribute("sAPP_PWD");
%>
<form>
<p>&nbsp;</p>
<p>&nbsp;</p>
<table align="center" cellpadding="6" cellspacing="6" >
  ...
  <tr>
    <td class="redLebel"><p>Record Successfully Saved........</p>
      <p>Your Applicant ID is <%=APP_ID%></p>
      <p>Your Password is <%=APP_PWD%></p>
      </td>
    </tr>
  <tr>
    <th><div align="center">
