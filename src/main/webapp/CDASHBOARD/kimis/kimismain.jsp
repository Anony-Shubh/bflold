...
qrysb.append("                    SELECT nvl(decode(k_n,'DEPT','Departmental Bhavan','Khadi Institutions'),'TOTAL') BEN_TYPE,count(ben_cd) as users,       "      );
...
qrysb.append("                    FROM       "      );
qrysb.append("              (       "      );
qrysb.append("                      SELECT STATENAME,ZONE_NM, k_n,      "      );
...
qrysb.append("                       (SELECT smm.STATENAME,smm.ZONE_NM, k_n,      "      );
...
qrysb.append("                        AND smm.STATEID   = KM.KISTATEID AND K_N NOT IN ('CSP')   and km.BEN_CD  NOT IN (1231, 1234, 2391)     "      );
qrysb.append("                              "      );
qrysb.append("           ) cust,       "      );
qrysb.append("           (       "      );
qrysb.append("           (       "      );
...
qrysb.append("                      GROUP BY rollup(nvl(decode(k_n,'DEPT','Departmental Bhavan','Khadi Institutions'),'TOTAL'))      "      );
        ...
        <div class="container-fluid">
            <div style="overflow-x:auto;">
                <table>
                    <thead>
                        <tr class="main_head">
                            <th colspan="7">Khadi Institution Management Information System (KIMIS)
                        ...
                        <tr class="mini_head">
                            <th colspan="1"></th>
                            <th colspan="1"></th>
                            <th colspan="1">No. of KI/Depat Bhavan </th>
					...
					int srno =0;
					while (rsMain.next()){
		BEN_TYPE=rsMain.getString("BEN_TYPE")==null?"":rsMain.getString("BEN_TYPE");
...
%><%= BEN_TYPE %><%}%></td>
							...
							<td> <a href="kimismainstatewise.jsp?INST_TYPE=<%= BEN_TYPE %>" target="_blank" data-toggle="tooltip" title="View More"><i
