...
var OP_PASS= document.getElementById("OP_PASS").value;
//var OP_PASS = document.form.OP_PASS.value;
 
var NP_WORD= document.getElementById("NP_WORD").value;
 
var CP_WORD= document.getElementById("CP_WORD").value;
...
-->
 ...
 <p>&nbsp;</p>
  ...
  <th colspan="4"><div align="center"> 
      ...
      <span class="style90 style96"> PASSWORD CHANGE FOR EDP CENTER FORM </span>
...
<th colspan="4"> 
   ...
   <%
       ...
       if (ins.equals("I")) {
		...
		qry.append(" SELECT nvl(COUNT(*),0) FROM  mas_off_mast WHERE OFF_CD=? AND P_WORD=? AND ACT_YN='Y' " );
...
if (cnt.equals("1")) {
		 ...
		 qrysb.append("  UPDATE MAS_OFF_MAST SET P_WORD=? WHERE OFF_CD=? AND ACT_YN='Y'" );
