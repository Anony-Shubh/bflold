...
//******************************************************************************
    ...
    // alternatively, hard code a date like this...
         //var scwBaseYear = 2008;

    var scwBaseYear        = scwDateNow.getFullYear()-(scwDateNow.getFullYear()-1950);

    // How many years do want to be valid and to show in the drop-down list?

    var scwDropDownYears   = scwDateNow.getFullYear()-1950+2;
...
// ****************************************************************************
    ...
    function popUpCalendar(scwEle,scwSource)
