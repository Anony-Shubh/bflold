...
function openMM(pAppid) {
 ...
 var TOT_SANC=document.form1.TOT_SANC.value;
  ...
  var mmmelig=round(Number((Number(MM_ELIG_PER)* Number(TOT_SANC))/100),0);
...
if (OWN_CONT_DT=="") {
	...
	*/
	...
	if (MM_CLAIM_AMT != mmmelig){
		inlineMsg('MM_CLAIM_AMT',"Margin Money --(Govt. Subsidy) Should be Rs."+mmmelig+" As per Admitted Project Cost of Rs."+TOT_SANC,5);
		 return (false);
		}
