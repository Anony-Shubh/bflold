...
qrysb.append(" BD.MM_REL_AMT-500 ELSE  BD.MM_REL_AMT END MM_REL_AMT ,  ap.app_name,FGETNEFTIFSCODE(BD.APP_ID) AS IFSC_CODE,rb.bank_name,rb.branchname,bbm.email as ");
qrysb.append(" BRANCHEMAIL from bank_dataentry bd, app_detail ap,  rbibanklist rb ,bank_br_mast bbm where pact_id=34    and ");
qrysb.append(" bd.app_id=ap.app_id  and rb.ifsc_code=bd.ifsc_code and rb.ifsc_code=bbm.br_ifsl_code  AND  bd.app_id=? and  BBM.CIRCLE_IFSC=?  ");
qrysb.append(" UNION  ");
...
qrysb.append(" AND  bd.app_id=? and  BBM.CIRCLE_IFSC=?)p ");
