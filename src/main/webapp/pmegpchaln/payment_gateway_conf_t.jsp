...
<table  border="1" align="center" width="60%">
  ...
  <tr>
    ...
    <td ><input name="udf1" id="udf1" type="hidden" value="<%= APP_ID %>"   size="200"  readonly="true" />
	<input name="pg" id="pg" type="hidden" value="NEFT"  size="200"  readonly="true" />

        <%= APP_ID %></td>
    <th>Applicant's  Name :
	    <input name="lastname" id="lastname" type="hidden" value="<%= LASTNAME %>" />
          <input name="key" id="key" type="hidden" value="BHUZlo" /></th>
	  <td ><input name="firstname" id="firstname" type="hidden" value="<%= FIRSTNAME %>"  size="200" readonly="true" />
	      <%= FIRSTNAME %></td>
  </tr>
  <tr>
    <th>Margin Money Refund Amount : </th>
    <td ><input type="HIDDEN" name="amount" id="amount" value="2"   size="200" readonly="true" />Rs. <%= AMOUNT %> /-</td>
	  <th>Financing Branch IFSC Code : </th>
	  <td ><input name="udf3" id="udf3" type="hidden" value="<%= UDF3 %>"   size="200" />
          <%= UDF3 %></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="udf2" id="udf2" type="HIDDEN" value="SBI"   size="200"  readonly="true" /><%= UDF2 %></td>
    <th>Branch Name :</th>
    <td ><input name="udf4" id="udf4" type="hidden" value="<%= UDF4 %>"  size="200"  readonly="true" />
        <%= UDF4 %></td>
  </tr>
