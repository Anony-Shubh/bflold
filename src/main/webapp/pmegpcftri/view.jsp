...
ResultSet rsUp=db.execSQL("select count(*) as noapp from cftri_trg where app_id='"+app_id+"' ");
  while (rsUp.next()){ 
	     count=rsUp.getString("noapp")==null?"0":rsUp.getString("noapp");
...
<th> <div align="center"><input name="button" type="button" class="button"  onClick="ShowReport('<%=app_id%>')" value="View Report"></div>

</th>
<%} else{%>
<th><center>

  <h1><span  style="color:red">Application Not Completed...... Please fill the application to generate Report</span></h1>
  </center></th>
<%}%>
</table>
<%
