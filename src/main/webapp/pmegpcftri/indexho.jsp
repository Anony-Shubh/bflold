...
<html lang="en">
  <head>
    ...
    <link href="css/styleho.css" rel="stylesheet" />
  ...
  <body>
	...
	<div>&nbsp;</div>
<div>&nbsp;</div>
	<FORM action="hologincheck.jsp" method="post" class="form3">
      ...
      <button><INPUT type="submit" value="Login" style="color:#FFFFFF;" ></button>
    </form>

<div align="center">	    	 <P id="error"></P>
                <%
