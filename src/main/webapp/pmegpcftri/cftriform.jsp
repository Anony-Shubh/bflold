...
var mfg_product = document.form.mfg_product.value; 
 ...
 if (mob_no == "")  {	 swal({title:"Please Enter Mobile No."}); return (false);}
	 ...
	 if (trng_month == "") {swal({title:"Please Select Training Months"});	return (false);}
	  ...
	  if (mfg_product == "") {swal({title:"Please Enter What are the food products manufactured by your unit"});	return (false);}
...
String app_id1="";
if  (session.getAttribute("sAPP_ID")==null) {
response.sendRedirect("index.jsp");
}else{
app_id1=(String)session.getAttribute("sAPP_ID");
}
DBCon db= new DBCon();
db.connect();
...
<div class="col">
<label>Food Processing Sub-sector <span  style="color:red"> *</span>:</label>
...
<div class="col">
<label>Preferred Months for training <span  style="color:red"> *</span>:</label>
...
<div class="row">
<div class="col" >
<label>What are the food products manufactured by your unit <span  style="color:red"> *</span>:</label>
...
<div class="col">
<div>&nbsp;</div>
<label>Whether unit visit required by CFTRI experts for expert suggestions on unit upgradation(<strong>All Expenses to be borne by PMEGP beneficiary</strong>) <span  style="color:red"> *</span> :</label>
...
<div class="row">
<div class="col">
<label>Training Required for <span  style="color:red"> *</span>:</label>
<br />
...
<%}else{out.print("<center> <h1> <span class=\"successclr\">Application forwarded to CFTRI, please contact CFTRI </span></h1></center>");}%>
</FORM>
