...
poRR.append(" pa.trademark_cert_yn, pa.udyam_cert_yn,pa.gst_cert_yn, pa.iso_cert_yn, pa.supply_cert_yn,  pa.supply_updoc, pa.partic_cert_yn, pa.partic_updoc, pa.DCO_APPROV_YN ");
