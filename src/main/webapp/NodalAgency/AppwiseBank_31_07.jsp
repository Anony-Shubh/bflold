...
qrysb.append("   AND BD.PACT_ID      = 34 AND GT.MM_ADJUSTMENT_STATUS IS NOT NULL "      );
...
//out.print(ADJ_YN);
  ...
  <DIV align="center"><A onClick="GTSTATUS('<%= APP_ID %>','<%= PMEGPGEOTAGID %>');"  class="greenButtonRound">Status Update </A></DIV>
  <%} else {%>
  Approved
  <%} %>
...
var callbackFunctionArray = new Array(refreshpage);
 modalWin.ShowURL("GTStatusUpdate1.jsp?APP_ID="+APP_ID+"&PMEGPGEOTAGID="+PMEGPGEOTAGID,600,1100,'Status',null,null);
 }//end of bank
