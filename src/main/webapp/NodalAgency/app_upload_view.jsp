	...
	ResultSet rsUp = db.execSQL(qryUp.toString());		
	  ...
	  <table align="center">
        ...
        <tr>
		  ...
		  <a href="PMEGPGenAppForm.jsp?APP_ID=<%= APP_ID %>" class="button">View Applicantion</a></th>
        </tr>
        <tr>
          <th nowrap>SrNo
  ...
  %>
        <tr>
          ...
          <td>
		   ...
		   <a href="doctransfertoNas.jsp?docname=<%= vDOC_NAME %>&APP_ID=<%= APP_ID %>" class="greenButtonRound">view Document </a>  </td>
        </tr>
        <%
  }
  rsUp.close();
