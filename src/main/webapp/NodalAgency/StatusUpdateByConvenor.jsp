...
function frtobank()
{
    ...
    var Name= document.getElementById('APP_ID').value;

    window.location.href="applicantFormValidationBeforeFinalSubmission_Bank.jsp?APP_ID"+Name;
...
%>
 ...
 <INPUT name="ACT_ID"  id="radio" type="radio" onClick="frtobank();">
          <SPAN class="GreenLebel">Forward to Bank</SPAN>		  
...
String vTodayDt ="";
 ...
 if(ACT_ID.equals("5")){
	 db.close();
	 response.sendRedirect("applicantFormValidationBeforeFinalSubmission_Bank.jsp?APP_ID="+APP_ID);
 }
