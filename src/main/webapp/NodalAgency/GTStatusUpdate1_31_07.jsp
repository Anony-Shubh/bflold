...
<FORM name="form" id="form"  class="form" method="post" >
  ...
  <TR>
    ...
    <TD colspan="3"><%= PMEGPGEOTAGID %></TD>
    </TR>
  <TR >
    <TH ><DIV align="left">Beneficiary Name  :</DIV></TH>
	...
	<TR >
	  ...
	  <TD width="141" colspan="2" ><%= VERIFICATION_STATUS %></TD>
	</TR>
	<TR >
	  ...
	  <TD width="141" colspan="2" ><%= TOTAL_EMPLOYEES %></TD>
	</TR>
	...
	<TR >
	  <TH >Capital Cost Of Biulding : </TH>
	...
	<TR >
      ...
      <TD ><%= TOT_PRJ %></TD>
	  <TH ><STRONG>MM Released Amount</STRONG></TH>
  ...
  <TR >
    <TH  ><DIV align="left">MM Adjustemnt Status </DIV></TH>
	
	
    <TD ><%= MM_ADJUSTMENT_STATUS%>	 </TD>
    <TD >MM Adjustemnt Amount </TD>
    <TD ><%= MM_ADJUSTMENT_AMT_S %></TD>
    <TD ><STRONG>Nodal Officer</STRONG> Remarks</TD>
    <TD ><%= NODAL_OFFICER_REMARK %></TD>
  </TR>


  <TR >
    <TH colspan="2" >Select Status </TH>
	<TD colspan="5"><input name="ACT_ID" id="ACT_ID" type="radio"  value="1" >
        <span class="GreenLebel">Approved </span>
		<input name="ACT_ID" id="ACT_ID" type="radio"  value="2" >
        <span class="GreenLebel">Returned For Resubmission </span></TD>
    </TR>
	 <tr>
      <th colspan="2"><div align="center"> Remarks:</div> </th>
