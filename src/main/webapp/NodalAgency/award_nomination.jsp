<%@ page buffer="500kb" session="true" import="java.sql.*,java.util.*,java.text.*,java.util.Date,java.text.SimpleDateFormat,pkgPmegpNew.DBCon"  %>
...
String UNIT_NAME=request.getParameter("app_name")==null?"":(String) request.getParameter("app_name");
...
poR.append(" SELECT pa.DCO_APPROV_YN, pa.FINAL_SUB_DT, ");
...
<TABLE align="center" class="pmegpTable">
    <TR>
      <TD colspan="19"><DIV align="center">PMEGP AWARD NOMINATION FORM</DIV></TD>
    </TR>
  </TABLE>
  <br>
<center>
...
<input name="ins" type="hidden" id="ins" >
  ...
  <tr>
    ...
    <td  colspan="4"> <strong>Application ID: </strong>  <%=app_id1%> </td>
    <td colspan="3"><strong>Beneficiary name:</strong><%=UNIT_NAME%></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td align="center" colspan="2"><input type="text"  name="anl_sales_amt1" value="<%=anl_sales_amt1%>" required></td>
    <td align="center" colspan="2"><input type="text"  name="anl_emp1" value="<%=anl_emp1%>" required></td>
  </tr>
  <tr>
    <td align="center">2.</td>
    <td align="center">2019-20*</td>
    <td  align="center" colspan="2" ><input type="text"  name="anl_sales_amt2"  value="<%=anl_sales_amt2%>"  required></td>
    <td  align="center" colspan="2"><input type="text"  name="anl_emp2" value="<%=anl_emp2%>" required></td>
  </tr>
  <tr>
    <td align="center">3.</td>
    <td align="center">2020-21*</td>
    <td  align="center" colspan="2"><input type="text"  name="anl_sales_amt3" value="<%=anl_sales_amt3%>" required></td>
    <td align="center" colspan="2"><input type="text"  name="anl_emp3" value="<%=anl_emp3%>" required></td>
  </tr>
