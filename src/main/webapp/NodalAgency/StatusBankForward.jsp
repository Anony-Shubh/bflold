...
qrysb.append("   NVL( (SELECT TOTAL_SCORE FROM PMEGP_SCORE_CARD PSC WHERE PSC.APP_ID=AD.APP_ID),0) AS TOTAL_SCORE "      );
...
qrysb.append("   WHERE A.DISTRICT_CD=B.DISTRICT_CD "      );
   ...
   <INPUT name="MOBNO" type="hidden" value="<%=MOB_NO1%>" id="MOBNO"/> 
    ...
    <TR>
	  ...
	  <% if (TOTAL_SCORE>59) {  %>
	   ...
	   <SPAN class="style1"> Cannot Forward to Bank as Total Score Card marks is less than 60</SPAN>
	   <%}%>
...
String sms_string="Dear "+APP_NAME+"  your PMEGP application "+APP_ID +" has been forwarded online to Financing Branch("+IFSC_CODE+").Contact Bank." ;
