...
var BENF_SPECAT_CD = document.form.BENF_SPECAT_CD.value;	
  ...
  for (var i=0; i < document.form.OFF_CD.length; i++)
 {
  ...
  if(BENF_SPECAT_CD == "") {
    inlineMsg('BENF_SPECAT_CD','Please Select Social Category',2);
    return false;
  }
...
// qualification validation
 ...
 if (it=='S' || it=='T' && Number(tprj)>2500000){
	inlineMsg('TOTAL_PRJ','Total Project Cost for <Strong> for Service Industry </Strong> should not exceed 25 lakhs',2);
	return (false);
}
