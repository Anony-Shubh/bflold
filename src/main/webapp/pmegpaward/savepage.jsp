...
<TR>
<th height="66"><DIV align="center" >Data Successfully Forwarded to Agency...</DIV></th></TR>
   <DIV align="center">
   <BR>
   <BR>
    <tr>
    <td><div align="center">
     <a href="curr_status.jsp"> <input name="Button" type="button" class="button" onClick="closeAndRefresh();" value="Close"/></a>
    </div></td>
    </tr>
</DIV>
