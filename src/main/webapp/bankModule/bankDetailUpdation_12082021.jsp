...
-->
 ...
 <form  method="post"  name="form1" id="form1" >
  <%		
   ...
   qrysb.append("  SELECT MOM.OFF_NAME1,BD.OFF_CD,BD.EDP_TRG_NAME,TO_CHAR(BD.EDP_FR_DT,'DD-MON-YYYY') AS EDP_FR_DT,BD.TDR_ACNO,TO_CHAR(BD.TDR_ADJ_DT,'DD-MON-YYYY') AS TDR_ADJ_DT," );
