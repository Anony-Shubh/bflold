...
<br> 
 <form name="form" id="form"  class="form" method="post">
   ...
   qrysb.append("  SELECT MOM.OFF_NAME1,  MOM.AGENCY_TYPE,  MD.DISTRICT_NAME,  AD.APP_ID, AD.APP_NAME,  AD.MOB_NO1,  BD.IFSC_CODE," );
   ...
   qrysb.append("  BD.PAY_STATUS,  BD.FB_ACNO,  BD.MM_REL_AMT,TO_CHAR(BD.MM_REL_DT,'DD-MON-YYYY') AS MM_REL_DT  , BD.PACT_ID, " );
