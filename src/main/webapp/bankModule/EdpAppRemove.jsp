...
function submit_form() {
  var DOC_REMARKS=form.DOC_REMARKS.value;
  if(DOC_REMARKS == "") {
    inlineMsg('DOC_REMARKS','Please Enter Remarks',2);
    return false;
  }
...
<form method="post" name="form" id="form"  >
	  ...
	  <p>
		...
		String UP_ID = request.getParameter("UP_ID")==null?"":(String) request.getParameter("UP_ID") ;
		String UPM_CD = "";
		String DOC_NAME = "";
		String DOC_REMARKS = "";
		String DOC_TYPE = "";
	  ...
	  MOB_NO1=rsApp.getString("MOB_NO1")==null?"":rsApp.getString("MOB_NO1");
		...
		qryUp.append("   AUT.DOC_ACTYN='Y' AND  AUT.UPM_CD =8 AND AUT.UP_ID="+UP_ID+" AND AUT.APP_ID='"+APP_ID+"'  ");
	...
	while (rsUp.next()) {
	  ...
	  <table align="center">
        <tr>
          <th colspan="2" scope="col"><div align="center">EDP Certificate Delete Form  </div></th>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <input name="UP_ID" type="hidden" id="UP_ID" value="<%=UP_ID%>">
        ...
        <tr>
          <th>Remarks</th>
          <td><input name="DOC_REMARKS" type="text" id="DOC_REMARKS" value="<%=  DOC_REMARKS %>"></td>
        </tr>
        <tr>
   ...
   if ((String)request.getParameter("ins")!=null){
	    UP_ID=request.getParameter("UP_ID")==null?"0":(String) request.getParameter("UP_ID");
		DOC_REMARKS=request.getParameter("DOC_REMARKS")==null?"0":(String) request.getParameter("DOC_REMARKS");
       out.print(UP_ID);
        List values=new ArrayList();
		List pstm=new ArrayList();
		StringBuffer qryUpdate = new StringBuffer();
		qryUpdate.append(" UPDATE APP_UPLOAD_TRANS SET DOC_ACTYN='N',DOC_REMARKS=?,EXP_DT=SYSDATE WHERE UP_ID=?");
		values.clear();
        pstm.clear();
