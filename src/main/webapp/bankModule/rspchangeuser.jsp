...
sb.append("UPDATE  bank_br_mast SET psswd=?, REG_RESET_DT=sysdate ,RESETYN='N' WHERE BR_IFSL_CODE=?");
 ...
 %>
  ...
  (* mark fields are mendotory )
    ...
    <tr >
      ...
      <td><input name="OLD_PWD" id="OLD_PWD" type="password"  size="15" maxlength="15"></td>
    </tr>
    <tr >
      <td >(2)</td>
      <th nowrap > 
      ...
      <td>
        <input name="NEW_PWD" id="NEW_PWD" type="password"  size="15" maxlength="15">
      </td>
    </tr>
    <tr >
      <td >(3)</td>
      ...
      <td>
        <input name="RE_PWD" id="RE_PWD" type="password"  size="15" maxlength="15">
      </td>
    </tr>
    <tr >
