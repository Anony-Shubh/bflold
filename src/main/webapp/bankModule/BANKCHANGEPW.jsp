...
CONF_TRANSAC=request.getParameter("CONF_CONF_TRANSAC")== null?"":(String) request.getParameter("CONF_CONF_TRANSAC").trim();
StringBuffer sb= new StringBuffer();
sb.append("UPDATE  bank_br_mast SET psswd=?, REG_RESET_DT=sysdate ,RESETYN='N', REG_YN='Y',CONF_TRANSAC=?,CONF_EMAIL=? WHERE BR_IFSL_CODE=?");
