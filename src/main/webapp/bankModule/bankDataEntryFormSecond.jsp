...
<input name="BANK_REC_DT" id="BANK_REC_DT" type="text"  tabindex="0" value="<%= BANK_REC_DT %>"  onClick="javascript:NewCssCal('BANK_REC_DT','ddMMMyyyy')" size="12" placeholder="dd-mom-yyyy" autocomplete="off"  ></td>
    ...
    <tr>
      <th>(18)</th>
      <th>&nbsp;</th>
      <th colspan="3"><input name="btnClaim" type="button" class="buttonBlue" id="btnClaim" style="background-color:#0000CC"  value=" Submit  Online Govt Subsidy (MM) Claim" onClick="openMM('<%= APP_ID %>');"></th>
