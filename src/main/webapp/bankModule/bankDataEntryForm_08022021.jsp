...
av.append("SELECT a.tr_id, b.app_id,a.act_id, to_char(a.bank_rec_dt,'DD-MON-YYYY') AS  bank_rec_dt, MS.STATE_CD,bank_remarks,AM.activity_name,100-OWNCONT_PER(B.APP_ID) AS BANK_LOAN_PER,a.RINT,a.LOAN_PERIOD, ").
...
<input name="BANK_REC_DT" id="BANK_REC_DT" type="text"  tabindex="0" value="<%= BANK_REC_DT %>" onClick="javascript:NewCssCal('BANK_REC_DT','ddMMMyyyy')" size="12" placeholder="dd-mom-yyyy" autocomplete="off" >
    ...
    <tr>
      ...
      <td colspan="2"><input name="Button" type="button" class="buttonMerun" onClick="clearEDP();" value="CLEAR EDP DATA" title="After Clear Data Please Click on Save Button"></td>
