...
<head>
 ...
 response.setHeader("X-Frame-Options", "SAMEORIGIN"); 
  String cspHeader = "default-src 'self'; frame-src 'self' kviconline.gov.in;";
        response.setHeader("Content-Security-Policy", cspHeader);
		 ...
		 response.setHeader("X-Content-Type-Options", "nosniff"); 
		  ...
		  String cntheader="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline';";
		  		  response.setHeader("Content-Security-Policy", cntheader); 
  ...
  <jsp:setProperty name="upBean" property="filesizelimit" value="1050000" />
   ...
   <jsp:setProperty name="upBean" property="whitelist" value="*.pdf,*.jpg,*jpeg,*.png" />
	  ...
	  <p>
		...
		String DOC_NAME = "";
		String DOC_REMARKS = "";
		String sifscode=(String)session.getAttribute("bank_id");


		if  (sifscode==null) {
		
		out.print (" Session Out please login again.........sb");
		   ...
		   qry.append("  TO_CHAR(A.ONLINE_SUBDT, 'DD-MON-RRRR HH:MI:SS') AS ONLINE_SUB_DT, ");
		    qry.append("  A.MOB_NO1, ");
			 qry.append(" A.DOB,  A.E_MAIL,A.AADHAR_NO ");
			  ...
			  qry.append("WHERE A.APP_ID = '"+APP_ID+"' AND A.IFSC_CODE='"+sifscode+"'");
