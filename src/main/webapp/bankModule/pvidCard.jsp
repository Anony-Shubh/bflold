...
<%
  ...
  String vStateCD=(String) session.getAttribute("STATE")==null?"":(String)session.getAttribute("STATE");
%>

<TABLE align="center" class="pmegpTable">
   
    <TR>
      <TD colspan="19"><DIV align="center">GeoTag Physical Verification Id Card</DIV></TD>
    </TR>
...
qrysb.append("   SELECT GD.EN_ID,GD.DOC_NAME,GD.DOC_REMARK,GD.ACT_YN,TO_CHAR(UPLOAD_TIMESTAMP,'DD-MON-RRRR') AS UPLOAD_TIMESTAMP,MS.STATE_NM,MS.STATE_CD from GEOENUM_DETAIL GD,M_STATE MS WHERE MS.STATE_CD=GD.STATE_CD AND GD.ACT_YN='Y' AND MS.STATE_NM='"+vStateCD+"' "      );
    ...
    %>
         <tr>
              <TD> <DIV align="center"><%= count %></DIV></TD>
			   <TD> <DIV align="center"><%= EN_ID %></DIV></TD>
      <TD><DIV align="center">
	   <%=STATE_NM %> 
	   </DIV></TD>
	   <TD><DIV align="center">
      ...
      <TD> <DIV align="center">
 <input type="button" name="button"  value="View" onClick="GTview('<%= DOC_NAME %>');">
...
var callbackFunctionArray = new Array(refreshpage);
 modalWin.ShowURL("../ENUMADMINLOGIN/docViewEn.jsp?DOC_NAME="+DOC_NAME,720,1350,'Status',null,null);
 }
fun
