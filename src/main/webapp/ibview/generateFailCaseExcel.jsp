<%@ page session="true"   import="java.io.*,java.util.Date, javax.naming.*,java.sql.*,javax.sql.*,java.util.*,net.sf.jasperreports.engine.*, net.sf.jasperreports.engine.export.*,java.math.BigDecimal"  %>
		   ...
		   String vwherecls="";
String vsStatetit ="";
		   String vFname=request.getParameter("REPNAME")==null?"Failcaseibview":(String)request.getParameter("REPNAME");
...
ServletContext context = request.getServletContext();
	...
	//String folderpath="/opt/tomcat5/webapps/jaasperop/jasperxls";
