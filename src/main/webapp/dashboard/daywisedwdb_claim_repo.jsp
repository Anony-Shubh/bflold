...
qry.append("     	        SUM(OFFLINE_NO_OF_PRJ_2526) AS NO_OF_PRJ2526,	     "     );
qry.append("     	     SUM(OFFLINE_MM_2526)        AS MM_REL2526	     "     );
qry.append("     	   FROM	     "     );
...
qry.append("     	        0                              AS OFFLINE_NO_OF_PRJ_2526,	     "     );
qry.append("     	       0                              AS OFFLINE_MM_2526	     "     );
...
qry.append("     	       0 AS OFFLINE_MM_2223,0,0,0,0,    0,0	     "     );
...
qry.append("     	         THEN 1	     "     );
qry.append("     	         ELSE 0	     "     );
qry.append("     	       END) AS NO_OF_PRJ_EPORTAL_2425,	     "     );
qry.append("     	       MMRELDASH('I','01-APR-2024','31-MAR-2025') as NEWMMCLAIM_2425,	     "     );
qry.append("     	     SUM(	     "     );
qry.append("     	       CASE	     "     );
qry.append("     	         WHEN TRUNC(BANK_DATAENTRY.MM_REL_DT) BETWEEN '01-APR-2025' AND '31-MAR-2026'	     "     );
qry.append("     	         THEN 1	     "     );
qry.append("     	         ELSE 0	     "     );
qry.append("     	       END) AS NO_OF_PRJ_EPORTAL_2526,	     "     );
qry.append("     	       MMRELDASH('I','01-APR-2025','31-MAR-2026') as NEWMMCLAIM_2526	     "     );
...
qry.append("     	         ELSE 0	     "     );
qry.append("     	       END) AS NO_OF_PRJ_EPORTAL_2425,	     "     );
qry.append("     	       MMRELDASH('II','01-APR-2024','31-MAR-2025') as NEWMMCLAIM_2425,	     "     );
qry.append("     	     SUM(	     "     );
qry.append("     	       CASE	     "     );
qry.append("     	         WHEN TRUNC(BANK_DATAENTRY_SECOND.MM_REL_DT) BETWEEN '01-APR-2025' AND '31-MAR-2026'	     "     );
qry.append("     	         THEN 1	     "     );
qry.append("     	         ELSE 0	     "     );
qry.append("     	       END) AS NO_OF_PRJ_EPORTAL_2526,	     "     );
qry.append("     	       MMRELDASH('II','01-APR-2025','31-MAR-2026') as NEWMMCLAIM_2526	     "     );
...
<table id="tableid" align="center" class="bordered">
 <thead>
  <tr>
	...
	<th rowspan="2"><div align="center">No of Projects <br>(2025-26)</div></th>
    <th rowspan="2"><div align="center">MM Disbursed<br>(2025-26)</div></th>
  </tr>
	</thead>
	<%
...
NO_OF_PRJ2526=rs.getString(20)==null?"":rs.getString(20);
MM_REL_2526=rs.getString(21)==null?"":rs.getString(21);
	%>
	<tbody>
  <tr>
  <th><h1><%=MM_DESC%></h1></th>
 ...
 <% }%></th>
 <th><h1><%= NO_OF_PRJ2526 %></h1></th>
 <th><h1><%= MM_REL_2526 %></h1>
  </tr>
  </tbody>
  <%
 }
