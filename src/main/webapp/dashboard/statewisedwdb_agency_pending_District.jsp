...
qrysb.append("     AND AD.ACT_ID IN (0,1,4,2) "+vwherecls+"  AND MS.STATE_CD='"+vStatecd+"' AND AD.ACT_YN='Y' "      );
...
<a href="../pmegphome/index.jsp" class="button" >
 ...
 <thead>
  <tr>
      ...
      <th>To Date:<%= vtodt %></th>
      <th rowspan="3">Above 45 days </th>
     <!-- <th colspan="2" rowspan="2"><div align="center"></div>        
      <div align="center"> Recommended by DLTFC but pending for Forwarding to Bank </div></th>-->
      </tr>
  <tr>
    <th colspan="4"><div align="center">No fo Applications Pending With Implementing Agency </div></th>
    </tr>
  <tr>
