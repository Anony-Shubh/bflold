...
String banknm=request.getParameter("bankname")==null?"":(String) js.getOnlyTextspc(request.getParameter("bankname"),70);
...
qrysb.append("   WHERE AD.APP_ID=BD.APP_ID AND AD.ACT_ID=5 AND AD.OFF_CD=MOM.OFF_CD AND bd.act_id=11 AND bd.loan_docfname IS NOT NULL AND bd.MM_CLAIM_AMT>0 AND AD.BANK_NAME LIKE '"+banknm+"'  and "+vcls+" "      );
