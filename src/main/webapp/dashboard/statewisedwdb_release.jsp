...
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2016' and '31-MAR-2017' ";
}

if (YR.equals("2017-18")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2017' and '31-MAR-2018' ";
}
if (YR.equals("2018-19")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2018' and '31-MAR-2019' ";
}
if (YR.equals("2019-20")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2019' and '31-MAR-2020' ";
}
if (YR.equals("2020-21")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2020' and '31-MAR-2021' ";
}
if (YR.equals("2021-22")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2021' and '31-MAR-2022' ";
}

if (YR.equals("2022-23")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2022' and '31-MAR-2023' ";
}
if (YR.equals("2023-24")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2023' and '31-MAR-2024' ";
}

if (YR.equals("2024-25")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2024' and '31-MAR-2025' ";
}

if (YR.equals("2025-26")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2025' and TRUNC(SYSDATE) ";
}

if (YR.equals("TOTAL")) {
vcls=" TRUNC(bd.MM_REL_DT) BETWEEN '1-APR-2016' and TRUNC(SYSDATE) ";
}
Date now = new Date();
...
qrysb.append("   SELECT  AD.BANK_NAME,"      );
...
qrysb.append("   WHERE AD.APP_ID=BD.APP_ID AND AD.ACT_ID=5 AND MOM.OFF_CD=AD.OFF_CD AND bd.act_id=11 AND bd.loan_docfname IS NOT NULL AND bd.MM_CLAIM_AMT>0  "      );
qrysb.append("    AND  BD.MM_REL_DT IS NOT NULL and "+vcls+" "      );
...
//out.print(qrysb.toString());
 ...
 %>
<center>
  <h1> MM Disbursed to Financing Branch From <%=wcls%>
...
%>
  <tr>
    <td><div align="center"><%= srno %></div></td>
     <td><div align="left"><a href="statewisedwdb_release_dw.jsp?bankname=<%= BANK_NAME %>&YR=<%=YR%>" target="_parent"><%= BANK_NAME %></a></div></td>
    <td>
