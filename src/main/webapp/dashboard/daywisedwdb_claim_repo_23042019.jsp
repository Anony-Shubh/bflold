...
//qry.append("       SUM("      );
//qry.append("       CASE"      );
//qry.append("         WHEN TRUNC(pmegponline.corpdata_final.DATE_TRANS)  between '01-APR-2017' and '31-MAR-2018' "      );
//qry.append("         THEN 1"      );
//qry.append("         ELSE 0   END)"      );
...
qry.append("       SUM("      );
qry.append("       CASE"      );
qry.append("         WHEN TRUNC(pmegponline.corpdata_final.DATE_TRANS) > '31-MAR-2018'"      );
qry.append("         THEN 1"      );
qry.append("         ELSE 0"      );
...
qry.append("         THEN ROUND(NVL(pmegponline.corpdata_final.MARGIN_AMOUNT_CLAIMED, 0) / 100000, 2)"      );
qry.append("         ELSE 0"      );
qry.append("       END) AS MARGIN_AMOUNT_CLAIMED_1819"      );
...
qry.append("       SUM("      );
qry.append("       CASE"      );
qry.append("         WHEN TRUNC(BANK_DATAENTRY.MM_REL_DT) > '31-MAR-2018'"      );
qry.append("         THEN 1"      );
qry.append("         ELSE 0"      );
...
qry.append("     UNION "      );
qry.append(" SELECT 'New Claims as per PMEGP e-Portal Second Loan' AS MM_DESC,"      );
qry.append("     0                                            AS NO_OF_PRJ_SEC_1617,"      );
 ...
 qry.append("    SUM(    CASE"      );
  qry.append("     WHEN TRUNC(BANK_DATAENTRY_SECOND.MM_REL_DT) > '31-MAR-2018'"      );
   qry.append("    THEN 1"      );
   qry.append("    ELSE 0"      );
   qry.append("  END) AS NO_OF_PRJ_EPORTAL_1819,"      );
   qry.append("  SUM("      );
   qry.append("  CASE      WHEN TRUNC(BANK_DATAENTRY_SECOND.MM_REL_DT) > '31-MAR-2018'"      );
...
<table id="tableid" align="center" class="bordered">
 <thead>
  <tr>
	...
	<th rowspan="2"><div align="center">No of Projects (2018-19)</div></th>
    <th rowspan="2"><div align="center">MM Disbursed(2018-19)</div></th>
  </tr>
	</thead>
	<%
...
MM_REL_1819=rs.getString(7)==null?"":rs.getString(7);
  ...
  <% if (count==3){%>
  <a href="daywisedwdb_claim_repo_sec.jsp" class="button">Read more</a>
 <% }%>
  </th>
  </tr>
  </tbody>
