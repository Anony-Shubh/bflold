...
vcls=" TRUNC(ad.FORD_DT_DLTFC) BETWEEN '1-APR-2016' and '31-MAR-2017' ";
}

if (YR.equals("2017-18")) {
vcls=" TRUNC(ad.FORD_DT_DLTFC) BETWEEN '1-APR-2017' and '31-MAR-2018' ";
}
if (YR.equals("2018-19")) {
vcls=" TRUNC(ad.FORD_DT_DLTFC) BETWEEN '1-APR-2018' and '31-MAR-2019' ";
}
if (YR.equals("2019-20")) {
vcls=" TRUNC(ad.FORD_DT_DLTFC) BETWEEN '1-APR-2019' and '31-MAR-2020' ";
}
if (YR.equals("2020-21")) {
vcls=" TRUNC(ad.FORD_DT_DLTFC) BETWEEN '1-APR-2020' and TRUNC(SYSDATE) ";
}


if (YR.equals("TOTAL")) {
vcls=" TRUNC(ad.FORD_DT_DLTFC) BETWEEN '1-APR-2016' and TRUNC(SYSDATE) ";
}
Date now = new Date();
...
qrysb.append("   WHERE (ad.FORD_DT_DLTFC IS NOT NULL OR MTG_ID IS NOT NULL)  "      );
...
ResultSet rsMain = db.execSQL(qrysb.toString());
 ...
 %>
<center>
  <h1 class="style1"> No. of Application Placed Before DLTFC during the period from <%= wcls %>
  ...
  <tr>
    <td><div align="center"><%= srno %></div></td>
     <td><div align="left"></div>
       <div align="left"><a href="districtwisedwdb_dltfc.jsp?STATE_CD=<%= STATE_CD %>&YR=<%=YR%>" target="_parent"><%= STATE_NM %></a></div></td>
