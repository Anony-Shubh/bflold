...
ResultSet rsMain = db.execSQL(qrysb.toString());
 ...
 %>
<center>
  <h1 class="style1"> No. of Application Forwarded to Bank during the period from <%=wcls%>
...
%>
  <tr>
    <td><div align="center"><%= srno %></div></td>
     <td><div align="left"><a href="districtwisedwdb_fwdbank.jsp?STATE_CD=<%= STATE_CD %>&YR=<%=YR%>" target="_parent"><%= STATE_NM %></a></div></td>
