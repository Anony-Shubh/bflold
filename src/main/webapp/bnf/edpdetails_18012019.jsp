...
<TR>
  <TD width="24%">Date :</TD>
  <TD colspan="8"><INPUT name="TR_DATE" type="text" id="TR_DATE" onClick="popUpCalendar(this, this.form.BNF_AFROMDT,'dd-mmm-yyyy');return false;" value="<%= TR_DATE %>" maxlength="11" readonly="true"  autocomplete="off" PLACEHOLDER="Date" ></TD>
</TR>
