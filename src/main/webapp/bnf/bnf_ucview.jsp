...
%>
            <TBODY>
             <TR> 
			     ...
			     <TD><DIV align="center"><A target="_blank" href="jasperReports/bnfreport.jsp?REP_NM=bnf_uc&OFF_CD=<%=OFF_CD%>&YEAR_ID=<%=sselect%>&UC_ID=<%=UC_ID%>&OFFICENAME=<%= OFFICENAME %>" class="myButton" VALUE="View Report">Generate UC</A></DIV></TD>
				 <TD>
