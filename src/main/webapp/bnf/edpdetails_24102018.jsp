...
<table>
<tr>
  <td colspan="9"><div align="center"> Form For <%=PBNF_DESC%> ( 2018-19) </div></td>
  </tr>
<tr>
  <td width="24%">Date :</td>
  <td colspan="8"><input name="TR_DATE" type="text" id="TR_DATE" onClick="popUpCalendar(this, this.form.BNF_AFROMDT,'dd-mmm-yyyy');return false;" value="<%= TR_DATE %>" maxlength="11"  autocomplete="off" ></td>
</tr>
...
<input name="OFF_CD" type="hidden" id="OFF_CD" value="<%= OFF_CD %>" />
  <td> Remark : </td>
  <td colspan="8"><input name="REMARK_ADD"  type="text" id="REMARK_ADD" value="<%=REMARK_ADD%>" size="50" maxlength="50"  autocomplete="off"></td>
</tr>
...
<tr>
 ...
 <td><input name="FIN_KVIC"  type="text"  autocomplete="off"  id="FIN_KVIC" value="<%=FIN_KVIC%>" onKeyPress="javascript:return isNumber(event)" size="10" maxlength="15" onBlur="calculate_amttotal();" ></td>
  ...
  <td><input name="PH_KVIB"  type="text"  id="PH_KVIB"   autocomplete="off" value="<%=PH_KVIB%>" onKeyPress="return isNumberNoDec(event)" size="8" maxlength="8" onBlur="calculate_phytotal();"></td>
   <td><input name="FIN_KVIB"  type="text"   id="FIN_KVIB"   autocomplete="off" value="<%=FIN_KVIB%>" onKeyPress="javascript:return isNumber(event)" size="10" maxlength="13" onBlur="calculate_amttotal();"></td>
  ...
  <td><input name="FIN_DIC"  type="text"   autocomplete="off" id="FIN_DIC" value="<%=FIN_DIC%>" onKeyPress="javascript:return isNumber(event)" size="10" maxlength="13" onBlur="calculate_amttotal();"></td>
