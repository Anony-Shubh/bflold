...
<table>
<tr>
  <td colspan="8"><h1><div align="center"><%= BNF_SUB_HEAD_LONG_DESC %></div></h1></td>
  </tr>
<tr>
  <td colspan="4">&nbsp;</td>
  
  <!--<td><div align="center"><a href="JavaScript:newPopup('bypass.jsp?PBUDID=<%= BNF_HDID %>&PBNF_TRID=<%= BNF_TRID %>'&PBNF_DESC=<%= BNF_SUB_HEAD_LONG_DESC %>');">ADD NEW </div></td>-->
  <td><div align="center"><a href="JavaScript:newPopup('bypass.jsp?PBUDID=<%= BNF_HDID %>&PBNF_TRID=<%= BNF_TRID %>&PBNF_DESC=<%= BNF_SUB_HEAD_LONG_DESC %>');">ADD NEW</div></td>
</tr>
<tr>
  <td colspan="5">&nbsp;</td>
...
<tr>
  ...
  <td>
  <a href="JavaScript:newPopup('bypass.jsp?PBUDID=<%= BNF_HDID %>&PBNF_TRID=<%= BNF_TRID %>&PBNF_DESC=<%= BNF_SUB_HEAD_LONG_DESC %>');">
  ...
  <a href="JavaScript:newPopup('edpphyupload.jsp?PBUDID=<%= BNF_HDID %>&PBNF_TRID=<%= BNF_TRID %>&PBNF_DESC=<%= BNF_SUB_HEAD_LONG_DESC %>');">
    <div style="height:100%;width:100%">
	  ...
	  <div align="center">Upload</div></a>
	  <%} else{%>
		  
		 <a href="upload/<%=DOCFNAME%>" >Download</a>
	<% }}%>
	 </div></td>
</tr>  
