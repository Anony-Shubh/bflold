...
<TABLE id="customers" align="center">
        ...
        <TR>
          <TD colspan="4" scope="col"><DIV align="center">Are you sure you want to Forward to HO?</DIV></TD>
        </TR>
        ...
        <TR>
          <TD colspan="4"><DIV align="center">
			<a class="myButton" onClick="submit_form();">Confirm</a>
          </DIV></TD>
        </TR>
      </TABLE>
	 <%
...
qryUpdate.append("UPDATE BNF_UC SET HO_FORW_DATE=SYSDATE WHERE UC_ID=?");
values.clear();
pstm.clear();
