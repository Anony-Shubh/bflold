...
<form method="post" name="form" id="form"  >
	  <p>
		...
		String UP_ID = request.getParameter("UP_ID")==null?"0":(String) request.getParameter("UP_ID");
	  ...
	  MOB_NO1=rsApp.getString("MOB_NO1")==null?"":rsApp.getString("MOB_NO1");
		...
		qryUp.append(" SELECT gt.UP_ID,  gt.UPM_CD,  gt.DOC_NAME,  gt.DOC_REMARKS,  gt.DOC_ACTYN,  gt.PMEGPGEOTAGID,  gt.APP_ID FROM geotag_upload_trans gt  where app_id='"+APP_ID+"' AND UP_ID='"+UP_ID+"' and DOC_ACTYN='Y' ");
   ...
   List values=new ArrayList();
		...
		qryUpdate.append("UPDATE GEOTAG_UPLOAD_TRANS SET DOC_ACTYN='N',DEL_TIMESTAMP=SYSDATE WHERE  UP_ID=? AND APP_ID=? and DOC_ACTYN='Y'  ");
		values.clear();
        pstm.clear();
