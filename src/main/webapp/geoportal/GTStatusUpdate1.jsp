...
<BODY onLoad="chMd()";>
<form   name="form" id ="form" method="post" action="ValidateCall.jsp" >
<%	
...
//out.print(MM_ADJUSTMENT_STATUS);
...
<FORM name="form" id="form" class="form" method="post">
  ...
  <TR>
    ...
    <TD colspan="5" ><STRONG>Beneficiary Name  :</STRONG> <%= APP_NAME %><INPUT name="APP_NAME" type="hidden" id="APP_NAME" value="<%= APP_NAME %>" ></TD>
    </TR>
...
rsValidate.close();
  ...
  <TR >
    ...
    <TD ><DIV align="left"><INPUT name="MAX_AMT" type="text" id="MAX_AMT"  size="10" maxlength="7"  value="" disabled="disabled" ></DIV></TD>
