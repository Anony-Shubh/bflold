...
<HEAD>
	...
	String vPMEGPGEOTAGID= request.getParameter("PMEGPGEOTAGID")==null?"0":(String) request.getParameter("PMEGPGEOTAGID");
	...
	String outFileName =folderpath+"jaspdf/"+vPMEGPGEOTAGID+rnd+".pdf"; 
 ...
 conn=ds.getConnection(); 
		 ...
		 hm.put("PAPPID",vPMEGPGEOTAGID);
           ...
           exporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, outFileName); 
			...
			response.sendRedirect("../jasperrop/jaspdf/"+vPMEGPGEOTAGID+rnd+".pdf");
			conn.close();
				}catch (Exception e){
