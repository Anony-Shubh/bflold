...
<TABLE align="center" class="pmegpTable" id="example">
...
CO_REMARKS=rs.getString("CO_REMARKS")==null?"":rs.getString("CO_REMARKS");
    ...
    %>
     <INPUT name="APP_ID" type="hidden" id="BANKCODE" value="<%=APP_ID %>">
      ...
      <TD><%=CUR_STA%><% if (ACT_ID.equals("2")){%>/<%=CO_REMARKS%><%}%></TD>
...
var callbackFunctionArray = new Array(refreshpage);
 modalWin.ShowURL("GTStatusUpdate1.jsp?APP_ID="+APP_ID+"&PMEGPGEOTAGID="+PMEGPGEOTAGID,720,1350,'Status',null,null);
 }//end of bank
