...
<FORM name="form" id="form"  class="form" method="post" >
  ...
  <TR>
    ...
    <TD colspan="2"><DIV align="left"><%=APP_ID %>   </DIV></TD>
    <TH>Geo Tagging Id </TH>
    <TD colspan="2"><%= PMEGPGEOTAGID %></TD>
    </TR>
  <TR >
    <TH colspan="2" ><DIV align="left">Beneficiary Name  :</DIV></TH>
    <TD colspan="5" ><DIV align="left"><%=  APP_NAME %></DIV></TD>
    </TR>
	...
	<TR >
	  <TH colspan="2" >Date of Verification: </TH>
	  <TD ><%= DATE_OF_VERIFICATION %></TD>
      <TH width="250" >Verification By:</TH>
      <TD width="339" ><%= VERIFICATION_BY %></TD>
	  <TH width="276" >Physical Verification Status: </TH>
	  <TD width="141" ><%= VERIFICATION_STATUS %></TD>
	</TR>
	<TR >
	  <TH colspan="2" >Physical Verification Remarks: </TH>
	  <TD ><%= VERIFIER_REMARKS %></TD>
      <TH >Per Capita Investment : </TH>
      <TD ><%= PER_CAPITA_INVESTMENT_NORM_SAT %></TD>
	  <TH >Total Employees:</TH>
	  <TD width="141" ><%= TOTAL_EMPLOYEES %></TD>
	</TR>

	
	<TR >
	  <TH colspan="7" ><DIV align="center">Unit Description </DIV></TH>
    </TR>
	...
	<TR >
	  ...
	  <TR>
	  <TH colspan="2" >MM Released: </TH>
	  <TD ><%= MM_REL_AMT %></TD>
      <TH >Maximum MM Eligible : </TH>
      <TD ><%= MAX_AMT%></TD>
  ...
  <TR >
    <TH colspan="7" ><DIV align="center"><STRONG><H3>Recommendation of District Nodal Officer</H3></STRONG></DIV></TH>
    </TR>
  <TR >
    <TH colspan="2"  ><DIV align="left">MM Adjustemnt Status </DIV></TH>
	
	 <% if (VERIFICATION_STATUS.equals("Completed")) {%>
    <TD >
	<INPUT type="radio" id="opt-1" value="FA"  onClick="chMd()" name="MM_ADJUSTMENT_STATUS" <% if (MM_ADJUSTMENT_STATUS.equals("FA")){out.print("checked");}%>> <SPAN class="GreenLebel">Fully Allowed</SPAN>		 </TD>
    <TD  >
	<INPUT type="radio" id="opt-1" value="PA"  onClick="chMd()" name="MM_ADJUSTMENT_STATUS" <% if (MM_ADJUSTMENT_STATUS.equals("PA")){out.print("checked");}%>><SPAN class="OrangeLebel">Partially Allowed</SPAN>     </TD>
	 <%}%>
	 
	<% if (VERIFICATION_STATUS.equals("Non-Traceable")  || VERIFICATION_STATUS.equals("Defunct")) {%>
    <TD ><DIV align="left">
    ...
    <TD colspan="4" >
    <DIV align="left">
	  <INPUT type="radio" id="opt-1" value="RU" onClick="chMd()" name="MM_ADJUSTMENT_STATUS" <% if (MM_ADJUSTMENT_STATUS.equals("RU")){out.print("checked");}%>>
	  <SPAN class="MarunLebel">Recommended For Reverification of Unit </SPAN>    </DIV></TD>
	  <%}%> 
    </TR>


  <TR >
    <TH colspan="2" ><DIV align="left">MM Adjustemnt Amount </DIV></TH>
    <TD ><DIV align="left"><INPUT type="text" name="MM_ADJUSTMENT_AMT_S" id="MM_ADJUSTMENT_AMT_S" value="<%= MM_ADJUSTMENT_AMT_S %>"></DIV></TD>
    <TH ><STRONG>Nodal Officer</STRONG> Remarks</TH>
    <TD colspan="3" ><INPUT type="text" name="NODAL_OFFICER_REMARK" id="NODAL_OFFICER_REMARK" value="<%= NODAL_OFFICER_REMARK %>"></TD>
    </TR>
  <% if (ACT_ID.equals("2")){%>  <TR>
	 <TH colspan="2" > Approver Remarks
	 <TD colspan="5" ><%=CO_REMARKS%>
	</TR>
	<%}%>
  <TR>
    <TH colspan="7"> 
...
qryUpdate.append("MM_ADJUSTMENT_STATUS=?,MARGIN_MONEY_ADJUSTMENT_DATE=SYSDATE,LAST_UPDATE_DT=SYSDATE ");
