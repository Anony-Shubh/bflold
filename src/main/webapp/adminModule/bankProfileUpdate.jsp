...
qyrSel.append("CIRCLE_IFSC,CIRCLE_NEFT,CIRCLE_TRANS_ACNO,BR_UPDATE_YN,");
...
<tr>
  <th>Nodal Bank ID </th>
  <td>  <input name="N_IFSC_CODE" type="text" id="N_IFSC_CODE" value="<%=N_IFSC_CODE%>" size="15" maxlength="15" readonly="true">  </td>
  <td>Circle IFSC </td>
  <td><%=CIRCLE_IFSC%></td>
</tr>  
<tr>
  <th>Sponsoring Bank </th>
  <td>  <input name="SPON_BANK_NAME" type="text" id="SPON_BANK_NAME" value="<%=SPON_BANK_NAME%>" size="60" maxlength="60" readonly="true">  </td>
  <td>Circle NEFT </td>
  <td><%=CIRCLE_NEFT%></td>
</tr>  
<tr>
  <th>Region Name </th>
  <td>  <input name="HIRONE" type="text" id="HIRONE" value="<%=HIRONE%>" size="50" maxlength="50" readonly="true">  </td>
  <td>Circle Tr. No </td>
  <td><%=CIRCLE_TRANS_ACNO%></td>
</tr>  
<tr>
  <th>Zone Name     </th>
  <td>  <input name="HIRTWO" type="text" id="HIRTWO" value="<%=HIRTWO%>" size="50" maxlength="50" readonly="true">  </td>
  <td>Br. Update: </td>
  <td><%=BR_UPDATE_YN%></td>
</tr>
<tr>
