...
String folderpath= context.getRealPath("")+"/reports/";
	...
	Context envCtx = (Context) ctx.lookup("java:comp/env");
			DataSource ds=(DataSource) envCtx.lookup("jdbc/SVM");
 	conn=ds.getConnection(); 
	/*Connection conn=null;
	String folderpath="C:\\tomcat8\\webapps\\tradingaudit\\reports\\";
	String fileName = folderpath+vFname+".jasper"; 
	String outFileName =folderpath+"\\jaspdf\\"+vFname+vGenID+".pdf"; 
	String fname=vFname+vGenID+".pdf";
   	Context ctx=new InitialContext();
	Context envCtx = (Context) ctx.lookup("java:comp/env");
 	DataSource ds=(DataSource) envCtx.lookup("jdbc/inspnew");
 	conn=ds.getConnection();  */
