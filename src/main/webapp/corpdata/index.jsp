...
<table border="1" align="center" width="50%">
  <tr>
    <th ><div align="center" class="mtextarea">CORP BANK FILE UPLOAD &amp; UPDATE </div></th>
  </tr>
  <tr>
  ...
  <tr>
    <th > <br>
        <div>
          <div align="center">
            <input type="text" placeholder="Enter Mob No." required="Enter Mob No." name="USERNAME" height="30%" autocomplete="off" maxlength="12" id="USERNAME" />
          </div>
        </div>
      <br />
 <div>
