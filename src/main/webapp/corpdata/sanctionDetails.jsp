...
qrysb.append("     AD.AADHAR_NO,MD.STATE_CD,"      );
qrysb.append("     AD.TEL_NO AS MOB_NO1,ad.UNIT_DIST_CD,MOM.AGENCY_TYPE  || '('  || MOM.OFF_NAME1 ||')' AS AGENCY,"      );
qrysb.append("     MS.STATE_NM,"      );
qrysb.append("     MS.STATE_CD,"      );
qrysb.append("     MOM.AGENCY_TYPE,AD.BR_CODE AS IFSC_CODE,AD.PROD_DESC,ad.EMP_ENV,AD.OFF_CD,"      );
qrysb.append("     AD.UNIT_LOC,"      );
qrysb.append("     AD.UNIT_POST_ADDR "      );
qrysb.append("     || ''"      );
qrysb.append("     || AD.UNIT_TALUK_BLOCK AS UNIT_ADDR, AD.UNIT_TALUK_BLOCK ,"      );
qrysb.append("     AD.UNIT_PIN,"      );
qrysb.append("     MD.DISTRICT_NAME,"      );
qrysb.append("     AM.ACTIVITY_NAME,"      );
qrysb.append("     AD.BANK_NAME,AD.BANK_POST_ADDR,AD.BANK_DISTRICT,"      );
qrysb.append("     AD.BRANCH_NAME,"      );
qrysb.append("     NVL(AD.MACHINARY_COST, 0)  AS MACHINARY_COST,"      );
qrysb.append("     NVL(AD.WORKING_CAPITAL, 0) AS WORKING_CAPITAL,  AD.IND_TYPE,  AD.IND_ACTIVITY,   "      );
...
qrysb.append("   AND AD.APP_ID='"+APP_ID+"' AND MD.STATE_CD='"+STATE_CD+"' "      );
...
while (rsApp.next()) {
	...
	//MM_REL_DT=rsApp.getString("MM_REL_DT")==null?"0":rsApp.getString("MM_REL_DT");
