...
<UL id="js-news" class="js-hidden">
		...
		<li class="news-item"> EDP exempted upto 30 jun 2020, Upload the Margin Money Claim without EDP Now. 
		
		<a href="EDPExemption30062020.pdf" style="color: white;"> Click here -> to Download Circular </a>
		 </li>
	...
	<A href="#" onClick="document.getElementById('id01').style.display='block'"><IMG src="02.gif" width="35%" border="0"></A> 
