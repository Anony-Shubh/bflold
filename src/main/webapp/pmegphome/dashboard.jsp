...
<IMG src="images/04.jpg" width="100%">
  ...
  <DIV class="header-nightsky">
    <nav class="navbar navbar-default">
            <DIV class="container">
                <A class="navbar-brand" href="#"><SPAN style="color: #990000;font-size: 20px"><B>PMEGP Portal</B></SPAN><SPAN style="color: #000">  Dashboard for 1st Loan </SPAN></A>
  ...
  <I class="fa fa-home"></I>
                        ...
                        <LI>
                         ...
                         <A href="../pmegpmr3/index.jsp"> <DIV class="button_home">
  MIS-Report
  <DIV></DIV>
...
Online EDP Training
  ...
  <LI>  <A href="../../pmegp/pmegpmr/pmegpOldRepo.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> PMEGP old performance</A></LI>
   <LI> <A href="../dashboard/daywisedwdb_claim_repo.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Daywise MM Disbursement </A></LI>
    ...
    <LI> <A href="../dashboard/pmegp_failcases_bank.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Bank Rejection Officewise</A></LI>                          
         <LI> <A href="../dashboard/bankwise_pmegp_failcases_bank.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Bank Rejection Bankwise</A></LI>                          
           <LI> <A href="../dashboard/PerformanceRepo1718.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Annual Progress Report (2017-18)</A></LI>  
			...
			<LI> <A href="../dashboard/PerformanceRepo2223.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Annual Progress Report (2022-23)</A></LI>
			<LI> <A href="../dashboard/PerformanceRepo2324.jsp" class="glyphicon glyphicon-hourglass" style="font-size: 18px"> Annual Progress Report (2023-24)</A></LI>
...
String FNAME_202324="";
String APP_REC_202324="";
String DTFC_PLACE_202324="";
String BANK_FORD_202324="";
String BANK_SANC_202324="";
String MMCLAIMED_202324="";
String MMRELEASE_202324="";




String FNAME_202425="";
String APP_REC_202425="";
String DTFC_PLACE_202425="";
String BANK_FORD_202425="";
String BANK_SANC_202425="";
String MMCLAIMED_202425="";
String MMRELEASE_202425="";



String FNAME_202526="";
String APP_REC_202526="";
String DTFC_PLACE_202526="";
String BANK_FORD_202526="";
String BANK_SANC_202526="";
String MMCLAIMED_202526="";
String MMRELEASE_202526="";
...
if (FNAME.equals("2023-24")) {

FNAME_202324=rsMain.getString("FNAME")==null?"":rsMain.getString("FNAME");
APP_REC_202324=rsMain.getString("APP_REC")==null?"":rsMain.getString("APP_REC");
DTFC_PLACE_202324=rsMain.getString("DTFC_PLACE")==null?"":rsMain.getString("DTFC_PLACE");
BANK_FORD_202324=rsMain.getString("BANK_FORD")==null?"":rsMain.getString("BANK_FORD");
BANK_SANC_202324=rsMain.getString("BANK_SANC")==null?"":rsMain.getString("BANK_SANC");
MMCLAIMED_202324=rsMain.getString("MMCLAIMED")==null?"":rsMain.getString("MMCLAIMED");
MMRELEASE_202324=rsMain.getString("MMRELEASE")==null?"":rsMain.getString("MMRELEASE");

}

if (FNAME.equals("2024-25")) {

FNAME_202425=rsMain.getString("FNAME")==null?"":rsMain.getString("FNAME");
APP_REC_202425=rsMain.getString("APP_REC")==null?"":rsMain.getString("APP_REC");
DTFC_PLACE_202425=rsMain.getString("DTFC_PLACE")==null?"":rsMain.getString("DTFC_PLACE");
BANK_FORD_202425=rsMain.getString("BANK_FORD")==null?"":rsMain.getString("BANK_FORD");
BANK_SANC_202425=rsMain.getString("BANK_SANC")==null?"":rsMain.getString("BANK_SANC");
MMCLAIMED_202425=rsMain.getString("MMCLAIMED")==null?"":rsMain.getString("MMCLAIMED");
MMRELEASE_202425=rsMain.getString("MMRELEASE")==null?"":rsMain.getString("MMRELEASE");

}


if (FNAME.equals("2025-26")) {

FNAME_202526=rsMain.getString("FNAME")==null?"":rsMain.getString("FNAME");
APP_REC_202526=rsMain.getString("APP_REC")==null?"":rsMain.getString("APP_REC");
DTFC_PLACE_202526=rsMain.getString("DTFC_PLACE")==null?"":rsMain.getString("DTFC_PLACE");
BANK_FORD_202526=rsMain.getString("BANK_FORD")==null?"":rsMain.getString("BANK_FORD");
BANK_SANC_202526=rsMain.getString("BANK_SANC")==null?"":rsMain.getString("BANK_SANC");
MMCLAIMED_202526=rsMain.getString("MMCLAIMED")==null?"":rsMain.getString("MMCLAIMED");
MMRELEASE_202526=rsMain.getString("MMRELEASE")==null?"":rsMain.getString("MMRELEASE");
...
<TABLE width="90%" border="0" align="center">
  ...
  <TR>
   ...
   <TR>
    ...
    <TR>
      <TD class="table_row">2023-24</TD>
    
    <TD class="table_row"><%=APP_REC_202324%></TD>
    <TD><A href="../dashboard/statewisedwdb.jsp?YR=2023-24" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>

<TR>
      <TD class="table_row">2024-25</TD>
    
    <TD class="table_row"><%=APP_REC_202425%></TD>
    <TD><A href="../dashboard/statewisedwdb.jsp?YR=2024-25" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
  
  <TD class="table_row">2025-26</TD>
    
    <TD class="table_row"><%= APP_REC_202526 %></TD>
    <TD><A href="../dashboard/statewisedwdb.jsp?YR=2025-26" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
...
<SCRIPT language="javascript">
      ...
      function drawChart() {
        ...
        var options = {
          ...
          title: 'Social Category wise No of Application received from July 2016',
          is3D: true,
        };
  ...
  <TR>
   ...
   <TR>
    ...
    <TD class="table_row"><%=BANK_FORD_202324%></TD>
    <TD><A href="../dashboard/statewisedwdb_fwdbank.jsp?YR=2023-24" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>

 <TR>
      <TD class="table_row">2024-25</TD>
    
    <TD class="table_row"><%=BANK_FORD_202425%></TD>
    <TD><A href="../dashboard/statewisedwdb_fwdbank.jsp?YR=2024-25" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
  
  <TD class="table_row">2025-26</TD>
    
    <TD class="table_row"><%=BANK_FORD_202526%></TD>
    <TD><A href="../dashboard/statewisedwdb_fwdbank.jsp?YR=2025-26" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
...
<TR>
 ...
 <TR>
   ...
   <TR>
    ...
    <TD class="table_row"><%=BANK_SANC_202324%></TD>
    <TD><A href="../dashboard/statewisedwdb_sanction.jsp?YR=2023-24" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
  
     <TR>
      <TD class="table_row">2024-25</TD>
    
    <TD class="table_row"><%=BANK_SANC_202425%></TD>
    <TD><A href="../dashboard/statewisedwdb_sanction.jsp?YR=2024-25" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
  
   <TR>
      <TD class="table_row">2025-26</TD>
    
    <TD class="table_row"><%=BANK_SANC_202526%></TD>
    <TD><A href="../dashboard/statewisedwdb_sanction.jsp?YR=2025-26" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
 ...
 <TR>
  ...
  <TR>
    ...
    <TD class="table_row"><%=MMCLAIMED_202324%></TD>
    <TD><A href="../dashboard/statewisedwdb_claim.jsp?YR=2023-24" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>

 <TR>
      <TD class="table_row">2024-25</TD>
    
    <TD class="table_row"><%=MMCLAIMED_202425%></TD>
    <TD><A href="../dashboard/statewisedwdb_claim.jsp?YR=2024-25" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
  
  <TR>
      <TD class="table_row">2025-26</TD>
    
    <TD class="table_row"><%=MMCLAIMED_202526%></TD>
    <TD><A href="../dashboard/statewisedwdb_claim.jsp?YR=2025-26" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
  </TR>
...
<TR>
  ...
  <TR>
    ...
    <TD class="table_row"><%=MMRELEASE_202324%></TD>
    <TD><A href="../dashboard/statewisedwdb_release.jsp?YR=2023-24" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
 </TR>

 <TR>
      <TD class="table_row">2024-25</TD>
    
    <TD class="table_row"><%=MMRELEASE_202425%></TD>
    <TD><A href="../dashboard/statewisedwdb_release.jsp?YR=2024-25" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
 </TR>
 
 <TR>
      <TD class="table_row">2025-26</TD>
    
    <TD class="table_row"><%=MMRELEASE_202526%></TD>
    <TD><A href="../dashboard/statewisedwdb_release.jsp?YR=2025-26" class="glyphicon glyphicon-expand" style="color: #FFFFFF"></A></TD>
 </TR>
