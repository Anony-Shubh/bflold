    ...
    <DIV class="container-fluid">
      ...
      <DIV class="ticker-news">
        ...
        <MARQUEE width="100%" direction="left" vspace="8px">
         PMEGP modified Guidelines implemented from 01-June-2022 <a href="../dashboard/notification/PMEGP_Guidelines_Certified_2022_3.pdf" class="myButtonYellow">Click here to download </a>
        </MARQUEE>
      </DIV>
    </DIV>
  </header>
 ...
 <BR>
  <P align="center"><A href="../pmegphome/EDP_CIRCULAR_15.11.2019.pdf" style="color:#FFFFFF " class="myButton3" target="_blank">DOWNLOAD ONLINE EDP TRAINING CIRCULAR</A></P>
	 ...
	 <P align="center"><A href="https://www.udyami.org.in" style="color:#FFFFFF " class="myButton3" target="_blank">CLICK HERE FOR ONLINE EDP TRAINING </A></P>
  	...
  	<DIV class="hover01">
    <figure><A href="../../pmegpeportal/pmegpaward" >	<IMG src="../../img/nomination_award.jpeg" alt="Avatar" style="width:200px; border-radius: 50%;" ></A></figure>
                          ...
                          <A href="../pmegpaward/">
                            <BUTTON type="button" class="buttonaward" style="background-color:#020266;">Click here for NOMINATION FORM</BUTTON>
                          </A>
  	...
  	<DIV class="hover01">
    <figure><A href="../../pmegpeportal/pmegpcftri" >	<IMG src="../images/cftriapply.png" alt="Avatar" style="width:250px; border-radius: 50%;" ></A></figure>
                          ...
                          <A href="../pmegpcftri/">
                            <BUTTON type="button" class="buttonaward" style="background-color:#020266;">Click here for CFTRI Training</BUTTON>
                          </A>
						...
						<DIV class="col-md-4 col-4">
						<div class="main-div">
        <IMG src="../images/smallbanner.jpg" alt="" style="width: 100%; height: 100%">
        <div class="sub-div">
          <a
            href="https://pledge.mygov.in/khadi-for-nation-khadi-for-fashion/"
            style="margin-left: 8px"
            >Take e-Pledge</a
          >
          <a
            href="https://quiz.mygov.in/quiz/khadi-mahotsav-quiz-contest/"
