            ...
            <DIV class="collapse navbar-collapse" id="navbarSupportedContent">
              <DIV class="container-fluid">
                <UL class="menu-nav">
                  ...
                  <LI class="menu-item">
                    <A href="https://kviconlineapp.in/mdashboard/"><I class="fa fa-fw fa-user"></I> MSME DASHBOARD</A>
                  </LI>
                  <LI class="menu-item">
                  ...
                  <LI class="menu-item1">
                    <A href="../dynamicdistrict/officeSearchForm.jsp" target="_blank"><I class="fa fa-fw fa-user"></I>Contact List</A>
                  </LI>
                  <LI class="menu-item1">
            ...
            <DIV class="col-md-12 col-12">
			 ...
			 <!-- <DIV class="new-loan">
				...
				<DIV class="card-body">
                          ...
                          <A href="../pmegpaward/">
                            <BUTTON type="button" class="btn" style="background-color:#566355;">NOMINATION FORM FOR PMEGP NATIONAL AWARD</BUTTON>
                          </A>
