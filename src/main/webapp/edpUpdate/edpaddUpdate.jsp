    ...
    <td ><select name="OFF_TYPE_CD"  id="OFF_TYPE_CD">
      ...
      <% 
	   String vOFF_TYPE_CD = "";
          ...
          ResultSet rsUp= db.execSQL("SELECT OFF_TYPE_CD ,OFF_TYPE_LONG_DESC FROM MAS_OFF_TYPE_CDMAST WHERE OFF_TYPE_CD IN (26,17,18,19)");
    ...
    <td><select name="DISTRICT_CD"  id="DISTRICT_CD">
      ...
      <% 
	   String vDISTRICT_CD = "";
          ...
          ResultSet rs= db.execSQL("SELECT DISTRICT_CD,DISTRICT_NAME FROM M_DISTRICT WHERE STATE_CD=(SELECT STATE_CD FROM M_DISTRICT WHERE DISTRICT_CD="+DISTRICT_CD+") ");
