...
<tr>
  ...
  <td  class="style1"> Field Office Payment Details*</td>
      <td  class="style1"><input name="PAYDETAILS" type="text" id="PAYDETAILS" value="<%= PAYDETAILS %>" maxlength="100">
    ...
    <tr>
      ...
      <td  class="style1">
<input  name="fopay_dt" type="text"  id="fopay_dt" onClick="javascript:NewCssCal('fopay_dt','ddMMMyyyy')" value="<%= fopay_dt %>" maxlength="10" readonly="true" /> </td>
    </tr>
    <tr>
      <td class="style1"><div align="center">(3)</div></td>
      <td class="style1"> Amount*</td>
      <td class="style1">
      <input name="fopay_amt" type="text" id="fopay_amt" value="<%=fopay_amt %>" size="10" maxlength="10">
      </th>		     </td>
    </tr>
    <tr>
      <td class="style1"><div align="center">(4)</div></td>
      <td class="style1">Any Remarks</td>
      <td class="style1"><input name="ANY_REMARKS" type="text" id="ANY_REMARKS" value="<%=ANY_REMARKS %>" maxlength="100">  </td>
    </tr>
    <tr>
      <td class="style1"><div align="center">(5)</div></td>
      <td class="style1"> Field Office disallowed Amt.*</td>
      <td class="style1"><input  name="fo_disallowment"  type="text" id="fo_disallowment" value="<%= fo_disallowment %>" size="10" maxlength="10" required /></td>
    </tr>
    <tr>
      <td class="style1"><div align="center">(6)</div></td>
      <td class="style1"> TDS/Other Amount*</td>
      <td class="style1"><input  name="tds_amt"  type="text"  id="tds_amt" value="<%= tds_amt %>" maxlength="10"required />    </td>
    </tr>
    <tr>
