...
<tr>
  ...
  <td><input name="BNF_EVENT" autocomplete="off" type="text" id="BNF_EVENT" value="<%= BNF_EVENT%>" ></td>
</tr>
<tr>
  <td >Name of the staff : </td>
  <td><input name="BNF_ASTFFNME" type="text" id="BNF_ASTFFNME" value="<%= BNF_ASTFFNME %>" autocomplete="off" />    </td>
...
<tr>
  ...
  <td><input name="BNF_ASTFFDSGNTN" type="text" autocomplete="off" id="BNF_ASTFFDSGNTN" value="<%= BNF_ASTFFDSGNTN %>" /></td>
</tr>
<tr>
  <td> Contact no. : </td> <input name="ins" type="hidden" id="ins">
  <td><input name="BNF_ASTFFCNTCT" autocomplete="off" type="text" id="BNF_ASTFFCNTCT" value="<%= BNF_ASTFFCNTCT %>" ></td>
</tr>
<tr>
...
<tr>
  ...
  <td><input name="BNF_APROGDTLS" autocomplete="off" type="textarea" id="BNF_APROGDTLS" value="<%= BNF_APROGDTLS %>" ></td>
</tr>
<tr>
  <td>Tour sanctioned for No. of days : </td>
  <td><input name="BNF_ATOURDYS" autocomplete="off" type="text" id="BNF_ATOURDYS" value="<%= BNF_ATOURDYS %>"  ></td>
  </tr>
<tr>
...
<tr>
  ...
  <td><input name="BNF_ORG_DAY" type="text" id="BNF_ORG_DAY" autocomplete="off"  value="<%= BNF_ORG_DAY%>" ></td>
  </tr>
<tr>
  <td>Organizer Co. Incharge Name: </td>
  <td><input name="BNF_ACLBNAME" autocomplete="off" type="text" id="BNF_ACLBNAME" value="<%= BNF_ACLBNAME %>" >    </td>
  </tr>
<tr>
  <td>Organizer Contact No</td>
  <td><input name="BNF_ORG_CONTNO" autocomplete="off" type="text" id="BNF_ORG_CONTNO" value="<%= BNF_ORG_CONTNO%>" ></td>
</tr>
<tr>
  <td>Expenditure incurred on TA (Amount in Rs only): </td>
  <td><input name="BNF_ATA" autocomplete="off" type="text" id="BNF_ATA" value="<%= BNF_ATA %>" onchange="tot();" ></td>
</tr>
<tr>
  <td>Expenditure incurred on DA (Amount in Rs only): </td>
  <td><input name="BNF_ADA" type="text" id="BNF_ADA" value="<%= BNF_ADA %>" autocomplete="off" onchange="tot();" >
  </td>
</tr>
<tr>
...
<tr>
  <td>Remark : </td>
  <td><input name="REMARK_ADD" type="textarea" id="REMARK_ADD" autocomplete="off" value="<%= REMARK_ADD %>" ></td>
</tr>
