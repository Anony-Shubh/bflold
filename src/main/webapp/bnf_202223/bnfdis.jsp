...
<TABLE>
<TR>
  <TD colspan="4"><DIV align="center">Data Entry Form <%= sselect %> </DIV></TD>
  </TR>

 
<TR>
  <TD width="53%" > Date/Period of Organization From </TD>
  <TD width="14%"><INPUT name="BNF_AFROMDT" type="text" id="BNF_AFROMDT"  onClick="javascript:NewCssCal('BNF_AFROMDT','ddMMMyyyy')" value="<%= BNF_AFROMDT %>" maxlength="10" readonly="true"  autocomplete="off" PLACEHOLDER="From date"></TD>
  <TD width="6%">To</TD>
  <TD width="27%"><INPUT name="BNF_ATODT" type="text" id="BNF_ATODT" onChange="days();" onClick="javascript:NewCssCal('BNF_ATODT','ddMMMyyyy')" value="<%= BNF_ATODT %>" maxlength="10" readonly="true"  autocomplete="off" PLACEHOLDER="To date"></TD>
</TR>
<TR>
...
<TR>
  ...
  <TD><INPUT name="BNF_ASTFFCNTCT" type="text" id="BNF_ASTFFCNTCT" onKeyPress="return isNumberNoDec(event)" value="<%= BNF_ASTFFCNTCT %>" maxlength="10" AUTOCOMPLETE="off" PLACEHOLDER="Contact No"></TD>
</TR>
<TR>
  <TD >No. of participants For : </TD>
  <TD colspan="3"><input name="BNF_NOOFPARTCPNTS" type="text" id="BNF_NOOFPARTCPNTS" onKeyPress="return isNumberNoDec(event)" value="<%= BNF_NOOFPARTCPNTS %>" maxlength="5" autocomplete="off" placeholder="No. of participants"></TD>
</TR>
...
<TR>
  ...
  <TD colspan="3"><INPUT name="BNF_ACLBNAME" type="text" id="BNF_ACLBNAME" value="<%= BNF_ACLBNAME %>" size="50" maxlength="50" AUTOCOMPLETE="off" PLACEHOLDER="Celebrity name">
  <INPUT name="YEAR_ID" type="hidden" id="YEAR_ID" value="<%= sselect %>" ></TD>
</TR>
<TR>
...
<TR>
  ...
  <TD colspan="3"><input name="BNF_ATA" type="text" id="BNF_ATA" onKeyPress="javascript:return isNumber(event)" onKeyUp="word.innerHTML=convertNumberToWords(this.value)" value="<%= BNF_ATA %>" maxlength="10" autocomplete="off" placeholder="Expenditure" ></TD>
</TR>
<TR>
  <TD></TD>
  <TD colspan="3"><DIV id="word"></DIV></TD>
</TR>
