    ...
    <tbody>
      ...
      <tr>
        ...
        <td><div align="center"><a href="jasperReports/bnfreportbudget.jsp?REP_NM=bnfconsolidatetarget&BGTID=14&YEAR_ID=<%= sselect %>" target="_blank" class="myButton">View</a></div></td>
	        ...
	        <tr>
        <td height="40"><div align="center">15</div></td>
        <td><div align="center">Samadhan EDP Payment</div></td>
        <td><div align="center"> <a href="jasperReports/generepexcel.jsp?REPNM=MONTHWISE_SAM" class="myButton">Download</a></div></td>
      </tr>
