...
sb.append(" select * from(select m.*,q.DOC_NAME, CASE WHEN NVL(PRJ_COST,0) BETWEEN 200001 AND 500000 AND TRUNC(m.edp_dt_cal) > '31-MAY-2022' THEN 5 ");
 sb.append("  WHEN  NVL(PRJ_COST,0) > 500000 AND TRUNC(m.edp_dt_cal) > '31-MAY-2022' THEN 10 WHEN  NVL(PRJ_COST,0)=0 THEN 0 ELSE 10 ");
      
 sb.append(" END AS edptobedays  from (SELECT mom.agency_type, ms.state_nm     AS state, mom.off_name2   AS off_name1,md.district_name,ad.app_id,ad.app_name,"      );
...
<br>
<div align="center" class="mbgcolour">
