...
String BUD_ID=request.getParameter("BUD_ID")==null?"0":(String)request.getParameter("BUD_ID");	
...
<TABLE>
<TR>
  <TD colspan="2"><DIV align="center">DATA ENTRY FORM 2019-20 </DIV></TD>
  </TR>
<TR>
...
<INPUT name="BUD_ID" type="hidden" id="BUD_ID" value="12" />
