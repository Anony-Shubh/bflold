...
var CALLBACK_AMOUNT= document.form.CALLBACK_AMOUNT.value;
var CALLBACK_REASON= document.form.CALLBACK_REASON.value;

var MARGIN_MONEY_ADJUSTMENT_AMOUNT= document.form.MARGIN_MONEY_ADJUSTMENT_AMOUNT.value;
var MARGIN_MONEY_ADJUSTMENT_DATE= document.form.MARGIN_MONEY_ADJUSTMENT_DATE.value;
...
/*
if(DATE_OF_WATER_CONNECTION==""){
 swal ( 'Note:','Please enter date of water connection','error');	
 return (false);
}
if(DATE_OF_ELECTRIC_CONNECTION==""){
 swal ( 'Note:','Please enter date of Electric connection','error');	
 return (false);
}

if(OTHER_CLEARANCE==""){
 swal ( 'Note:','Please enter any other clearance','error');	
 return (false);
}

if(GST_REGISTRATION_NUMBER==""){
 swal ( 'Note:','Please enter GST Registration Number','error');	
 return (false);
}
if(GST_REGISTRATION_DATE==""){
 swal ( 'Note:','Please enter GST Registration date','error');	
 return (false);
}
if(UDYAM_REGISTRATION_NUMBER==""){
 swal ( 'Note:','Please enter udyam registration number','error');	
 return (false);
}if(UDYAM_REGISTRATION_DATE==""){
 swal ( 'Note:','Please enter udyam registration date','error');	
 return (false);
}
if(PAN_OR_TAN_NUMBER==""){
 swal ( 'Note:','Please enter pan or tan number','error');	
 return (false);
}
if(KVIC_REGISTRATION_NUMBER==""){
 swal ( 'Note:','Please enter KVIC Registration number','error');	
 return (false);
}
if(KVIC_REGISTRATION_DATE==""){
 swal ( 'Note:','Please enter KVIC Registration date','error');	
 return (false);
}
if(REGISTERED_BRAND_NAME==""){
 swal ( 'Note:','Please enter KVIC Registered brand name','error');	
 return (false);
}
if(PATENT_OWNERSHIP==""){
 swal ( 'Note:','Please enter KVIC Patent ownership','error');	
 return (false);
}
if(HANDHOLDING_DETAILS==""){
 swal ( 'Note:','Please enter handholding deatils','error');	
 return (false);
}*/
...
/*
if(MACHINERY_TYPE==""){
 swal ( 'Note:','Please enter Machinery type','error');	
 return (false);
}
if(RAW_MATERIAL_DETAILS==""){
 swal ( 'Note:','Please enter Details of Raw material','error');	
 return (false);
}
if(RAW_MATERIAL_IMPORT==""){
 swal ( 'Note:','Please enter Import of Raw material','error');	
 return (false);
}

if(COUNTRY_OF_IMPORT==""){
 swal ( 'Note:','Please enter COUNTRY_OF_IMPORT','error');	
 return (false);
}

if(RAW_MATERIAL_STOCK_VALUE==""){
 swal ( 'Note:','Please enter RAW_MATERIAL_STOCK_VALUE','error');	
 return (false);
}
if(SEMI_FIN_RM_STOCK==""){
 swal ( 'Note:','Please enter SEMI FINISHED_RAW_MATERIAL_STOCK','error');	
 return (false);
}
if(FINISHED_RAW_MATERIAL_STOCK==""){
 swal ( 'Note:','Please enter FINISHED_RAW_MATERIAL_STOCK','error');	
 return (false);
}
if(CAPITAL_COST_OF_BUILDING==""){
 swal ( 'Note:','Please enter CAPITAL_COST_OF_BUILDING','error');	
 return (false);
}
if(CAPITAL_COST_OF_MACHINERY==""){
 swal ( 'Note:','Please enter CAPITAL_COST_OF_MACHINERY','error');	
 return (false);
}*/
...
/*
if(BY_PRODUCT==""){
 swal ( 'Note:','Please enter BY_PRODUCT','error');	
 return (false);
}
if(EXPORT_QUANTITY==""){
 swal ( 'Note:','Please enter EXPORT_QUANTITY','error');	
 return (false);
}
if(EXPORT_QUANTITY==""){
 swal ( 'Note:','Please enter EXPORT_QUANTITY','error');	
...
if(EXPORT_VALUE==""){
 swal ( 'Note:','Please enter EXPORT_VALUE','error');	
 return (false);
}

if(COUNTRY_OF_EXPORT==""){
 swal ( 'Note:','Please enter COUNTRY_OF_EXPORT','error');	
 return (false);
}
if(MODE_OF_EXPORT==""){
 swal ( 'Note:','Please enter MODE_OF_EXPORT','error');	
 return (false);
}

if(SKILLED_EMPLOYEES==""){
 swal ( 'Note:','Please enter SKILLED_EMPLOYEES','error');	
 return (false);
}
if(SEMI_SKILLED_EMPLOYEES==""){
 swal ( 'Note:','Please enter SEMI_SKILLED_EMPLOYEES','error');	
 return (false);
}
if(UNSKILLED_EMPLOYEES==""){
 swal ( 'Note:','Please enter UNSKILLED_EMPLOYEES','error');	
 return (false);
}
if(FULLTIME_EMPLOYEES==""){
 swal ( 'Note:','Please enter FULLTIME_EMPLOYEES','error');	
 return (false);
}
if(PART_TIME_EMPLOYEES==""){
 swal ( 'Note:','Please enter PART_TIME_EMPLOYEES','error');	
 return (false);
}
if(SEASONAL_EMPLOYEES==""){
swal ( 'Note:','Please enter SEASONAL_EMPLOYEES','error');
 return (false);
}*/
...
/*
if(GENERAL==""){
 swal ( 'Note:','Please enter GENERAL','error');	
 return (false);
}
if(SC==""){
 swal ( 'Note:','Please enter SC','error');	
 return (false);
}
if(ST==""){
 swal ( 'Note:','Please enter ST','error');	
 return (false);
}
if(OBC==""){
 swal ( 'Note:','Please enter OBC','error');	
 return (false);
}
if(MINORITY==""){
 swal ( 'Note:','Please enter MINORITY','error');	
 return (false);
}*/
...
/*
if(MALE_EMPLOYEES==""){
 swal ( 'Note:','Please enter MALE_EMPLOYEES','error');	
 return (false);
}
if(FEMALE_EMPLOYEES==""){
 swal ( 'Note:','Please enter FEMALE_EMPLOYEES','error');	
 return (false);
}
if(TRANSGENDER_EMPLOYEES==""){
 swal ( 'Note:','Please enter TRANSGENDER_EMPLOYEES','error');
 return (false);
}*/
...
if(PHYSICALLY_CHALLENGED_EMPLOYEE==""){
 swal ( 'Note:','Please enter PHYSICALLY_CHALLENGED_EMPLOYEE','error');	
 return (false);
}
...
/*
if(PENDING_LOAN_AMOUNT==""){
 swal ( 'Note:','Please enter PENDING_LOAN_AMOUNT','error');	
 return (false);
}*/
if(ROI_LOAN==""){
...
/*
if(IS_MARGIN_MONEY_ELIGIBLE_FOR_A==""){
 swal ( 'Note:','Please enter IS_MARGIN_MONEY_ELIGIBLE_FOR_A','error');	
 return (false);
}

if(IS_INTEREST_CHARGED==""){
 swal ( 'Note:','Please enter IS_INTEREST_CHARGED','error');
 return (false);
}
if(IS_COLLATERAL_SECURITY==""){
 swal ( 'Note:','Please enter IS_COLLATERAL_SECURITY','error');	
 return (false);
}

if(VALUE_OF_COLLATERAL_SECURITY==""){
 swal ( 'Note:','Please enter VALUE_OF_COLLATERAL_SECURITY','error');	
 return (false);
}
if(IS_REPAYMENT_REGULAR==""){
 swal ( 'Note:','Please enter IS_REPAYMENT_REGULAR','error');	
 return (false);
}
if(NPA_PERIOD==""){
 swal ( 'Note:','Please enter NPA_PERIOD','error');	
 return (false);
}

if(OUTSTANDING_LOAN_AMOUNT==""){
 swal ( 'Note:','Please enter OUTSTANDING_LOAN_AMOUNT','error');	
 return (false);
}

if(CALLBACK_AMOUNT==""){
 swal ( 'Note:','Please enter CALLBACK_AMOUNT','error');	
 return (false);
}
if(CALLBACK_REASON==""){
 swal ( 'Note:','Please enter CALLBACK_REASON','error');	
 return (false);
}

if(MARGIN_MONEY_ADJUSTMENT_AMOUNT == ""){
 swal ( 'Note:','Please enter MARGIN_MONEY_ADJUSTMENT_AMOUNT','error');
 return (false);
}

if(MARGIN_MONEY_ADJUSTMENT_DATE == ""){
 swal ( 'Note:','Please enter MARGIN_MONEY_ADJUSTMENT_DATE','error');
 return (false);
}
...
/* 
if(ANNUAL_SALES_VALUE !=""){
  if(!numberOnly.test(ANNUAL_SALES_VALUE)) {
 swal ( 'Note:','ANNUAL_SALES_VALUE should be in number','error');	
 return (false);
 }
}*/
if(EXPORT_VALUE !=""){
