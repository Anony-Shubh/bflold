...
String FromDt=request.getParameter("FROMDT")==null?"01-APR-2021":(String) request.getParameter("FROMDT");
String ToDt=request.getParameter("TODT")==null?"11-MAY-2021":(String) request.getParameter("TODT");
...
qrysb.append(" FROM ( ");
qrysb.append(" SELECT ZM.zone_nm as zone_nm , MS.STATE_NM as off_name1   ");
...
qrysb.append(" and ad.unit_dist_cd=dm.district_cd and dm.state_cd=ms.state_cd and ad.mtg_id=amm.mtg_id(+) and AD.BENF_CATAGORY_CD IN ('ST') ");

qrysb.append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by  ZM.zone_nm,MS.STATE_NM ORDER BY ZM.zone_nm,MS.STATE_NM  )A ");
...
<td><div align="center"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=10"%>">
    <% out.print(dfd.format(rsinst.getDouble("edp_cert_iss")));%>
</a></div></td>
<td><div align="right">
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=11"%>">
...
<td>
    <div align="right">
	<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=12"%>">
  ...
  <td>
  <div align="right"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a>
</td>
<td><div align="right"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=35"%>">
<% out.print(dfd.format(rsinst.getDouble("edp_cert_iss_pending")));%>
</a>
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=35"%>"></a></div></td>
<td><div align="right">
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=7"%>">
  <% out.print(dfd.format(rsinst.getDouble("bank_reject")));%>
</a></div></td>
<td><div align="right">
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=38"%>">
  <% out.print(dfd.format(rsinst.getDouble("pend_bank_sanc")));%>
</a></div></td>
<td><div align="right">
  <% out.print(dfd.format(rsinst.getDouble("pend_bank_sanc_mm")));%>
</div></td>
<td><div align="right"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=40"%>">
  <% out.print(dfd.format(rsinst.getDouble("REF_PEND_NO")));%>
</a>
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=16"%>"></a></div></td>
<td><div align="right"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=16"%>">
  <% out.print(dfd.format(rsinst.getDouble("Pend_mmrel")));%>
</a>
</div></td>
<td><% out.print(dfd.format(rsinst.getDouble("Pend_mmrel_amt")));%></td>
<th nowrap="nowrap"><a href="bankdw_pmegpSCST.jsp?<%=p3+vFurl%>">view</a></th>
<th nowrap="nowrap"><a href="bankdw_pmegpdistrictSCST.jsp?<%=p3+vFurl%>">view</a></th>
     </tr>
<%
}
rsinst.close();
