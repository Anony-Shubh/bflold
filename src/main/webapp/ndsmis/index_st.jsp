...
sb.append("   SELECT"      );
sb.append("     /*+ PARALLEL(AUTO) */"      );
sb.append("     NVL(STATE_NM,'ALL INDIA TOTAL') AS STATE_NM,MAX(STATE_CD) as STATE_CD ,"      );
...
sb.append("     SUM(MM_REL_AMT) MM_REL_AMT"      );
sb.append("   FROM"      );
sb.append("     (SELECT STATE_CD,"      );
sb.append("       STATE_NM,"      );
sb.append("       NO_OF_APP,"      );
sb.append("       RET_BY_AGENCY,"      );
sb.append("       BANK_FORD,"      );
sb.append("       PENDING_AGENCY,"      );
sb.append("       LOAN_SANC,"      );
sb.append("       CLAIM_BY_BANK_NO,"      );
sb.append("       CLAIM_BY_BANK_MM,"      );
sb.append("       FOR_DECISION,"      );
sb.append("       BANK_REJ,"      );
sb.append("       LOANDIS_MM,   "      );
sb.append("       LOANDIS_NO,"      );
sb.append("       MM_REL_NO,"      );
sb.append("       MM_REL_AMT"      );
sb.append("     FROM"      );
sb.append("       (SELECT (MS.STATE_CD) AS STATE_CD,"      );
sb.append("         MS.STATE_NM,"      );
sb.append("         SUM("      );
sb.append("         CASE"      );
sb.append("           WHEN TRUNC(AD.ONLINE_SUBDT) BETWEEN  '"+FROMDT+"' AND ( '"+TODT+"')"      );
sb.append("           THEN 1"      );
sb.append("         END) AS NO_OF_APP,"      );
sb.append("         SUM("      );
sb.append("         CASE"      );
sb.append("           WHEN AD.ACT_ID IN (3, 7)"      );
sb.append("           AND TRUNC(AD.ONLINE_SUBDT) BETWEEN  '"+FROMDT+"' AND ( '"+TODT+"')"      );
sb.append("           THEN 1"      );
sb.append("           ELSE 0"      );
sb.append("         END) RET_BY_AGENCY,"      );
sb.append("         SUM("      );
sb.append("         CASE"      );
...
sb.append("         SUM("      );
sb.append("         CASE"      );
sb.append("           WHEN AD.ACT_ID NOT IN (3, 7, 5)"      );
sb.append("           AND TRUNC(AD.ONLINE_SUBDT) BETWEEN  '"+FROMDT+"' AND ( '"+TODT+"')"      );
sb.append("           THEN 1"      );
sb.append("           ELSE 0"      );
sb.append("         END) PENDING_AGENCY,"      );
sb.append("         SUM("      );
sb.append("         CASE"      );
...
sb.append("         SUM("      );
sb.append("         CASE"      );
sb.append("           WHEN BD.IST_LOAN_DT BETWEEN  '"+FROMDT+"' AND  '"+TODT+"'"      );
sb.append("           THEN ROUND(BD.IST_LOAN_AMT / 10000000, 2)"      );
sb.append("           ELSE 0"      );
sb.append("         END) LOANDIS_MM,"      );
sb.append("         SUM("      );
sb.append("         CASE"      );
sb.append("           WHEN BD.IST_LOAN_DT BETWEEN  '"+FROMDT+"' AND  '"+TODT+"'"      );
sb.append("           THEN 1"      );
sb.append("           ELSE 0"      );
sb.append("         END) LOANDIS_NO,"      );
sb.append("         SUM("      );
sb.append("         CASE"      );
...
sb.append("         "      );
sb.append("           THEN ROUND(BD.MM_REL_AMT / 10000000, 2)"      );
...
sb.append("       GROUP BY (MS.STATE_NM, MS.STATE_CD)"      );
sb.append("       )"      );
sb.append("     UNION ALL"      );
sb.append("       (SELECT MS.STATE_CD,"      );
sb.append("         MS.STATE_NM,"      );
sb.append("         0,"      );
sb.append("         0,"      );
sb.append("         0,"      );
...
sb.append("           AND BD.MM_CLAIM_DT   IS NOT NULL"      );
sb.append("           THEN 1"      );
...
sb.append("       AND AD.UNIT_DIST_CD = MD.DISTRICT_CD"      );
sb.append("       AND MD.STATE_CD     = MS.STATE_CD     and AD.BENF_CATAGORY_CD IN ('ST')     "      );
sb.append("       GROUP BY MS.STATE_CD,"      );
sb.append("         MS.STATE_NM"      );
sb.append("       )"      );
sb.append("     )GROUP BY ROLLUP(STATE_NM)"      );
sb.append("     ORDER BY STATE_NM"      );
sb.append("      "      );
sb.append("      "      );
sb.append("      "      );
sb.append("      "      );
...
<%if(STATE_NM.equals("ALL INDIA TOTAL")){%>	
										 
<TD><%= STATE_NM %></TD>																				
<TD><DIV align="right"><%= NO_OF_APP %></DIV></TD>
<TD><DIV align="right"><%= RET_BY_AGENCY %> 
  <%//= RET_BY_AGENCYPERC %>
</DIV></TD>
<TD><DIV align="right"><%= PENDING_AGENCY %> 
  <%//= PENDINGPERC %>
</DIV></TD>
<TD><DIV align="right"><%= BANK_FORD %> 
  <%//= BANK_FORDPERC %>
</DIV></TD>
<TD><DIV align="right"><%= LOAN_SANC %></DIV></TD>
...
<TD><DIV align="right"><%= FOR_DECISION %></DIV></TD>

<TD><DIV align="right"><%= BANK_REJ %></DIV></TD>

										
<%}else{%>					
											
<TD><DIV><A href="index_ds.jsp?STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>"><%= STATE_NM %></A></DIV></TD>																				
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&REP_NM=detailed&REPTYPE=1&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>"><%= NO_OF_APP %></A></DIV></TD>
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=2&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= RET_BY_AGENCY %> 
  <%//= RET_BY_AGENCYPERC %>
</A></DIV></TD>
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed_pend&REPTYPE=4&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %> 
  <%//= PENDINGPERC %>
</A></DIV></TD>
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=3&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_FORD %> 
  <%//= BANK_FORDPERC %>
</A></DIV></TD>
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=5&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= LOAN_SANC %></A></DIV></TD>
<TD><DIV align="right"><%= LOANDIS_NO %></DIV></TD>
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=6&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_NO %> / <%= CLAIM_BY_BANK_MM %></A></DIV></TD>

<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=8&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_NO %> / <%= MM_REL_AMT %></A></DIV></TD>

<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=10&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= FOR_DECISION %></A></DIV></TD>

<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=11&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_REJ %></A></DIV></TD>	
