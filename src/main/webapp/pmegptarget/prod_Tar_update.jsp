...
DBCon db= new DBCon();
		...
		qrysb.append(" MOM.DISTRICT_CD=? AND OFF_NAME1=?  ");
...
<table align="center">
  ...
  <tr>
    <th>OFF_NAME:</th>
    <th colspan="2"><span class="style1"><%=OFF_NM%>
      <input name="OFF_NAME" type="hidden" id="OFF_NAME" value="<%= OFF_NM%>">
    </span></th>
    <th>DISTRICT_NAME</th>
    <th><span class="style1"><%=DIS_NM%></span>
  ...
  <br/>
  <tr><th scope="col">Office</th>
      <th scope="col">Agency</th>
      <th scope="col">OFF_CD</th>
      <th scope="col">No of Project </th>
      <th scope="col">Margin Money Target ( In Lakhs) </th>
  </tr>
  <% 
  for (int i=0;i<Listdis.size();i++) {
		 ...
		 %>
  <tr>
    <th height="82" nowrap><div align="center"><%=Listdis.get(i).get("OFF_NAME")%></div></th>
    <th nowrap><div align="center"><%=Listdis.get(i).get("AGENCY_TYPE")%>
            ...
            <input type="hidden" name="OFF_CD" id="OFF_CD" value="<%=Listdis.get(i).get("OFF_CD")%>">
    </div></th>
    <th nowrap><div align="center"><%=Listdis.get(i).get("OFF_CD")%></div></th>
    <th nowrap>
      <div align="right">
  ...
  <tr>
    ...
    <td><div align="right">
      <input name="TOT_PRJ" type="text" id="TOT_PRJ"  size="10" maxlength="6" readonly="readonly" >
    </div></td>
