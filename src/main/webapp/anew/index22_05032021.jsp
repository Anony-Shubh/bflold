...
<INPUT type="text" name="FROMDT1" id="FROMDT1" value="<%= FROMDT %>">  

<INPUT type="text" name="TODT1" id="TODT1" value="<%= TODT %>">  
                    ...
                    <DIV class="card shadow mb-4">
                        ...
                        <DIV class="card-body">
                            <DIV class="table-responsive">
							  <%if(TYPE.equals("D")){%>
							<DIV align="center"><H3><%= STATE_NM %></H3></DIV>
                            <%}%>
...
while (rs.next()) {
count=count+1;
NO_OF_APP=rs.getString("NO_OF_APP");
RET_BY_AGENCY=rs.getString("RET_BY_AGENCY");
BANK_FORD=rs.getString("BANK_FORD");
PENDING_AGENCY=rs.getString("PENDING_AGENCY");
LOAN_SANC=rs.getString("LOAN_SANC");
CLAIM_BY_BANK_NO=rs.getString("CLAIM_BY_BANK_NO");
CLAIM_BY_BANK_MM=rs.getString("CLAIM_BY_BANK_MM");
MM_REL_NO=rs.getString("MM_REL_NO");
MM_REL_AMT=rs.getString("MM_REL_AMT");
FOR_DECISION=rs.getString("FOR_DECISION");
BANK_REJ=rs.getString("BANK_REJ");
if(TYPE.equals("S")){
STATE_CD=rs.getString("STATE_CD");
STATE_NM=rs.getString("STATE_NM");
}
if(TYPE.equals("D")){
DISTRICT_CD=rs.getString("DISTRICT_CD");
...
%>									
                                        ...
                                        <TR>
                                          <TD><%= count %></TD>
										  <%if(TYPE.equals("A")){%>
										  <TH><A href="index22.jsp?TYPE=S">INDIA</A></TH>
										  <%}%>
										   <%if(TYPE.equals("S")){%>
										  <TD><A href="index22.jsp?TYPE=D&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>"><%= STATE_NM %></A></TD>
										  <%}%>
										   <%if(TYPE.equals("D")){%>
										  <TD><%= DISTRICT_NAME %></TD>
										  <%}%>
...
<%if(TYPE.equals("A")){%>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=1&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= NO_OF_APP %></A></TD>                                            
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=2&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= RET_BY_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=3&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_FORD %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=4&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=5&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= LOAN_SANC %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=6&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_NO %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=7&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_MM %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=8&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_NO %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=9&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_AMT %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=10&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= FOR_DECISION %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=A&REP_NM=detailed&REPTYPE=11&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_REJ %></A></TD>
<%}%>
											
											
<%if(TYPE.equals("S")){%>
<TD><A target="_blank" href="reports/dashboardrep.jsp?REP_NM=detailed&REPTYPE=1&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>"><%= NO_OF_APP %></A></TD>                        
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=2&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= RET_BY_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=3&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_FORD %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=4&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=5&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= LOAN_SANC %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=6&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_NO %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=7&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_MM %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=8&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_NO %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=9&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_AMT %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=10&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= FOR_DECISION %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=S&REP_NM=detailed&REPTYPE=11&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_REJ %></A></TD>
<%}%>
											
											
<%if(TYPE.equals("D")){%>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=1&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= NO_OF_APP %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=2&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= RET_BY_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=3&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_FORD %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=4&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=5&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= LOAN_SANC %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=6&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_NO %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=7&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_MM %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=8&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_NO %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=9&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_AMT %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=10&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= FOR_DECISION %></A></TD>
<TD><A target="_blank" href="reports/dashboardrep.jsp?TYPE=D&REP_NM=detailed&REPTYPE=11&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_REJ %></A></TD>
<%}%>
...
<TD><DIV align="center"><A class="btn btn-primary" href="bankwisedetail.jsp?TYPE=S&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>">View</A></DIV></TD>
										  <%}%>
										   <%if(TYPE.equals("D")){%>
<TD><DIV align="center"><A class="btn btn-primary" href="bankwisedetail.jsp?TYPE=D&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>">View</A></DIV></TD>
										  <%}%>
