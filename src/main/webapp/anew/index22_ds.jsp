...
sb.append("   SUM(CASE WHEN BD.IST_LOAN_DT BETWEEN '01-APR-2020' AND ('01-APR-2021') THEN ROUND(BD.IST_LOAN_AMT/10000000,2) ELSE 0 END) LOANDIS_MM,    "      );
...
<INPUT type="submit" value="Go" onClick="changetype()" >
                    ...
                    <DIV class="card shadow mb-4">
                        ...
                        <DIV class="card-body">
							...
							<DIV align="center"><H3><%= STATE_NM %>  Data from <%= FROMDT %> TO <%= TODT %></H3></DIV>
...
<TD><%= DISTRICT_NAME %></TD>
<TD><%= NO_OF_APP %></TD>
<TD><%= RET_BY_AGENCY %></A></TD>
<TD><%= PENDING_AGENCY %></A></TD>
<TD><%= BANK_FORD %></A></TD>
<TD><%= LOAN_SANC %></A></TD>
<TD><%= LOANDIS_NO %></TD>
<TD><%= CLAIM_BY_BANK_NO %></A></TD>
<TD><%= CLAIM_BY_BANK_MM %></A></TD>
<TD><%= MM_REL_NO %></A></TD>
<TD><%= MM_REL_AMT %></A></TD>
<TD><%= FOR_DECISION %></A></TD>
...
<TD><%= DISTRICT_NAME %></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=1&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= NO_OF_APP %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=2&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= RET_BY_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=4&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=3&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_FORD %></A></TD>

<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=5&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= LOAN_SANC %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=12&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= LOANDIS_NO %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=6&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_NO %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=7&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= CLAIM_BY_BANK_MM %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=8&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_NO %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=9&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= MM_REL_AMT %></A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=10&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= FOR_DECISION %></A></TD>
<TD hidden><%= BANKDEC_PER %>%</TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=D&REP_NM=detailed&REPTYPE=11&DISTRICT_CD=<%= DISTRICT_CD %>&DISTRICT_NAME=<%= DISTRICT_NAME %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_REJ %></A></TD>
