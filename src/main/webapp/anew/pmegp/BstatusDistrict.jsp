...
qrysb.append(" select NVL(MD.DISTRICT_NAME, 'TOTAL')  AS agency_type ,COUNT(*) AS TOT_APP, ");
...
ResultSet rsMain = db.execSQL(qrysb.toString());
 %>
<CENTER>
  <H3> Status of application with <%=ORG%> pending decision for the period from <%= rFromdt %> to <%= rTodt %> ( <%= YR %> )for <%=AGENCY%> (<%=AGN%> Agency)
<A href="../pmegp/index.jsp" class="button" >Back</A></H3>
</CENTER>
...
<TABLE align="center" cellpadding="2" cellspacing="10" id="customers">
 <THEAD>
    ...
    <TH bgcolor="#FCDCF4"><DIV align="center">No. of Application for more than one month</DIV></TH>
    <TH bgcolor="#FCDCF4"><DIV align="center">No. of Application 15 days to  one month</DIV></TH>
