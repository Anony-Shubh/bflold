...
<HEAD>
	...
	<SCRIPT language="javascript" src="https://cdn.datatables.net/1.10.21/js/dataTables.bootstrap4.min.js"></SCRIPT>
...
%>									
                                        ...
                                        <TR>
                                          <TH>
										   <BUTTON type="button" class="btn btn-primary modalButton" DATA-TOGGLE="modal" DATA-ID="2">Edit</BUTTON>	
										  <A href="index22_st.jsp">INDIA</A></TH>
										
										
										 
										 
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=A&REP_NM=detailed&REPTYPE=1&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= NO_OF_APP %></A></TD>                                            
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=A&REP_NM=detailed&REPTYPE=2&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= RET_BY_AGENCY %> (<%= RET_BY_AGENCYPERC %>%)</A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=A&REP_NM=detailed&REPTYPE=4&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %> (<%= PENDINGPERC %>%)</A></TD>
<TD><A target="_blank" href="reports/GenerateXLS.jsp?TYPE=A&REP_NM=detailed&REPTYPE=3&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= BANK_FORD %> (<%= BANK_FORDPERC %>%)</A></TD>
