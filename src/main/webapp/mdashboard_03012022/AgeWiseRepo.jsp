...
%>
  <TR>
    ...
    <TD><DIV align="center">4</DIV></TD>
     <TD><DIV align="left">Sanctioned By Bank ( from forwarding date to sanctioned Date) </DIV></TD>
    <TD><DIV align="right"><%= BANK_SANC %></DIV></TD>
   
 <TD><DIV align="right"><%= BANK_SANC_AVG %></DIV></TD>
  </TR>  <TR>
    <TD><DIV align="center">5</DIV></TD>
     <TD><DIV align="left">Own Contribution Deposited ( from sanctioned date to deposit date) </DIV></TD>
    <TD><DIV align="right"><%= OWN_CONT %></DIV></TD>
     <TD><DIV align="right"><%= OWN_CONT_AVG %></DIV></TD>
  </TR>  <TR>
    <TD><DIV align="center">6</DIV></TD>
     <TD> <DIV align="left">Loan Disbursement ( Own contribution deposit date to Loan Disbursement Date) </DIV></TD><TD><DIV align="right"><%= IST_LOANSANC %></DIV></TD>
    <TD><DIV align="right"><%= IST_LOANSANC_AVG %></DIV></TD>
  </TR>  <TR>
    <TD><DIV align="center">7</DIV></TD>
     <TD><DIV align="left">MM Claim ( Loan Disbursement Date to Claim Date) </DIV></TD>
