...
sb.append("    MAX(MS.STATE_CD) AS STATE_CD, nvl(MS.STATE_NM,'ALL INDIA TOTAL')STATE_NM,  "      );
...
sb.append("   GROUP BY ROLLUP(MS.STATE_NM)  ORDER BY MS.STATE_NM  ) "      );
...
<TD><DIV align="right"><A href="index22_ds.jsp?STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>"><%= STATE_NM %></A></DIV></TD>																				
...
<TD><DIV align="right"><A target="_blank" href="reports/GenerateXLS.jsp?AGENTYPE=<%= AGENTYPE %>&TYPE=S&REP_NM=detailed&REPTYPE=4&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>"><%= PENDING_AGENCY %> 
  <%//= PENDINGPERC %>
</A></DIV></TD>
...
<TD><A href="AppStatusRepo.jsp?STATE_CD=<%= STATE_CD %>&STATE_NM=<%=STATE_NM%>&DLEVEL=2" class="btn btn-primary">More</A></TD>	

<TD><A href="AgeWiseRepo.jsp?STATE_CD=<%= STATE_CD %>&STATE_NM=<%=STATE_NM%>&DLEVEL=2&FROMDT=<%= FROMDT %>&TODT=<%= TODT %>" class="btn btn-primary">More</A></TD>	


<TD><A href="rejectiondetail.jsp?STATE_CD=<%= STATE_CD %>&STATE_NM=<%=STATE_NM%>&DLEVEL=2" class="btn btn-primary">More</A></TD>	

									
<TD><A class="btn btn-primary" href="bankwisedetail.jsp?TYPE=S&STATE_CD=<%= STATE_CD %>&STATE_NM=<%= STATE_NM %>&DLEVEL=2">View</A></TD>	
