...
qrysb.append("    SUM("      );
qrysb.append("     CASE"      );
qrysb.append("       WHEN  TRUNC(ad.ONLINE_SUBDT) BETWEEN '"+FROMDT+"' AND '"+TODT+"' AND ad.ACT_ID=3"      );
qrysb.append("       THEN 1"      );
qrysb.append("       ELSE 0"      );
qrysb.append("     END) AS AGN_REJECT,"      );
qrysb.append("   SUM("      );
qrysb.append("     CASE"      );
qrysb.append("       WHEN  TRUNC(ad.ONLINE_SUBDT) BETWEEN '"+FROMDT+"' AND '"+TODT+"' AND ad.ACT_ID in(0,1,2,4)"      );
qrysb.append("       THEN 1"      );
qrysb.append("       ELSE 0"      );
...
qrysb.append("     SUM(NVL("      );
qrysb.append("     CASE"      );
qrysb.append("       WHEN bd.ACT_ID >= 11 AND TRUNC(ad.ONLINE_SUBDT) >= '"+FROMDT+"'"      );
qrysb.append("       AND TRUNC(bd.LOAN_SANC_DT) BETWEEN '"+FROMDT+"' AND '"+TODT+"'"      );
qrysb.append("       AND ad.ACT_ID = 5"      );
qrysb.append("       THEN 1"      );
...
qrysb.append("       CASE"      );
qrysb.append("         WHEN  apr_year='2020-21'"      );
qrysb.append("        "      );
qrysb.append("         THEN 1"      );
...
<CENTER>
  <H3 >Status of Application For The Period From <%=FROMDT%> to <%=TODT%></H3>
</CENTER>
...
%>
  ...
  <TR>
    <TD><DIV align="center">1</DIV></TD>
     <TD ><DIV align="center">Application Recieved </DIV></TD>
	...
	<TD><DIV align="center"> <%= AGN_RECV %>  </DIV></TD>
	<TD><DIV align="center">   </DIV></TD>
	<TD><DIV align="center"> <%=calculatePercentage(AGN_RECV,AGN_RECV)%>  </DIV></TD>
  </TR>
    <TR>
	...
	<TD><DIV align="center"> <%= AGN_REJECT %>  </DIV></TD>
	<TD><DIV align="center">   </DIV></TD>
	<TD><DIV align="center"><%=calculatePercentage(AGN_REJECT,AGN_RECV)%></DIV></TD>
  </TR>
   <TR>
	...
	<TD><DIV align="center"><%= agency_up %>   </DIV></TD>
	<TD><DIV align="center">   </DIV></TD>
	<TD><DIV align="center"> <%=calculatePercentage(agency_up,AGN_RECV)%>  </DIV></TD>
  </TR>
	...
	<TD><DIV align="center"> <%=calculatePercentage(bank_ford,AGN_RECV)%>  </DIV></TD>
  </TR>
  <TR>
    ...
    <TD><DIV align="center">5</DIV></TD>
     <TD ><DIV align="center">Recieved By Bank </DIV></TD>
   <!-- <TD><DIV align="center"><%= bank_recv %></DIV></TD>  
	...
	<TD><DIV align="center"><%= bank_ford_MM_tot %></DIV></TD>
	<TD><DIV align="center"><%=calculatePercentage(bank_ford_MM_tot,bank_ford_MM_tot)%>    </DIV></TD>
  </TR>
  <TR>
	...
	<TD><DIV align="center">  <%=calculatePercentage(bank_pend_tot,bank_ford_tot)%>   </DIV></TD>
  </TR>
  <TR>
	...
	<TD><DIV align="center">  <%=calculatePercentage(bank_reject_tot,bank_ford_tot)%>  </DIV></TD>
  </TR>
 ...
 <TD><DIV align="center"><%= bank_sanc_MM_tot %></DIV></TD>
	...
	<TD><DIV align="center"> <%=calculatePercentage(bank_sanc_tot,bank_ford_tot)%>   </DIV></TD>
  </TR>
    <TR>
    <Th colspan="9"></Th>
  </TR>
   ...
   <TR>
	...
	<TD><DIV align="center"> <%=PRV_OWN_CONT_MM%>  </DIV></TD>
     ...
     <TD><DIV align="center"><%= OWN_CONT_MM_tot%></DIV></TD>
	<TD><DIV align="center"><%=calculatePercentage(OWN_CONT_tot,bank_sanc_tot)%>    </DIV></TD>
  </TR>
  <TR>
	...
	<TD><DIV align="center"><%=calculatePercentage(IST_LOANSANC_tot,bank_sanc_tot)%>   </DIV></TD>
  </TR>
  <TR>
    <TD><DIV align="center">11</DIV></TD>
     <TD><DIV align="center">EDP Completed </DIV></TD>
    <TD ><DIV align="center"><%= edp_cert_iss_c %></DIV></TD>
   
	 <TD><DIV align="center"></DIV></TD>
	 	<TD><DIV align="center"><%= edp_cert_iss_p %> </DIV></TD>
	   <TD ><DIV align="center"></DIV></TD>
	
	<TD><DIV align="center"><%= edp_cert_iss %></DIV></TD>
	<TD><DIV align="center">   </DIV></TD>
	<TD><DIV align="center"><%=calculatePercentage(edp_cert_iss,bank_sanc_tot)%>    </DIV></TD>
  </TR> 
   ...
   <TR>
	...
	<TD><DIV align="center"><%=calculatePercentage(mm_claim_tot,bank_sanc_tot)%>    </DIV></TD>
  </TR>
   <TR>
    ...
    <TD><DIV align="center">0</DIV></TD>
	 ...
	 <TD><DIV align="center">0</DIV></TD>
	 	<TD><DIV align="center"><%=MM_REL_NO_OLD%></DIV></TD>
	<TD><DIV align="center"> <%=MM_REL_AMT_OLD %> </DIV></TD>
	<TD><DIV align="center"><%=MM_REL_NO_OLD%>   </DIV></TD>
	<TD><DIV align="center"> <%=MM_REL_AMT_OLD %>   </DIV></TD>
	 <TD><DIV align="center"></DIV></TD>
  </TR>
