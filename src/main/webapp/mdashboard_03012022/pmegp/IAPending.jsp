...
ResultSet rsMain = db.execSQL(qrysb.toString());
 %>
<CENTER>
  <H1>  Status of Application Approved for the period from <%= rFromdt %> to <%= rTodt %>  
...
%>
  <TR>
    <TD><DIV align="center"><%= cnt %></DIV></TD>
     <TD><DIV align="left"><A href="statewiseIAPend.jsp?Agency=<%=STATE_NM%>&YR=<%=YR%>" target="_parent"><%= STATE_NM %></A></DIV></TD>
