...
if(DLEVEL.equals("2")){
qrysb.append("   MS.STATE_NM,MS.STATE_CD,   "      );

}

qrysb.append("    SUM(  CASE"      );
...
if(DLEVEL.equals("3")){
qrysb.append("   AND dm.DISTRICT_CD='"+DISTRICT_CD+"'"      );
qrysb.append("   GROUP BY  dm.DISTRICT_NAME, dm.DISTRICT_CD    "      );
qrysb.append("   )GROUP BY (DISTRICT_NAME), (DISTRICT_CD)"      );
}
...
<CENTER>
  <H3>Age Wise Report For The Period From <%= FROMDT %> to <%= TODT %> (Agency: 
   <%if(AGENTYPE.equals("")){%>
	 All
	 <%}%>
	 <%=AGENTYPE%>)</H3>
...
<DIV id="wrapper">
<TABLE id="customers" width="80%" align="center">
 <THEAD>
    <TR>
...
%>
  <TR>
    <TD><DIV align="center">1</DIV></TD>
     <TD><DIV align="left">Under Process at Agency<BR> 
       ( from date of submission to as on date) </DIV></TD>
    <TD><DIV align="right"><%= AGENCY_UP %></DIV></TD>
   
	<TD><DIV align="right"><%= APP_UP_AVG %></DIV></TD>
  </TR>
    <TR>
    <TD><DIV align="center">2</DIV></TD>
     <TD><DIV align="left">Rejected By Agency ( from online submission date to rejection date) </DIV></TD>
    <TD><DIV align="right"><%= AGN_REJECT %></DIV></TD>
   
	<TD><DIV align="right"><%= APP_REJ_AVG %></DIV></TD>
  </TR>
    <TR>
    <TD><DIV align="center">3</DIV></TD>
     <TD><DIV align="left">Forwarded to Bank ( from Submission to Forwarding Date) </DIV></TD>
    <TD><DIV align="right"><%= BANK_FORD %></DIV></TD>
   
	<TD><DIV align="right"><%= BANK_FORD_AVG %></DIV></TD>
  </TR>
    <TR>
    <TD><DIV align="center">4</DIV></TD>
     <TD><DIV align="left">Sanctioned By Bank ( from forwading date to sanction Date) </DIV></TD>
    <TD><DIV align="right"><%= BANK_SANC %></DIV></TD>
   
 <TD><DIV align="right"><%= BANK_SANC_AVG %></DIV></TD>
  </TR>  <TR>
    <TD><DIV align="center">5</DIV></TD>
     <TD><DIV align="left">Own Contribution Deposited ( from santion date to deposit date) </DIV></TD>
    <TD><DIV align="right"><%= OWN_CONT %></DIV></TD>
     <TD><DIV align="right"><%= OWN_CONT_AVG %></DIV></TD>
  </TR>  <TR>
    <TD><DIV align="center">6</DIV></TD>
     <TD> <DIV align="left">Loan Disbursement ( Own cont. deposit date to Loan Disb. Date) </DIV></TD><TD><DIV align="right"><%= IST_LOANSANC %></DIV></TD>
    <TD><DIV align="right"><%= IST_LOANSANC_AVG %></DIV></TD>
  </TR>  <TR>
    <TD><DIV align="center">7</DIV></TD>
     <TD><DIV align="left">MM Claim ( Loan Disb Date to Claim Date) </DIV></TD>
    <TD><DIV align="right"><%= MM_CLAIM %></DIV></TD>
   
	<TD><DIV align="right"><%= MM_CLAIM_AVG %></DIV></TD>
  </TR>
    <TR>
    <TD><DIV align="center">8</DIV></TD>
     <TD><DIV align="left">MM Release ( Claim Date to MM Release Date) </DIV></TD>
    <TD><DIV align="right"><%= MM_REL %></DIV></TD>
   
	 <TD><DIV align="right"><%= MM_REL_AVG %></DIV></TD>
  </TR>
    <TR>
    <TD><DIV align="center">9</DIV></TD>
     <TD><DIV ALI_GN="center">
       <DIV align="left">EDP Certificate Issue ( from Sanction Date to EDP Complete Date) </DIV>
     </DIV></TD>
    <TD><DIV align="right"><%= EDP_CERT_ISS %></DIV></TD>
   
	 <TD><DIV align="right"><%= EDP_CERT_ISS_AVG %></DIV></TD>
  </TR> 
  </TBODY>
   <% 
  db.close();
