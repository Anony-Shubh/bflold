...
%>
 <DIV align="center"><IMG src="images/Transaction-Failed.png" width="25%" alt="img">	</DIV>
<TABLE border="1" align="center" id="customers" >
  <TR>
    <TH colspan="2" style="background-color:#FF0000"><DIV align="center">COVID-19 DONATION FORM </DIV></TH>
  </TR>

  <TR>
    <TD><DIV align="left">KVIC Tranasction No </DIV></TH>
    <TD nowrap>PMEGPCOVID-  <%= COVDONID %></TD>
  </TR>
  <TR>
