...
qrysb.append("   AND BD.MM_CLAIM_AMT   > 0 AND ( BD.PACT_ID IN (30,32) AND BD.APPRV_YN='R') ");
...
JSONObject obj=new JSONObject();
 ...
 obj.put("VIEW","<input name=btnDocument type=button class=buttonMerun id=btnDocument onClick=viewAlldocument('"+rsMain.getString("APP_ID")+"') value=Forms>");
