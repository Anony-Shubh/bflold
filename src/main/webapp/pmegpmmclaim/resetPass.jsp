...
if(OP_PASS == "") {
 ...
 if(NP_WORD == "") {
    ...
    return false;
	 ...
	 if(!pass.test(NP_WORD)) {
	 inlineMsg('NP_WORD','Enter correct pattern password...',2);
				return false;
	}
...
-->
     ...
     <%
	   ...
	   String SREQOTP =  (String) session.getAttribute("REQOTP");
	   out.print(SREQOTP);
	   String msg="";  
	   ...
	   String ins=request.getParameter("ins")==null?"":(String) request.getParameter("ins");
		...
		if (!REQID.equals(SREQOTP)){
		
		 response.sendRedirect("passwOtp.jsp");
		}
   %>
</p>
 <p>&nbsp;</p>
 ...
 <form method="post" name="form" id="form">
  ...
  <th colspan="4"><div align="center"> 
      ...
      <span class="style90 style96"> PASSWORD CHANGE FORM </span>
...
<th><div align="right">ENTER OLD PASSWORD*</div></th>
    ...
    <td ><input name="OP_PASS" type="password" id="OP_PASS"  value="" size="20" maxlength="20"></td>
	</tr>
	<tr>
...
<th colspan="4"> 
          <div align="center">
		    ...
		    <p>* <span class="style1">NOTE : Passwords Are Case-Sensitive
		    At least one upper case,
		    		      At least one lower case,
		    	      At least one digit,
		     At least one special character,
		     Minimum eight in length</span>       </p>
          </div>
</th>
</tr>
   ...
   <%
       ...
       if (ins.equals("I")) {
		...
		qry.append(" SELECT nvl(COUNT(*),0) FROM  MMCLAIM_USER WHERE USER_ID=? AND PASSWD=? AND ACT_YN='Y' " );
...
if (cnt.equals("1")) {
		 ...
		 qrysb.append("  UPDATE MMCLAIM_USER SET PASSWD=? WHERE USER_ID=? AND ACT_YN='Y' " );
...
db.setValues(values,pstm); 
 ...
 values.add (USER_ID);pstm.add ("D");
	...
	String docStr="update PMEGP_PASS_OTP set valid_yn='Y',A_TIMESTAMP=SYSDATE where trid="+STRID+" ";
