...
%>
  ...
  <table align="center">
    ...
    <tr>
	 <input type="button" onclick="alert(getCheckedCheckboxesFor('VALID_RS'));" value="Get Values" />
  ...
  <%
  String refqry=  " SELECT MRT.CO_REMARKS AS CO_REMARKS1, TO_CHAR(trunc(MRT.PROC_DT),'DD-MON-RRRR') AS PROC_DT1 FROM MM_REMARKS_TRANS MRT,BANK_DATAENTRY BD WHERE BD.PACT_ID IN (30,32) AND MRT.APPRV_YN='R' ";
