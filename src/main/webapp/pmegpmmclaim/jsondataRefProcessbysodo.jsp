...
qrysb.append("   AND BD.MM_CLAIM_AMT   > 0 AND ( BD.PACT_ID IN (30,31) OR BD.APPRV_YN='R') ");
...
JSONObject obj=new JSONObject();
 ...
 obj.put("VIEW","<input name=btnDocument type=button class=buttonMerun id=btnDocument onClick=viewAlldocument('"+rsMain.getString("APP_ID")+"') value=Forms/Document>");
 //obj.put("VIEW", rsMain.getString("BR_IFSL_CODE"));
 obj.put("STATUS","<input type=button name=Button class=buttonOrange value=Update onClick=ShowMMClaim('"+rsMain.getString("APP_ID")+"') >");
