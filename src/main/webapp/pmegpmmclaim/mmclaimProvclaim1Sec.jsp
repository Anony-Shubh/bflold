...
qrysb.append("   AND BD.APPRV_YN      IS NOT NULL ORDER BY BD.MM_CLAIM_DT ASC"      );
...
<p>&nbsp;  </p>
<p align="center">
  <input name="btnReport" type="button" class="blinker" id="btnReport" onClick="printMMStatus(' ')" value="Generate Consolidated Report">
  <script>
...
var urlpar='../jsp/PMEGPGenAppForm.jsp?APP_ID='+pAppid+'&RNAME=SecondLoanApplication';
...
var urlpar='StatusUpdateIstLCOSec.jsp?APP_ID='+pAppid;
 modalWin.ShowURL(urlpar,700,700,'PMEGP STATUS UPDATE',null,null);
 }
...
var urlpar='../jsp/PMEGPGenAppForm.jsp?APP_ID='+pAppid+'&RNAME=BANKSTATUSCOREPORTSEC';
 modalWin.ShowURL(urlpar,700,700,'PMEGP Application',null,null);
 }
