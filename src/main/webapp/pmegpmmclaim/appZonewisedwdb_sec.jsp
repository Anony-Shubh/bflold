...
String reportclsEX="";
reportclsEX=reportclsEX+vcls+Wcls+REPDT;
...
qrysb.append("SELECT OFF_NAME1,ZONE_NM,DECODE(APPRV_YN,'A','Approved','R','Retruned','Pending') as APPRV_YN ,APP_NAME,APP_ID,TO_CHAR(MM_CLAIM_DT,'DD-MON-YYYY') AS MM_CLAIM_DT,MM_CLAIM_AMT,     "      ); 
...
qrysb.append(" (SELECT AD.APP_ID,"      );
 qrysb.append(" AD.APP_NAME,AD.BENF_CATAGORY_CD,"      );
  qrysb.append("PMEGPCO_PENDINGSTATUS_SEC(AD.APP_ID) APP_STATUS,"      );
...
qrysb.append("AND BD.ACT_ID         = 11 ) WHERE     "+vcls+"    "+Wcls+"  "      );
...
<a href="zonewisedwdb_claim_repo_sec.jsp" class="button" >
 ...
 <!-- <p><a href="../jsp/PMEGPGenbulk.jsp?APP_ID=<%=reportcls  %>" target="_self" class="button">Download bulk claim form</a> </p>-->
   <p><a href="../jasperrop/grMmCLaiRepo.jsp?APP_ID=<%=reportclsEX%>&REPNAME=mmclaimDetailReposec" target="_self" class="button">Download bulk claim form in excel</a> 
</center>
