...
qrysb.append("     MU.USER_DETAIL,CASE WHEN MS.ZONE_CD <> 'NE' AND ACTIVITY_CD=316 THEN 'N' ELSE 'Y' END AS NEACT_YN,"      );
...
qrysb.append("    TO_CHAR( MRT.PROC_DT,'DD-MON-RRRR') AS PROC_DT,MATCHTRANSACNO(AD.APP_ID,2) AS TRANS_YN"      );
...
qrysb.append("     BANK_APP_STATUS BAS,M_DISTRICT MD,M_STATE MS"      );
...
%>
  ...
  <table align="center">
    ...
    <tr>
      ...
      <%if ((ACT_ID.equals("30")) || (TRANS_YN.equals("Y") && (ACT_ID.equals("32")) && (NEACT_YN.equals("Y") ) && (MMCLAIMAMTYN.equals("Y") ) ) ){%> <td><input name="APPROV_YN" type="radio" value="A"> 
...
pstm.clear();
*/
String Updt= "UPDATE BANK_DATAENTRY_SECOND SET APPRV_YN=? WHERE APP_ID=? AND IFSC_CODE=? ";
