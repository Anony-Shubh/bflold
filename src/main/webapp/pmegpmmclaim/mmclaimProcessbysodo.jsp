...
qrysb.append("   AND BD.MM_CLAIM_AMT   > 0  "+vWherecls+" ");
qrysb.append("   AND BD.LOAN_DOCFNAME IS NOT NULL AND (APPRV_YN='N'  OR APPRV_YN IS NULL )ORDER BY BD.MM_CLAIM_DT ASC ");
