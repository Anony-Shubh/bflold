      ...
      <%
        ...
        db.connect();
         ...
         qry.append(" SELECT A.APP_ID, ");
		  qry.append(" UPPER(A.APP_NAME) AS APP_NAME, BD.LOAN_DOCFNAME,(select count(*) from app_upload_trans where upm_cd=22 and doc_actyn='Y' and app_id=A.app_id) as sanYN, ");
	    ...
	    MOB_NO1=rsApp.getString("MOB_NO1")==null?"":rsApp.getString("MOB_NO1");
		 ...
		 sanYN=rsApp.getString("sanYN")==null?"0":rsApp.getString("sanYN");
        }
			rsApp.close();
...
<table width="100%"  border="1">
  ...
  rsUp.close();
   ...
   String refqry=  " SELECT MRT.CO_REMARKS AS CO_REMARKS1, TO_CHAR(trunc(MRT.PROC_DT),'DD-MON-RRRR') AS PROC_DT1 FROM MM_REMARKS_TRANS MRT,BANK_DATAENTRY BD WHERE BD.PACT_ID =30 ";
  ...
  %>
      ...
      <table width="100%"  border="1">
        <tr>
          ...
          <th nowrap><div align="center"><a href="../bankModule/docview.jsp?docname=<%=LOAN_DOCFNAME%>" class="greenButtonRound">Loan Disbursment Statement </a></div></th>
		  
        </tr>
		<%if (sanYN.equals("0")){%>
		<tr>
		<td colspan="3"> <center><h2 class="style1">SANCTION LETTER NOT UPLOADED</h2>
		</center> </td>
		</tr>
		<%}%>
      </table>
