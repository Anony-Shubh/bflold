          ...
          if (n && rb(h.h, m))
            for (h = 0; h < n.length; h++) {
              ...
              if ((k !== k && p.key !== p.key) || k === p.key)
                return { id: m, list: n, index: h, La: p };
            }
...
*/
    ...
    xb.Va = Qe;
    xb.Va.g = { Of: 0, Df: 1, TIMEOUT: 2, Mf: 3, fe: 4 };
    var Se = function () {
      Zb.call(this);
      this.g = {};
      this.j = [];
      ...
      if (0 !== e.length) {
        ...
        a = (0, _.x)(this.C.H, this.C, _.wa(e), this.g, {
          ...
          af: function (f) {
            ...
            401 == f
              ? (af(d, new xb.Va(xb.Va.g.Of, f)), (d.h.length = 0))
              : 410 == f
              ? (bf(d, new xb.Va(xb.Va.g.Mf, f)), cf(d))
              : 3 <= d.D
              ? (bf(d, new xb.Va(xb.Va.g.Df, f)), cf(d))
              : d.M(d.l, !0, 8001 == f);
          },
    ...
    var $e = function (a, b) {
      ...
      Ue = function (a) {
        a.o == a.F &&
          ((a.o = null),
          a.F.onLoad((0, _.x)(a.hg, a)) && af(a, new xb.Va(xb.Va.g.fe)),
          We(a));
      },
      na = function (a) {
        if (a.o) {
          ...
          a.Ya() ||
            (a.g[b].onLoad((0, _.x)(a.hg, a)) && af(a, new xb.Va(xb.Va.g.fe)),
            _.va(a.A, b),
            _.va(a.j, b),
            0 === a.j.length && cf(a),
    ...
    var la = function (a) {
      var b = _.fa;
      b.o &&
        "synthetic_module_overhead" === b.o.jb() &&
    ...
    Se.prototype.da = function () {
      bf(this, new xb.Va(xb.Va.g.TIMEOUT));
      cf(this);
    };
    var bf = function (a, b) {
        1 < a.l.length
    ...
    _.l.keys = function () {
      return nf(this.Nb(!0)).h();
    };
    _.l.values = function () {
      return nf(this.Nb(!1)).h();
    };
    ...
    _.Pf.prototype.Na = function (a) {
      a = a({}, this.j ? this.j.g() : {});
      this.h(
        null,
        "function" == typeof _.Qf && a instanceof _.Qf ? a.Db : null
      );
    };
    ...
    _.cg.prototype.Sb = function (a, b, c, d) {
    ...
    _.cg.prototype.nb = function (a, b, c, d, e) {
      if (Array.isArray(b))
        for (var f = 0; f < b.length; f++) this.nb(a, b[f], c, d, e);
      else
    ...
    _.qg.prototype.N = function () {
      this.Ya() || (this.L || this.s || this.j ? zg(this) : this.U());
    };
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.en_GB.wqdPVMOQ9t8.O/d=1/rs=AN8SPfqirFiZv_J3gCOaVwvRZkCxyetUTQ/m=el_conf
// Configure Constants
(function () {
  ...
  (function () {
    ...
    c._cl = "en-GB";
    c._cuc = "go  ogleTranslateElementInit";
    c._cac = "";
    c._cam = "";
    c._ctkk = "467813.2341639788";
    ...
    _loadCss(c._ps);
    _loadJs(
      "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.en_GB.wqdPVMOQ9t8.O/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfqirFiZv_J3gCOaVwvRZkCxyetUTQ/m\x3del_main"
    );
    _exportMessages();
    _exportVersion("TE_20230510");
  })();
})();
