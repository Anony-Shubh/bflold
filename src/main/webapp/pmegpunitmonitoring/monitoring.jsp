...
PVTIME_STAMP=(String) request.getParameter("PVTIME_STAMP")==null?"":(String) request.getParameter("PVTIME_STAMP").trim();
...
<jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
   ...
   <table class="CSSTableGenerator" align="center">
	...
	<th>(6)
          ...
          <td colspan="4"><input name="uploadfile" type="file" class="button" id="uploadfile" onChange="ValidateSingleInput(this);">            </td>
        </tr>
      ...
      <td colspan="4"><input name="PRODUCT_DETAIL" type="text"  id="PRODUCT_DETAIL"   value="<%=PRODUCT_DETAIL%>" size="50" maxlength="100"  />	    </tr>	
    <tr id="hidethis1" style="display:none;">
      <th rowspan="2">(9)  
      <th rowspan="2">No.of Employment*: 
	  <th colspan="3"><div align="center">Part time           </div>
     <th><div align="center">Full Time </div>    </tr>
    ...
    <tr  >
      <th>    
      <th>Annual Sales     
      ( in Rs.) <td><input name="MACHIN_AVAIL_DTL2"  type="text"  id="MACHIN_AVAIL_DTL2" value="<%=MACHIN_AVAIL_DTL%>" size="10" maxlength="10">    
    ...
    <tr  >
      ...
      <td><div align="center"><strong>Observation
        </strong>
       </div>
...
if (APP_ID.equals("")) {
out.print ("Applicant ID Not Selected") ;
}else if (PV_VAR_OFF.equals("")) {
out.print ("Select Officer Name<br>") ;
}else if (PV_VAR_DES.equals("")) {
out.print ("Enter Designation<br>") ;
}else if (PV_DT.equals("")) {
out.print ("Select Visit Date<br>") ;
	...
	ResultSet rs1=db.execSQL("select PVMON_SEQ.NEXTVAL from MONITORING_PV_DETAIL");
	while (rs1.next()) {
