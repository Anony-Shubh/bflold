...
if (!APP_ID.equals("")){
 ...
 qrysb.append(" AD.IFSC_CODE, " ); 
  ...
  qrysb.append("(BRM.PSSWD) AS BANK_PASSWORD, " );
...
qrysb.append("FROM APP_DETAIL_ONLINE AD, BANK_DATAENTRY BD , BANK_APP_STATUS BAP," );
qrysb.append("  M_DISTRICT MD, " );
  qrysb.append("M_STATE MS, " );
 qrysb.append(" APP_STATUS_MAST ASM, " );
  qrysb.append("MAS_OFF_MAST MOM, " );
  qrysb.append("BANK_BR_MAST BRM, " );
...
qrysb.append("(SELECT DISTRICT_CD,U_NAME,P_WORD FROM MAS_OFF_MAST WHERE CONV_DLTFCYN='Y' AND ACT_YN='Y')RQ  " );
qrysb.append("WHERE MQ.UNIT_DIST_CD=RQ.DISTRICT_CD(+) " );
...
<div id = "view"  >
  <table id="example" align="center" class="bordered">
    ...
    <tr>
	  ...
	  <th><div align="center">District_cd</div></th>
	  <th><div align="center">District</div></th>
	  <th><div align="center">State</div></th>
	  <th><div align="center">Off_cd</div></th>
...
edpcount=edpcount+1;
	...
	<tr>
	  ...
	  <td><div align="center"><%=UNIT_DIST_CD %></div></td>
	...
	<tr>
	  <td colspan="15"><div align="left"></div>	    
	    <div align="left">
	      <p align="center">&nbsp;</p>
	      <p align="center"> INDIVIDUAL USER NAME:<%=APP_ID%></p>
	      <p align="center">INDIVIDUAL PASSWORD:<%=APP_PWD%></p>
	      <p align="center">&nbsp;</p>	      
	    </div>	    </td>
	  </tr>
	<% 
