...
//out.print (BUD_ID);
%>
<STRONG><H2><CENTER><%=PBNF_DESC%> (Data Entry Form 2018-19 ) 
</CENTER></H2></STRONG>
<TABLE>
...
<TR>
  ...
  <TD><INPUT name="BNF_AFROMDT" type="text" id="BNF_AFROMDT" onClick="popUpCalendar(this, this.form.BNF_AFROMDT,'dd-mmm-yyyy');return false;" value="<%= BNF_AFROMDT %>" maxlength="11" readonly="true" PLACEHOLDER="Organized from" autocomplete="off" >
  </TD>
</TR>
<TR>
  <TD> Organized To :</TD>
  <TD><INPUT name="BNF_ATODT" type="text" id="BNF_ATODT" onBlur="days();" onClick="popUpCalendar(this, this.form.BNF_ATODT,'dd-mmm-yyyy');return false;" value="<%= BNF_ATODT %>" maxlength="11" readonly="true" AUTOCOMPLETE="off" PLACEHOLDER="Organized to" ></TD>
</TR>
<TR>
...
<TR>
  ...
  <TD><INPUT name="BNF_ATA" type="text" id="BNF_ATA" AUTOCOMPLETE="off" value="<%= BNF_ATA %>"  onKeyPress="javascript:return isNumber(event)" PLACEHOLDER="Expenditure incurred"></TD>
</TR>
<TR>
