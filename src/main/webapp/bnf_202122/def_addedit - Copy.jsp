...
qrysb.append("   FROM BNF_FO_TRANS BFT,BNF_HEAD_MAST BHM"      );
qrysb.append("   WHERE  BFT.BNF_TRID=? AND OFF_CD=?"      );

ResultSet rsMain=db.execSQL(qrysb.toString());

while (rsMain.next()){

BUD_ID=rsMain.getString("BUD_ID")==null?"0":rsMain.getString("BUD_ID");
...
<tr>
  ...
  <td colspan="8"><input name="TR_DATE"  type="date" id="TR_DATE" value="<%=TR_DATE%>"  > </td>
</tr>
<tr>
  <td> BNF Place : </td>
  <td colspan="8"><input name="BNF_PLACE"  type="text" id="BNF_PLACE" value="<%=BNF_PLACE%>" ></td>
</tr>

<tr>
  <td> Remark : </td>
  <td colspan="8"><input name="ADD_RMRK"  type="text" id="ADD_RMRK" value="<%=ADD_RMRK%>"></td>
</tr>

<tr>
  <td> Timestamp : </td>
  <td colspan="8"><input name="TIMESTAMP"  type="time" id="TIMESTAMP" value="<%=TIMESTAMP%>"></td>
</tr>
...
<tr>
 ...
 <td><input name="FIN_KVIC"  type="text"   id="FIN_KVIC" value="<%=FIN_KVIC%>" onKeyPress="javascript:return isNumber(event)" size="10" maxlength="15" onBlur="calculate_amttotal();" ></td>
  ...
  <td><input name="PH_TOTAL" type="text" readonly="" id="PH_TOTAL" size="10" maxlength="10" onClick="calculate_phytotal();"></td>
  <td> <input name="FIN_TOTAL" type="text" readonly="" id="FIN_TOTAL" size="10" onClick="calculate_amttotal();"></td>
</tr>
...
BUD_ID=(String) request.getParameter("BUD_ID")==null?"0":(String) request.getParameter("BUD_ID").trim();
TR_DATE=(String) request.getParameter("TR_DATE")==null?"0":(String) request.getParameter("TR_DATE").trim();
