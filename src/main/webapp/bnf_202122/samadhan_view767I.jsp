...
sb.append("   SELECT  boi.INVUPID,  TO_CHAR(boi.MONTH_DT,'DD-MON-RRRR') AS MONTH_DT,  boi.UPDOC_EDP,   boi.EDP_NO,  boi.TOTAL_AMT,    "      );
...
sb.append("   FROM bnf_onlineedp_inf boi WHERE OFF_CD=?    "      );
...
%>
  <TR>
	...
	<TD><DIV align="center"><A href="jasperReports/GenerateExcel.jsp?REPNM=samadhan&STATECD=<%= SSTATE_CD %>&month_dt=<%= MONTH_DT %>" class="myButton">Download</A></DIV></TD>
