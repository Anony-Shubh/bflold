...
response.setHeader("Cache-control","private");
	...
	String OFFICENAME=request.getParameter("OFFICENAME")==null?"":request.getParameter("OFFICENAME");
	...
	if(!vOFF_CD.equals("9999"))
	{
		vclsuc=vclsuc + "  bu.OFF_CD='"+vOFF_CD+"' ";
	}
	else{
		vclsuc=vclsuc + "  bu.OFF_CD like '%%' ";
	}
    ...
    HashMap hm = new HashMap(); 
		 ...
		 if  (vFname.equals("bnf_uc")){
			 hm.put("wrclsuc",vclsuc);
		   hm.put("PYEAR_ID",YEAR_ID);
		   hm.put("PUC_ID",UC_ID);
		   hm.put("POFFICENAME",OFFICENAME);
		 }
		 
		 if (!vFname.equals("MPR_BFL")){
	       hm.put("wrcls",vcls);
		   hm.put("YEAR_ID",YEAR_ID);
		   hm.put("PBUDID",QRYCODE);
		 }
		 else if  (vFname.equals("MPR_BFL")){
			 hm.put("wrcls",vcls);
		   hm.put("YEAR_ID",YEAR_ID);
		 }
		 else	if (vFname.equals("report2")){ 
		  hm.put("YEAR_ID",YEAR_ID);
		  }
