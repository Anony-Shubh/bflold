...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by ROLLUP(DECODE(AD.bank_name,NULL,'Total',AD.BANK_NAME))  )A  ");
...
<td nowrap="nowrap">
  ...
  <td nowrap="nowrap">
<div align="right"><a href="dwstatewiseSCSTSCST.jsp?<%=p3+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a>
</td>
<td nowrap="nowrap"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=24"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_NOT_UPDATE")));%></a></td>
  
<td nowrap="nowrap">
<div align="right"><a href="dwstatewiseSCST.jsp?<%=p3+"&amp;QRYCODE=40"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=16"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="bankdwState_pmegpSCST.jsp?<%=p3%>">
     view
 </a></div></td>
</tr>
<%
