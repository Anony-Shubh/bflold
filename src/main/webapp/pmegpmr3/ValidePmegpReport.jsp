...
qrysb.append("   SELECT nvl(ZONE_NM,'Grand Total') as ZONE_NM,nvl(state_nm,'Total') as State_nm,COUNT(*) AS NOOFAPPREC,ROUND(SUM(mm_claim_amt)/10000000,2) AS MMCLAIMONREC ,"      );
...
qrysb.append("     AND BD.PACT_ID=32 AND APPRV_YN<>'R' "      );
qrysb.append("   "      );
qrysb.append("    )"      );
qrysb.append("       GROUP BY ROLLUP(ZONE_NM,STATE_NM)"      );
...
<%} else{%>
  <a href="ValidePmegpReportDis.jsp?State=<%= State_nm%>">
      <%= State_nm%>
