...
String repnm="centerWiseEdp.jsp";
 ...
 urlrepE ="centerWiseEdp.jsp?TODT="+ToDt+"&FROMDT="+FromDt+"&AGENCY="+vAgency+"&ZONECD="+vZonecd+"&STATEDC="+vStatedc+"&STATECD="+vStatecd+"&OFF_TYPE_CD=";
   String repnmE="edpJasperRepo.jsp?TODT="+ToDt+"&FROMDT="+FromDt+"&AGENCY="+vAgency+"&ZONECD="+vZonecd+"&STATEDC="+vStatedc+"&STATECD="+vStatecd+"&OFF_TYPE_CD=";
    String EDPOFF_CD="";
String STATE_NM="";
String OFF_NAME="";
String PREON_EDP="";
 ...
 <table border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
   <thead>
     <tr>
       ...
       <th colspan="3"> <span class="redLebel">Pending EDP </span></th>
     ...
     <tr>
       ...
       <th rowspan="3"  > <span class="OrangeLebel">
         <p>Pre EDP </p>
         <p>(Before Sanction) </p>
       </span></th>
...
%>
       ...
       <td nowrap="nowrap"><a href=<%=urlrepE+OFF_TYPE_CD%>>view</a>
       ...
       <td nowrap="nowrap"><% if (!vnmdw.equals("Total")){%>
           <a href="<%=urlrepE+OFF_TYPE_CD%>">VIEW</a>
           <%}%></td>
