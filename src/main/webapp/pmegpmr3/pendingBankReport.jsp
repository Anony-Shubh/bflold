...
out.print ("<center>Bankwise Pending Detail of PMEGP Portal</center>");
...
<a href="../jasperrop/pmegpMisPend.jsp?<%=p3+"&QRYCODE=1"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="../jasperrop/pmegpMisPend.jsp?<%=p3+"&QRYCODE=2"%>">
