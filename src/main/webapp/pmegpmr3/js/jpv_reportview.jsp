...
qrysb.append("gto.enum_cd IS NOT NULL AND GTO.qc_ver_dt IS NULL THEN 1 ELSE 0 END ) PENDIN ");
 qrysb.append("from geotag_trans_online gto, pmegpnew.app_detail ad,pmegpnew.m_state ms,pmegpnew.m_district md "); 
...
<td><div align="center"><%=noofapp%></div></td>
<td><div align="center"><%=NOOFASSIGN%></div></td>
<td><div align="center"><%= PENDIN %></div></td>
<td><div align="center"><%=noofcpmpleted%></div></td>
