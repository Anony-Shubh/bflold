...
String ReportDesc=" PMEGP e-Tracking "+ReportName+" Performance Report for the Period from "+FromDt +" to "+ToDt+" " ; 
 ...
 if  ( vUsrnm.equals("Central office User ( All India)")) {
...
qrysb.append(" and ad.unit_dist_cd=dm.district_cd and dm.state_cd=ms.state_cd and ad.mtg_id=amm.mtg_id(+) ");
...
<td><div align="center"><a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=10"%>">
    <% out.print(dfd.format(rsinst.getDouble("edp_cert_iss_on")));%>
</a></div></td>
<td><div align="center"><a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=95"%>">
    <% out.print(dfd.format(rsinst.getDouble("edp_cert_iss")));%>
</a></div></td>
<td><div align="right">
<a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=11"%>">
...
<td>
    <div align="right">
	<a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=12"%>">
  ...
  <td>
  <div align="right"><a href="dwstatewisetest.jsp?<%=p3+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a></td>
<td><div align="right"><a href="dwstatewisetest.jsp?<%=p3+"&amp;QRYCODE=35"%>">
<% out.print(dfd.format(rsinst.getDouble("edp_cert_iss_pending")));%>
</a>
<a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=35"%>"></a></div></td>
<td><div align="right">
<a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=7"%>">
  <% out.print(dfd.format(rsinst.getDouble("bank_reject")));%>
</a></div></td>
<td><div align="right">
<a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=38"%>">
  <% out.print(dfd.format(rsinst.getDouble("pend_bank_sanc")));%>
</a></div></td>
<td><div align="right">
  <% out.print(dfd.format(rsinst.getDouble("pend_bank_sanc_mm")));%>
</div></td>
<td><div align="right"><a href="dwstatewisetest.jsp?<%=p3+"&amp;QRYCODE=40"%>">
  <% out.print(dfd.format(rsinst.getDouble("REF_PEND_NO")));%>
</a>
<a href="dwstatewisetest.jsp?<%=p3+"&QRYCODE=16"%>"></a></div></td>
<td><div align="right"><a href="dwstatewisetest.jsp?<%=p3+"&amp;QRYCODE=16"%>">
