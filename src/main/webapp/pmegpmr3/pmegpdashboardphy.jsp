...
qrysb.append(" SUM(CASE WHEN gt.pmegpgeotagid IS NOT NULL AND MM_ADJUSTMENT_STATUS IS NOT NULL THEN 1 ELSE 0 END) AS NOTPEN_AG,");
qrysb.append(" SUM(CASE WHEN gt.pmegpgeotagid IS NOT NULL AND MM_ADJUSTMENT_STATUS IS NULL THEN 1 ELSE 0 END) AS RPEN_AG, ");
qrysb.append(" SUM(CASE WHEN gt.pmegpgeotagid IS NOT NULL AND MM_ADJUSTMENT_STATUS is not null and act_id is not null THEN 1 ELSE 0 END) AS APV_DO, ");
qrysb.append(" SUM(CASE WHEN gt.pmegpgeotagid IS NOT NULL AND MM_ADJUSTMENT_STATUS is not null and act_id is null THEN 1 ELSE 0 END) AS PEN_APV ");
 ...
 <table border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
   <thead>
     <tr>
       ...
       <th colspan="4" >No fo Units Inspected </th>
       <th colspan="2">Verified By KVIC </th>
     </tr>
     <tr>
       <th >Working</th>
       <th  >Not-Working</th>
...
APV_DO=rsinst.getString("APV_DO")==null?"":rsinst.getString("APV_DO");
PEN_APV=rsinst.getString("PEN_APV")==null?"":rsinst.getString("PEN_APV");
 ...
 %>
   ...
   <tbody>
     <tr>
       <th  colspan="26"><div align="center"></div>
           <%=firstcolold%></th>
     </tr>
     <%}%>
     <tr>
