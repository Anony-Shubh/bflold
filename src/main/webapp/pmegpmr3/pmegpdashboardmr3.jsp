...
String urladd="";
String urlrep="";
String repnm="pmegpdashboardmr3.jsp";
...
qrysb.append(" and ad.unit_dist_cd=dm.district_cd and dm.state_cd=ms.state_cd and ad.mtg_id=amm.mtg_id(+) and AD.BENF_CATAGORY_CD IN ('SC','ST') ");
