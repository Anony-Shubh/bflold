...
String urladd="";
String urlrep="";
String repnm="pmegpdashboardgeoPhyREv.jsp";
...
qryField2=" MAX('ALL') as zone_nm , A.off_name1  as off_name1 ";
urladd="&AGENCY=";
...
qryField2=" A.zone_nm as zone_nm , A.off_name1  as off_name1 ";
urladd="&ZONECD=";
...
//out.print(qrysb.toString());
/*qrysb.append("   SELECT A.*,nvl(A.PARDIS_NO,0)- nvl(A.BCLNO,0)  as pencallno,nvl(A.call_bck,0)-nvl(A.BCLNO_AMT,0)AS pendcallmm from ("      );
...
qrysb.append("   GROUP BY "+qryGroup1+")A "      );

*/
qrysb.append("   select A.*,"      );
qrysb.append("     NVL(A.PARDIS_NO, 0) - NVL(A.BCLNO, 0)     AS pencallno,"      );
qrysb.append("     NVL(A.CALL_BCK, 0)  - NVL(A.BCLNO_AMT, 0) AS pendcallmm from ("      );
qrysb.append("   SELECT "+qryField1+", "      );
qrysb.append("     SUM(A.TOT)TOT,"      );
qrysb.append("     SUM(A.NOT_COMP)NOT_COMP,"      );
qrysb.append("     SUM(A.COMP)COMP,"      );
qrysb.append("     SUM(A.COM) COM,"      );
qrysb.append("     SUM(A.NT)NT,"      );
qrysb.append("     SUM(A.DF)DF,"      );
qrysb.append("     SUM(A.QC_PEN)QC_PEN,"      );
qrysb.append("     SUM(A.QC_COMP)QC_COMP,"      );
qrysb.append("     SUM(A.ADJ_NO)ADJ_NO,"      );
qrysb.append("     SUM(A.ADJ_MM)ADJ_MM,"      );
qrysb.append("     SUM(A.RVNO)RVNO,"      );
qrysb.append("     SUM(A.FULLADJ_NO)FULLADJ_NO,"      );
qrysb.append("     SUM(A.FULLADJ_MM)FULLADJ_MM,"      );
qrysb.append("     SUM(A.FULLDIS_NO)FULLDIS_NO,"      );
qrysb.append("     SUM(A.FULLDIS_MM)FULLDIS_MM,"      );
qrysb.append("     SUM(A.PARDIS_NO)PARDIS_NO,"      );
qrysb.append("     SUM(A.PARDIS_MM)PARDIS_MM,"      );
qrysb.append("     SUM(A.CALL_BCK)CALL_BCK,"      );
qrysb.append("     SUM(A.AGEN_PEN)AGEN_PEN,"      );
qrysb.append("     SUM(A.NAGEN_PEN)NAGEN_PEN,"      );
qrysb.append("     SUM(A.BCLNO) AS BCLNO,"      );
qrysb.append("     SUM(A.BCLNO_AMT) BCLNO_AMT,"      );
qrysb.append("     SUM(A.BCLNO_P) BCLNO_P,"      );
qrysb.append("     SUM(A.BCLNO_AMTP) BCLNO_AMTP"      );
qrysb.append("   FROM"      );
qrysb.append("     (SELECT A.AGENCY_TYPE,"      );
qrysb.append("         A.ZONE_NM,"      );
qrysb.append("         A.STATE_NM,"      );
qrysb.append("         A.UNIT_DIST,"      );
qrysb.append("         A.OFF_NAME1,"      );
qrysb.append("       COUNT(*)                                         AS TOT,"      );
qrysb.append("       SUM(NVL(DECODE(A.PMEGPGEOTAGID, NULL, 1, 0), 0)) AS NOT_COMP,"      );
qrysb.append("       SUM(NVL(DECODE(A.PMEGPGEOTAGID, NULL, 0, 1), 0)) AS COMP,"      );
qrysb.append("       SUM("      );
...
qrysb.append("         ELSE 0"      );
qrysb.append("       END) AS BCLNO_AMT,"      );
qrysb.append("       0    AS BCLNO_P,"      );
qrysb.append("       0    AS BCLNO_AMTP"      );
qrysb.append("     FROM"      );
qrysb.append("       (SELECT A.AGENCY_TYPE,"      );
qrysb.append("         A.ZONE_NM,"      );
qrysb.append("         A.STATE_NM,"      );
...
qrysb.append("         gt.AGN_CALLBACK,"      );
qrysb.append("         gt.MM_ADJUSTMENT_AMT_S,"      );
qrysb.append("         gt.AGENCY_UPLOAD,"      );
qrysb.append("         gt.VERIFICATION_STATUS,"      );
qrysb.append("         A.OFF_NAME1"      );
qrysb.append("       FROM GEOTAGAPIDATA A,"      );
qrysb.append("         geotag_trans gt"      );
qrysb.append("       WHERE A.APP_ID = gt.APP_ID(+)"      );
qrysb.append("       AND TRUNC(A.MM_REL_DT) BETWEEN '"+FromDt+"' AND '"+ToDt+"' "+txtSearch+"   "      );
qrysb.append("       ) A,"      );
qrysb.append("       (SELECT ir.STATUS,"      );
qrysb.append("         ir.PRODUCTINFO,"      );
qrysb.append("         ir.UDF1 AS app_id,"      );
qrysb.append("         ir.AMOUNT"      );
qrysb.append("       FROM GEOTAGAPIDATA A,"      );
qrysb.append("         indbank_request ir"      );
qrysb.append("       WHERE A.APP_ID = ir.UDF1"      );
qrysb.append("       AND (ir.STATUS = 'success')"      );
qrysb.append("       ) B"      );
qrysb.append("     WHERE A.APP_ID = B.app_id(+)"      );
qrysb.append("     GROUP BY (A.AGENCY_TYPE,"      );
qrysb.append("         A.ZONE_NM,"      );
qrysb.append("         A.STATE_NM,"      );
qrysb.append("         A.UNIT_DIST,"      );
qrysb.append("         A.OFF_NAME1)"      );
...
qrysb.append("         A.UNIT_DIST,"      );
qrysb.append("           A.OFF_NAME1,"      );
qrysb.append("       0               AS TOT,"      );
qrysb.append("       0               AS NOT_COMP,"      );
qrysb.append("       0               AS COMP,"      );
qrysb.append("       0               AS COM,"      );
qrysb.append("       0               AS NT,"      );
qrysb.append("       0               AS DF,"      );
qrysb.append("       0               AS QC_PEN,"      );
qrysb.append("       0               AS QC_COMP,"      );
qrysb.append("       0               AS ADJ_NO,"      );
qrysb.append("       0               AS ADJ_MM,"      );
qrysb.append("       0               AS RVNO,"      );
qrysb.append("       0               AS FULLADJ_NO,"      );
qrysb.append("       0               AS FULLADJ_MM,"      );
qrysb.append("       0               AS FULLDIS_NO,"      );
qrysb.append("       0               AS FULLDIS_MM,"      );
qrysb.append("       0               AS PARDIS_NO,"      );
qrysb.append("       0               AS PARDIS_MM,"      );
qrysb.append("       0               AS CALL_BCK,"      );
qrysb.append("       0               AS AGEN_PEN,"      );
qrysb.append("       0               AS NAGEN_PEN,"      );
qrysb.append("       0               AS BCLNO,"      );
qrysb.append("       0               AS BCLNO_AMT,"      );
qrysb.append("       SUM("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN STATUS = 'success'"      );
qrysb.append("         THEN 1"      );
qrysb.append("         ELSE 0"      );
qrysb.append("       END) AS BCLNO_P,"      );
qrysb.append("       SUM("      );
qrysb.append("       CASE"      );
qrysb.append("         WHEN STATUS = 'success'"      );
qrysb.append("         THEN ROUND(TO_NUMBER(AMOUNT) / 100000, 2)"      );
qrysb.append("         ELSE 0"      );
qrysb.append("       END) AS BCLNO_AMTP"      );
qrysb.append("     FROM"      );
qrysb.append("       (SELECT A.AGENCY_TYPE,"      );
qrysb.append("         A.ZONE_NM,"      );
qrysb.append("         A.STATE_NM,"      );
...
qrysb.append("         0,"      );
qrysb.append("         A.OFF_NAME1,"      );
qrysb.append("         B.STATUS,"      );
qrysb.append("         B.PRODUCTINFO,"      );
qrysb.append("         B.app_id AS app_id1,"      );
qrysb.append("         B.AMOUNT"      );
qrysb.append("       FROM"      );
qrysb.append("         (SELECT A.AGENCY_TYPE,"      );
qrysb.append("           A.ZONE_NM,"      );
qrysb.append("           A.STATE_NM,"      );
...
qrysb.append("           A.APP_ID,"      );
qrysb.append("           A.OFF_NAME1"      );
qrysb.append("         FROM PHYMMREFDATA A"      );
qrysb.append("         WHERE "      );
qrysb.append("          TRUNC(A.MM_REL_DT) BETWEEN '"+FromDt+"' AND '"+ToDt+"' "+txtSearch+"  "      );
qrysb.append("         ) A,"      );
qrysb.append("         (SELECT ir.STATUS,"      );
qrysb.append("           ir.PRODUCTINFO,"      );
qrysb.append("           ir.UDF1 AS app_id,"      );
qrysb.append("           ir.AMOUNT"      );
qrysb.append("         FROM indbank_request ir"      );
qrysb.append("         WHERE ir.STATUS = 'success'"      );
qrysb.append("         ) B"      );
qrysb.append("       WHERE A.APP_ID(+) = B.app_id"      );
qrysb.append("       )A"      );
qrysb.append("     GROUP BY (A.AGENCY_TYPE,"      );
...
qrysb.append("         A.UNIT_DIST,"      );
qrysb.append("           A.OFF_NAME1)"      );
qrysb.append("     ) A GROUP BY "+qryGroup1+" )A "      );
qrysb.append(" where A.TOT >0  "      );
     ...
     <tr>
	   ...
	   <th colspan="2" >Reverification </th>
	    <th colspan="2" >Callback MM Recieved from Financing Bank</th>
		 <th colspan="2" >Callback MM Pending At Financing Bank</th>
		  <th colspan="2" >Total MM Refunded By Financing Bank</th>
     </tr>
     <tr>
       <th  >Working </th>
       <th  >Not Working </th>
...
BCLNO_AMT=rsinst.getString("BCLNO_AMT")==null?"":rsinst.getString("BCLNO_AMT");
 ...
 pencallno=rsinst.getString("pencallno")==null?"":rsinst.getString("pencallno");
 pendcallmm=rsinst.getString("pendcallmm")==null?"":rsinst.getString("pendcallmm");
 BCLNO_P=rsinst.getString("BCLNO_P")==null?"":rsinst.getString("BCLNO_P");
 BCLNO_AMTP=rsinst.getString("BCLNO_AMTP")==null?"":rsinst.getString("BCLNO_AMTP");
...
%>
       ...
       <td  ><a href="<%=repnmE+urlrep+p2+vnmdw+p1+firstcolold%>&QRYCODE=15"><%= BCLNO%></a></td>
	    <td  ><%= BCLNO_AMT%></td>
		<td  ><a href="<%=repnmE+urlrep+p2+vnmdw+p1+firstcolold%>&QRYCODE=16"><%= pencallno%></a></td>
	    <td  ><%= pendcallmm%></td>
		<td  ><a href="<%=repnmE+urlrep+p2+vnmdw+p1+firstcolold%>&QRYCODE=17"><%= BCLNO_P%></a></td>
	    <td  ><%= BCLNO_AMTP%></td>
       <% } else{%>
      <td ><a href="<%=repnmE+urlrep+p3%>&QRYCODE=1"><%=PENOF_EDP%></a></td>
       ...
       <td  ><a href="<%=repnmE+urlrep+p3%>&QRYCODE=15"><%= BCLNO%></a></td>
	    <td  ><%= BCLNO_AMT%></td>
			<td  ><a href="<%=repnmE+urlrep+p3%>&QRYCODE=16"><%= pencallno%></a></td>
	    <td  ><%= pendcallmm%></td>
		<td  ><a href="<%=repnmE+urlrep+p3%>&QRYCODE=17"><%= BCLNO_P%></a></td>
	    <td  ><%= BCLNO_AMTP%></td>
