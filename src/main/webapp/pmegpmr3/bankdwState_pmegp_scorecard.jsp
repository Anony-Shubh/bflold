...
sb.append("SELECT A.* ").
append(" FROM ( ").
append(" SELECT  AD.bank_name as bank_name,NVL(DECODE(MS.STATE_NM,NULL,'Total',MS.STATE_NM),'Total') as STATE_NM  ").
...
append(" FROM app_detail ad, bank_dataentry bd, m_district dm, mas_off_mast mom,m_state ms,ZONE_MAST ZM, PMEGP_SCORE_CARD PSC ").
append(" where ad.app_id=bd.app_id(+) and ad.unit_dist_cd=dm.district_cd and dm.state_cd=ms.state_cd AND ad.APP_ID = PSC.APP_ID(+) AND PSC.TOTAL_SCORE>=60 AND PSC.HO_VERIFY_YN='Y'").
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by bank_name, ROLLUP(DECODE(MS.STATE_NM,NULL,'Total',MS.STATE_NM)))  A  WHERE A.BANK_FORD>0 AND A.BANK_NAME='"+vBank+"'");
...
by Bank</th>
 ...
 <th colspan="2" >Failed Cases</th>
  ...
  <th colspan="2" >Pending for MM Disbursement</th>
   <th rowspan="2" >District Wise View</th>
  </tr>
<tr>
<th ><br /> 
  No of Prj.
...
<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=5"%>">
  ...
  <td nowrap="nowrap">
    <div align="right">
	<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=6"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=11"%>">
...
<td nowrap="nowrap">
    <div align="right">
	<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=12"%>">
  ...
  <td nowrap="nowrap">
<div align="right"><a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a>
</td>
<td nowrap="nowrap"><a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&amp;QRYCODE=24"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_NOT_UPDATE")));%></a></td> 

<td nowrap="nowrap"><div align="right">
<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=7"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=40"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=38"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="../jasperrop/AgencySCGenerateXLS_bw.jsp?<%=p4+"&QRYCODE=16"%>">
...
<td nowrap="nowrap"><div align="right">
  <a href="bankdwDist_pmegp.jsp?<%=p4%>">
     view</a>
</div></td>
</tr>
<%
