...
<td nowrap="nowrap">
  ...
  <td nowrap="nowrap">
<div align="right"><a href="dwstatewiseSec.jsp?<%=p3+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a>
</td>
<td nowrap="nowrap"><a href="dwstatewiseSec.jsp?<%=p3+"&amp;QRYCODE=24"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_NOT_UPDATE")));%></a></td>
  
<td nowrap="nowrap">
<div align="right"><a href="dwstatewiseSec.jsp?<%=p3+"&amp;QRYCODE=40"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p3+"&QRYCODE=16"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="bankdwState_pmegpSecond.jsp?<%=p3%>">
     view
 </a></div></td>
</tr>
<%
