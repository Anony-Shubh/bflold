...
sStatecd=sStatecd;
 ...
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' AND A.ACT_ID=11 AND  A.STATE_NM LIKE '"+sStatecd+"' AND TRUNC(A.LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' ";
			}
				if (vQryCode.equals("2")) {
 vwherecls=vwherecls + "  A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NOT NULL AND A.ACT_ID=11 AND A.STATE_NM LIKE '"+sStatecd+"' AND  TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.OFF_CD  = 9246 ";
			}
			
				if (vQryCode.equals("3")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NOT NULL AND A.STATE_NM LIKE '"+sStatecd+"' AND  A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.OFF_CD  <> 9246 ";
			}
			
				if (vQryCode.equals("4")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NOT NULL AND A.STATE_NM LIKE '"+sStatecd+"' AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  ";
			}
			
				if (vQryCode.equals("5")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NULL AND A.STATE_NM LIKE '"+sStatecd+"' AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  ";
			}
			
			if (vQryCode.equals("6")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and  (A.EDP_CERT_DT) IS  NULL AND A.STATE_NM LIKE '"+sStatecd+"' AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' AND TRUNC(A.MM_REL_DT) IS NOT NULL ";
			}
			
			if (vQryCode.equals("7")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS  NULL AND A.STATE_NM LIKE '"+sStatecd+"' AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' AND TRUNC(A.MM_REL_DT) IS  NULL ";
			}
			
				if (vQryCode.equals("8")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"'   and  (A.EDP_CERT_DT) IS  NULL AND A.STATE_NM LIKE '"+sStatecd+"' AND  A.ACT_ID=11 AND TRUNC(A.LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' AND UPLOAD_YN='Y' "; 
			}
			...
			if (vQryCode.equals("1")){
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"'  ";
			}
				if (vQryCode.equals("2")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NOT NULL AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.OFF_CD  = 9246 AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"'  ";
			}
 ...
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NOT NULL AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.OFF_CD  <> 9246 AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"' ";
				...
				if (vQryCode.equals("4")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NOT NULL AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"' ";
			}
			
				if (vQryCode.equals("5")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS NULL AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"'  AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"' ";
			}
			
			if (vQryCode.equals("6")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and  (A.EDP_CERT_DT) IS  NULL AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' AND TRUNC(A.MM_REL_DT) IS NOT NULL AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"' ";
			}
			
			if (vQryCode.equals("7")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and (A.EDP_CERT_DT) IS  NULL AND A.ACT_ID=11 AND TRUNC(LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' AND TRUNC(A.MM_REL_DT) IS  NULL AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"' ";
			}
			
				if (vQryCode.equals("8")) {
 vwherecls=vwherecls + " A.AGENCY_TYPE LIKE '"+vsAgency+"' and  (A.EDP_CERT_DT) IS  NULL AND A.ACT_ID=11 AND TRUNC(A.LOAN_SANC_DT) BETWEEN  '"+pfrom+"' and  '"+pto+"' AND UPLOAD_YN='Y' AND A.ZONE_NM LIKE '"+vsZonecd+"' AND A.STATE_NM LIKE '"+sStatecd+"'  ";
			}
