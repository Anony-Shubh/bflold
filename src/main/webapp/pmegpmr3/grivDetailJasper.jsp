...
sStatecd=sStatecd;
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  G.SUB_ID=1 and ms.state_nm like '"+sStatecd+"'  ";
			}
				if (vQryCode.equals("2")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id=3 AND G.SUB_ID=1 and ms.state_nm like '"+sStatecd+"' ";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and   G.SUB_ID=2 and ms.state_nm like '"+sStatecd+"'";
			}
			
				if (vQryCode.equals("5")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and P.act_id=3 AND G.SUB_ID=2 and ms.state_nm like '"+sStatecd+"'";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  G.SUB_ID=3  and ms.state_nm like '"+sStatecd+"'";
			}
			
				if (vQryCode.equals("8")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id=3 AND G.SUB_ID=3  and ms.state_nm like '"+sStatecd+"' ";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  G.SUB_ID=4 and ms.state_nm like '"+sStatecd+"' ";
			}
			
			if (vQryCode.equals("11")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and P.act_id=3 AND G.SUB_ID=4  and ms.state_nm like '"+sStatecd+"'";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"' and ms.state_nm like '"+sStatecd+"'  ";
			}
			
			if (vQryCode.equals("14")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and P.act_id=3 and ms.state_nm like '"+sStatecd+"'";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id<>3 and ms.state_nm like '"+sStatecd+"'  ";
		...
		if (vQryCode.equals("1")){
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  G.SUB_ID=1 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
				if (vQryCode.equals("2")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id=3 AND G.SUB_ID=1 AND ZM.ZONE_NM LIKE '"+vsZonecd+"'  and ms.state_nm like '"+sStatecd+"' ";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id<>3 AND G.SUB_ID=1  AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
				...
				if (vQryCode.equals("4")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and   G.SUB_ID=2  AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
			
				if (vQryCode.equals("5")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and P.act_id=3 AND G.SUB_ID=2 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and   P.act_id<>3 AND G.SUB_ID=2 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			...
			if (vQryCode.equals("7")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  G.SUB_ID=3 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
			
				if (vQryCode.equals("8")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id=3 AND G.SUB_ID=3 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id<>3 AND G.SUB_ID=3 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			...
			if (vQryCode.equals("10")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  G.SUB_ID=4 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"'";
			}
			
			if (vQryCode.equals("11")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and P.act_id=3 AND G.SUB_ID=4 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
 ...
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and  P.act_id<>3 AND G.SUB_ID=4 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			...
			if (vQryCode.equals("13")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"' AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
			
			if (vQryCode.equals("14")) {
 vwherecls=vwherecls + " AND MOM.AGENCY_TYPE LIKE '"+vsAgency+"' and TRUNC(P.GR_TIMESTAMP) between '"+pfrom+"' and  '"+pto+"'  and P.act_id=3 AND ZM.ZONE_NM LIKE '"+vsZonecd+"' and ms.state_nm like '"+sStatecd+"' ";
			}
