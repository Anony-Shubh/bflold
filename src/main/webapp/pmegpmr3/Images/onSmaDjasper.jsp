...
txtSearch=" and upper(A.zone_nm) like upper('"+vZoneCD+"') and upper(A.state_nm) like upper('"+vStateCd+"') and A.AGENCY_TYPE like '"+vAgency+"' and upper(A.DISTRICT_NAME) like upper('"+vDist+"')  and upper(A.state_nm) like upper('"+sStatecd+"')";
 
 if (vQryCode.equals("1")){
 txtSearch = txtSearch  + " and A.ACTUAL_EDP >0 " ; 
}
out.print(txtSearch);
