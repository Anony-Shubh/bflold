...
String urladd="";
String urlrep="";
String repnm="agencyscdashboard.jsp";
  ...
  while( parameterList.hasMoreElements() )
  {
    String sName = parameterList.nextElement().toString();
      String[] sMultiple = request.getParameterValues( sName );
	   if(sName.equals("AGENCY")||sName.equals("ZONECD")||sName.equals("STATECD")||sName.equals("OFFNAMECD")||sName.equals("DISTCD")){
...
//qrysb.append("   SELECT AGENCY_TYPE, PREVYRPENDING, CURYRPENDING, PREVYRPENDING+CURYRPENDING AS TOTALPENDING, SCORECARDFILLUP, AGENCY_VERIFY,  "      );
//qrysb.append("   VAR_SCORE_60PER, SIXTYPER_FORD, PENDING_TO_FORWAD FROM ( "      );

//qrysb.append(" SELECT"+qryField+"  FROM(");
...
<tbody>
 <tr>
 <th  colspan="10"><div align="center"></div>   <%=firstcolold%></span></th>
 </tr>
	 <%}%>
