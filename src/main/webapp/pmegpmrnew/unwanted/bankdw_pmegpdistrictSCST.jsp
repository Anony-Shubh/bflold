...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by ROLLUP(DECODE(dm.district_name,NULL,'Total',dm.district_name))  )A WHERE A.BANK_FORD>0 ");
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSCST.jsp?<%=p3+"&QRYCODE=15"%>">
