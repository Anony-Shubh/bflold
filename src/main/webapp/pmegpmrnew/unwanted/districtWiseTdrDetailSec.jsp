...
out.print ("<center>PMEGP e-Tracking System</center>");
 ...
 sb.append(" SELECT bank_name,STATE_NM,NVL(DECODE(DISTRICT_NAME,NULL,'Total',DISTRICT_NAME),'Total') as DISTRICT_NAME,").
...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd   ) where bank_name='"+vBank+"'  and state_nm= '"+vSTATE+"' ").
 append(" GROUP BY  BANK_NAME,STATE_NM,ROLLUP(DISTRICT_NAME)   ");
...
<td nowrap="nowrap"><a href="dwstatewise.jsp?<%=p3+"&amp;QRYCODE=27"%>">
