...
QryCaption="Under Process/Pending at Agency";
 ...
 // Own Contribution Deposited
  txtSearch = txtSearch + " and  BD.OWN_CONT_DT IS NOT NULL AND  TRUNC(ad.Online_subdt) between '"+FromDt+"' and '"+ToDt+"' and bd.act_id=11  ";
 }else if (vQryCode.equals("9")){
 QryCaption="Loan Released";
 //  LOAN RELEASED
  txtSearch = txtSearch + " and  TRUNC(bd.ist_loan_dt) IS NOT NULL AND   TRUNC(ad.Online_subdt) between '"+FromDt+"' and '"+ToDt+"' and bd.act_id=11  ";
