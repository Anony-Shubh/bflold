...
<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=5"%>">
  ...
  <td nowrap="nowrap">
    <div align="right">
	<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=6"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=11"%>">
...
<td nowrap="nowrap">
    <div align="right">
	<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=12"%>">
  ...
  <td nowrap="nowrap">
<div align="right"><a href="dwstatewiseSec.jsp?<%=p4+"&amp;QRYCODE=27"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_UPDATE")));%>
</a>
</td>
</td>
<td nowrap="nowrap"><a href="dwstatewiseSec.jsp?<%=p4+"&amp;QRYCODE=24"%>">
<% out.print(dfd.format(rsinst.getDouble("TDR_NOT_UPDATE")));%></a></td>
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=7"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=40"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p3+"&QRYCODE=45"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=38"%>">
...
<td nowrap="nowrap"><div align="right">
<a href="dwstatewiseSec.jsp?<%=p4+"&QRYCODE=16"%>">
