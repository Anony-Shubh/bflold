...
String   PENPOSTOF_EDP="";  
 ...
 txtSearch=txtSearch+" AND MOM.AGENCY_TYPE LIKE '"+vAgency+"' AND ZM.ZONE_NM LIKE '"+vZonecd+"' AND MS.STATE_NM LIKE '"+vStatecd+"' AND MOM.OFF_NAME1 LIKE '"+vOffice+"' AND MO.OFF_TYPE_CD="+OFF_TYPE_CD+"  "; 
...
*/
qrysb.append("   SELECT nvl(A.OFF_NAME,'Total')  as off_name1 ,max(A.off_cd ) as off_cd,SUM(A.COMPTOT_EDP) AS COMPTOT_EDP,"      );
