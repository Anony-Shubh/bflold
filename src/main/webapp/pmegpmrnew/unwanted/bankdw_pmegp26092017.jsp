...
append("  "+txtSearch+"  ").
append(" and ad.off_cd=mom.off_cd(+) AND MS.zone_cd=ZM.zone_cd group by ROLLUP(DECODE(AD.bank_name,NULL,'Total',AD.BANK_NAME))  )A WHERE A.BANK_FORD>0 ");
...
by Bank</th>
  ...
  <th rowspan="2" >State Wise View</th>
  </tr>
<tr>
<th ><br /> 
  No of Prj.
