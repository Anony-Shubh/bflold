...
public class DigitalSigner {
	...
	public String signXML(String xmlDocument, boolean includeKeyInfo) {
		...
		//	System.out.println("\nxmlDocument"+stringWriter.getBuffer().toString());
	...
	private KeyStore.PrivateKeyEntry getKeyFromKeyStore(String keyStoreFile, char[] keyStorePassword, String alias) {
		...
		try {
	                ...
	                configWriter.println("name=etoken"); 
	                	configWriter.println("library=C:\\Windows\\System32\\Watchdata\\PROXKey CSP India V1.0\\wdpkcs.dll"); 
	                  configWriter.println("slot=16385");  
                    // SunPKCS11 provider = ( SunPKCS11 ) Security.getProvider(tmpConfigFile.getAbsolutePath());		
	                ...
	                Security.addProvider(provider);
                     ...
                     // KeyStore ks = KeyStore.getInstance("PKCS11",  "SunPKCS11-Luna"); 
	                  ...
	                  keyFileStream = new FileInputStream(tmpConfigFile);
				      ks.load( keyFileStream,keyStorePassword);
				      Signature signature = Signature.getInstance("SHA1withRSA");
			
				      Enumeration<String> keyAliases = ks.aliases();
			          
			          String nalias = keyAliases.nextElement();
			          
			          System.out.println(nalias);
		         
			KeyStore.PrivateKeyEntry entry = (KeyStore.PrivateKeyEntry) ks.getEntry(nalias,
